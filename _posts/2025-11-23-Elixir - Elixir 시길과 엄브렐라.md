...
category: Elixir
---
# Elixir 시길(Sigil) 사용자 정의와 엄브렐라(Umbrella)
...
#### (A) 경계를 유지하는 방법: “core는 절대 외부를 모른다”
