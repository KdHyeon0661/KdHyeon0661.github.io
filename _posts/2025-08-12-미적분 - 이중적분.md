...
## 1) 반복적분과 Fubini 정리: 계산의 표준 루틴

### 1.1 반복적분(Iterated Integral)
...
# 테스트: ∫_0^1 ∫_0^x (x+y) dy dx = 1/2 (앞서 예제 B)
f = lambda x,y: x + y
