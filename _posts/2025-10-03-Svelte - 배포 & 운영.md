...
### 프로세스 관리자(PM2) / Graceful Shutdown
...
## Vercel 어댑터 — Serverless / Edge Functions
...
## Netlify 어댑터 — Functions / Edge Functions
...
## Cloudflare 어댑터 — Workers / Pages Functions
...
## 배포 파이프라인 (CI/CD) — GitHub Actions 예
