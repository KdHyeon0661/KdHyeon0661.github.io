...
### POSIX Shared Memory + futex(저오버헤드 대기)
...
### POSIX Message Queue (우선순위 있는 커널 큐)
...
### UNIX Domain Sockets — FD 전달(핸드오프)
...
### Windows Named Pipe & MailSlot (개요)
...
### HTTP/1.1 Keep-Alive, HTTP/2 Multiplexing, gRPC
