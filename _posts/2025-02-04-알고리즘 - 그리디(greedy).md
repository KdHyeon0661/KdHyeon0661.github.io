...
## 2. 그리디가 “맞는 이유” — 교환 논증 기본형

### 2.1 회의실 배정(BOJ 1931)의 교환 논증
...
### 5.1 분수 배낭(Fractional Knapsack) — 정렬 그리디가 **정확**
...
### 5.2 작업 스케줄링(마감·이익 최대) — **마감 오름차순 + 힙**
...
### 5.4 카드 묶기(BOJ 1715) — 허프만/합치기 최소 비용
...
### 5.6 멀티탭 스케줄링(BOJ 1700) — **가장 늦게 다시 쓰는 것**을 뽑아라
- 플러그 구멍 \(N\), 사용 순서 길이 \(K\).
...
### 5.7 크레인(BOJ 1092) — 내림차순 + 가장 무거운 것부터
...
### 5.8 구간 덮개(BOJ 2457 “공주님의 정원”) — 스위핑
