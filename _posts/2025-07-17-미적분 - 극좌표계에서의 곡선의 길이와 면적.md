...
## 2. 면적 공식 \(A=\frac12\int r^2\,d\theta\) — 유도와 해석
...
## 3. 호길이(곡선 길이) 공식 \(L=\int\sqrt{r^2+(r')^2}\,d\theta\) — 유도와 해석
...
### 예제 4-3. 장미곡선 \(r=a\cos(n\theta)\) 한 잎 면적
...
### 예제 4-4. 카디오이드 \(r=a(1+\cos\theta)\) 전체 면적
$$
...
### 예제 5-3. 카디오이드 \(r=a(1+\cos\theta)\) 전체 둘레
\(r'= -a\sin\theta\). 그러면
$$
...
## 7. 이중적분 관점(야코비안)으로 본 면적 공식의 정당화
...
## 9. 실습 코드 (SymPy/NumPy/Matplotlib)
...
### 9.2 면적 예제 — \(r=2\)와 \(r=\cos\theta\), \(0\le\theta\le\frac{\pi}{2}\)
...
### 9.3 길이 예제 — 카디오이드 \(r=a(1+\cos\theta)\)
