...
## (확장) **문자열 출력**·**최종 출력**이 있는 경우(순차 변환기)
...
## 구현 — **참조용 파이썬 코드**(Trim, 최소화, 동치성, 반례 생성)
...
## **상태 구분 입력**(distinguishing sequence) 찾기
