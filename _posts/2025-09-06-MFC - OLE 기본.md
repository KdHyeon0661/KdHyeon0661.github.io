...
## 드래그&드롭(Drag&Drop) — 원리→MFC 클래스→예제
...
## 클립보드(Clipboard) — Cut/Copy/Paste 패턴
...
## 임베딩(Embedding) & 링킹(Linking) — 복합 문서
...
## In-place Activation(서버 UI 병합) 핵심
