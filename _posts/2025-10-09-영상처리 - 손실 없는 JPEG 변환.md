...
category: 영상처리
---
# 손실 없는 JPEG 변환(회전/뒤집기/크롭) — **jpegtran 방식(transupp.h) 완전 정리**
...
### 5.3 **수평 반전(H-Flip)** (웹캠 좌우 반전 교정 등)
```cpp
