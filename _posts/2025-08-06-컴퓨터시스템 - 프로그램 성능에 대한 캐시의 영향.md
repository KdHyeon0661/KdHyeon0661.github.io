...
## TLB와 페이지 — TLB reach가 작으면 캐시가 좋아도 느리다
...
## 캐시 친화적 설계 — 데이터·루프·동시성

### 데이터 레이아웃: AoS→SoA, 정렬/패딩
