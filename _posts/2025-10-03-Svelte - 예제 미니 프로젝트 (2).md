...
category: Svelte
---
# 실전 예제 미니 프로젝트 (2) — **블로그/문서 사이트 (SSG · RSS · 검색)**
...
### mdsvex 설정 (Shiki + remark/rehype 플러그인)
...
### 포스트 예시 (`/content/posts/2025-01-hello-sveltekit.md`)
...
### 문서 예시 (`/content/docs/guide/01-installation.md`)
