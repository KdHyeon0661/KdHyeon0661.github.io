...
### 예제 ①—접근 행렬을 ACL로 구현(개념 코드, Python)
...
```bash
# 미만 포트 바인드만 필요한 바이너리에 해당 capability 부여
...
### 공통기제 최소화(Least Common Mechanism)
...
### Linux capabilities로 “root 없이 80/443 바인드”
...
### Revocation 패턴: 핸들 테이블로 능력 회수(개념)
