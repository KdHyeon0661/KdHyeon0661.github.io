...
## 2. 프로젝트 설정 — 최소 의존성과 런처

### 2.1 Maven (5.x/6.x 공통 패턴: BOM 권장)
```xml
...
## 8. 테스트 더블 — Stub/Mock/Fake/Spy (Mockito 예)
...
## 12. 병렬 실행과 설정(`junit-platform.properties`)
