...
### 분기(제어) 해저드 — predict-not-taken (기본안)
...
## 사이클-트레이스 (포워딩/스톨/분기 동작 관찰)

### ADD → ADD (RAW, 포워딩으로 해결)
