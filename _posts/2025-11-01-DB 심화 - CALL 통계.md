...
## 실습: SQL Trace + TKPROF로 CALL 통계 얻기
...
## SELECT vs DML — CALL 통계 차이를 제대로 이해하자
...
## 예제: 동일 SQL, 페치 사이즈만 바꾸어 CALL 통계 비교
