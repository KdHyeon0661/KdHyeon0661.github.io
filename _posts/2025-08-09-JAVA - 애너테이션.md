...
## 4. 사용자 정의 애너테이션 — 정의 규칙/제약

### 4.1 허용되는 요소(Element) 타입
...
## 5. 적용 위치 확장 — TYPE_USE/TYPE_PARAMETER, MODULE, RECORD_COMPONENT
...
## 9. 컴파일 타임 애너테이션 프로세싱(AP) — 소스 생성/검증
...
## 11. 고급 설계 — enum/클래스 요소, 중첩/배열, 기본값 상수화
...
## 12. 패키지/모듈/레코드에 부착하는 실전 예

### 12.1 `package-info.java`
```java
@PublicApi
