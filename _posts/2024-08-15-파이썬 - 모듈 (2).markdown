...
- 여러 개의 모듈을 **디렉터리 형태로 묶은 것**
- 즉, `모듈들의 모음집`
- 패키지를 통해 **대규모 프로젝트도 깔끔하게 분리** 가능
...
- 해당 디렉터리를 **패키지로 인식시키는 파일**
- Python 3.3 이후 필수는 아니지만 **명시적으로 작성 권장**
- 초기화 작업, 모듈 노출 제어 등에 사용
