...
### 11.4 순서교환으로 내부가 상수화되는 예제(수치)
```python
import mpmath as mp

# I = ∫_0^1 ∫_0^x e^{y^2} dy dx = ∫_0^1 e^{y^2}(1-y) dy
