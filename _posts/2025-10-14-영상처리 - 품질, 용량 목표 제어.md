...
category: 영상처리
---
# **품질/용량 목표 제어(타깃 사이즈)** — `jpeg_mem_dest` + **이진 탐색**으로 “이 JPEG을 300KB 이하로”
...
## **품질 고정 인코딩** — `jpeg_mem_dest`로 한 번 압축해 바이트 얻기
