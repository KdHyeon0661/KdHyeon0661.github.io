...
## Crow’s Foot Notation — 기호와 조합의 정밀 해석
...
### 비식별 관계 예 — 주문-결제(결제는 독립 PK, 주문 FK만 보유)
...
## Crow’s Foot와 IE로 같은 모델 그리기(종합 예)

### 도메인: 고객–주문–주문항목–상품–결제–주소
...
## Crow’s Foot/IE와 UML 클래스 다이어그램 매핑
