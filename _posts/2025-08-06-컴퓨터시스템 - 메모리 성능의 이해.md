...
## 10. 데이터 레이아웃: AoS vs SoA, 정렬, 패딩, AoSoA
...
### 16.2 stride/working-set 스윕(캐시·TLB 계단)
```c
// stride_bench.c
#include <stdio.h>
#include <stdlib.h>
