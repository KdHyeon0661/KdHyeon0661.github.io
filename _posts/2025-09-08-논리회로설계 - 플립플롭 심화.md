...
### 1.3 여기사표(Excitation Table) — 합성 역문제에 사용
...
## 3. 플립플롭의 **부가 입력** (CE/Set/Reset/Load/Scan)
...
### 4.2 원시 흐름표(Primitive Flow Table) → 설계 절차
...
### 4.5 Muller C-element (SI 설계의 핵심 소자)
...
### 6.1 예제 A — **Mod-5 동기 카운터** (T FF 접근 → D FF 합성)
