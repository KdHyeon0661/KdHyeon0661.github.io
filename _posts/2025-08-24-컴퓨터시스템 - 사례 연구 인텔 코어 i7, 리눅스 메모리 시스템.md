...
## Core i7 메모리 하드웨어 구조 (개요와 현재적 관례)

### 캐시 계층(64B 라인, write-back, MESI 일관성)
...
## 리눅스 가상메모리: 주소공간·페이지·폴트

### 주소공간(64비트, 4/5-레벨 페이징)
...
## 실험 B — NUMA 로컬리티(First-Touch)와 이주
...
## 심화: VIPT·동의어(synonym)·포괄성 정책(한 페이지 설명)
