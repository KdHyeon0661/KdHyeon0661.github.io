...
## ON vs WHERE — 특히 OUTER JOIN에서의 차이
...
## NULL, 중복, 카디널리티(기수성) — 결과 정확성의 3대 변수
...
## 세미 조인·안티 조인 (EXISTS / NOT EXISTS / IN / NOT IN)
...
## 집합 연산(UNION/INTERSECT/EXCEPT)과 JOIN의 경계
...
## 조인 알고리즘: Nested Loops / Hash / Merge
