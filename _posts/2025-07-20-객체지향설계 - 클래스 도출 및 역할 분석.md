...
## 6. 사례 B — 전자상거래(주문·결제·정책)

### 6.1 변이 보호(가격/배송 정책은 **전략**으로)
```java
...
### 13.1 Responsibility Assignment Record (RAR)
```text
