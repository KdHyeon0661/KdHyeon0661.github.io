...
### 예제: 초미니 FUSE 파일시스템(읽기 전용, Python)
...
# as f: print(parse_mbr(f.read(512)))
...
# as f: print(parse_gpt_header(f.read(512)))
...
# 파티션 (sgdisk 사용; parted/fdisk도 가능)
