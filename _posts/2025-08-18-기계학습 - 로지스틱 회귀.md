...
## 3. 최적화: GD/SGD, L-BFGS, Newton/IRLS, SAGA
...
## 4. 정규화(Regularization): 과적합 제어와 해석
...
## 6. 해석(Explainability): 계수, 오즈비, 신뢰구간
...
## 8. 다중 클래스: OVR vs Multinomial(Softmax)
