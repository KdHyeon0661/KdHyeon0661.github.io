...
## 1. Razor Pages의 기본 라우팅 — 파일/폴더 매핑
...
## 5. 링크 생성: Tag Helper와 Url/LinkGenerator
...
## 8. Razor Pages 전용 Conventions — 글로벌 라우팅/권한/경로 재매핑
...
## 9. MVC 영역(Areas)와 Razor Pages 영역
...
## 12. 파라미터 변환기(Parameter Transformer) — 슬러기파이
...
## 16. Razor Pages·MVC·Minimal API 혼용
...
### 18.1 Razor Pages — SEO 별칭과 다국어, 슬러그 매핑
