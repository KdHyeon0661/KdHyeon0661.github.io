...
## 미들웨어의 해부학: Use / Run / Map / UseWhen

### `Use` — 전/후 처리 + 다음으로 흐름 전달
...
## 예외 처리: `UseExceptionHandler` vs `UseDeveloperExceptionPage`
...
## `UseEndpoints` 레거시 패턴(.NET 6)과의 정확한 연결
