...
category: 시스템보안
---
# 메모리 취약점 & 익스플로잇 기초 — “왜 깨지는가”를 몸으로 이해하기
...
## 버퍼 오버플로우(C/C++)의 본질 — 스택 프레임과 EIP/RIP 하이재킹
...
## 보호 기법 이해 — Canary, DEP/NX, ASLR, RELRO (그리고 PIE)
...
## 대표 취약점 4형제 — Format String, Use-After-Free, Double Free, Integer Overflow
