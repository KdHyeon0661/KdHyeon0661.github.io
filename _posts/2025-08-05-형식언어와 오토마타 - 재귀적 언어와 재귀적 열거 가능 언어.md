...
### 1.2 재귀적 열거 가능(RE / c.e. / 반결정 가능) 언어
...
### 4.2 RE이지만 Recursive가 **아닌** (RE \ Recursive)
...
### 4.3 non-RE (RE도 co-RE도 아님 혹은 co-RE이지만 RE 아님)
...
### 5.3 RE vs co-RE vs Recursive: 도베일링 정리
위 §1.3 등식. 실무적으로 가장 많이 쓰이는 “**둘 다 RE면 결정 가능**” 트릭.

### 5.4 (참고) Post–Kleene–Church–Turing 풍경
...
## 10. 작은 실습: “RE지만 Recursive가 아님”을 체감하기
