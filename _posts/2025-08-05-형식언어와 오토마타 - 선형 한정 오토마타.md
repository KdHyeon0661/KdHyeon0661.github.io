...
## 2. 표현력: **NLBA = CSL = \(\mathrm{NSPACE}(n)\)**
...
## 7. **CSG ↔ LBA** 변환 스케치(구현 감각)

### 7.1 CSG ⇒ LBA (규칙 매칭 스캐너)
