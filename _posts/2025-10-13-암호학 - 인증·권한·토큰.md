...
### Argon2 파라미터 프로파일(출발선; 실제 장비에서 측정 후 조정)
...
### Python 예제(Argon2id: `argon2-cffi`)
...
### Node 예제(`@node-rs/argon2` 또는 `argon2`)
...
### Python(검증 예: `python-jose`/`pyjwt` 개념)
