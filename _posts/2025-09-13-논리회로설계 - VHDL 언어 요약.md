...
## **순차문**: if/case/loop/wait/return/null
...
## **예제 모음** — 언어 기능을 망라한 작은 조각들

### 조합/동기 템플릿(래치 방지/CE 사용)
...
## **미니 프로젝트 예** — 파라메트릭 ALU (연산자/케이스/플래그)
