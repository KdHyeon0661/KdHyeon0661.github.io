...
## CloudFront — **캐시 히트율 = Origin egress 비용의 핵심**
...
## Global Accelerator — **Anycast + 전용 백본(성능/가용성 대가)**
...
### CloudWatch로 LCU 근사치 도출(요청/바이트/룰)
...
### Budgets & Anomaly(월 300달러 초과 경보 예시)
