...
# 1. 수정 가능 조인 뷰(Updatable Join View) 활용
...
## 1.2 예제: “카테고리 ELEC의 최근 주문(30일) 존재 상품의 가격에 3% 가산”
...
# 2. MERGE 문 활용 (존재하면 UPDATE, 없으면 INSERT)
...
# 3. 다중 테이블 INSERT (INSERT ALL / INSERT FIRST)
...
## 3.2 예제: 주문 상세(OI) 한 번 스캔으로 “일자·카테고리 합계”와 “일자·브랜드 합계”를 **동시 적재**
...
## 5.1 “지난달 ELEC 매출 있는 상품만 5% 인상” — 조인 뷰 UPDATE vs MERGE
...
## 5.2 “STG_PRICE로 가격 동기화 + 로그 테이블에도 기록” — MERGE + 다중 INSERT
