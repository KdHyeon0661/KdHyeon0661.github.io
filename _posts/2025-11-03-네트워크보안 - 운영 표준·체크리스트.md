...
## 29.1 분기별 네트워크 보안 헬스체크

### 29.1.1 헬스체크의 5축(5 Axes)
...
### 29.2.3 히트 분석(예: Elastic KQL/SQL)
**방화벽 로그 인덱스 가정(`fw-*`)**
