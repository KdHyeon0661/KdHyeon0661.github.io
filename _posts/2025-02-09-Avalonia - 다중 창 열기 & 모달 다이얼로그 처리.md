...
## ReactiveUI Interaction<TIn, TOut> — 완전 분리 패턴
...
## 결과 반환 패턴: `Close(T)` vs `TaskCompletionSource`
...
## 창 UX 고급: 위치/크기 복원, 닫기 차단, Topmost 등
