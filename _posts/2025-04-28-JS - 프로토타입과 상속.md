...
### 1.2 용어 정리: `[[Prototype]]` vs `__proto__` vs `prototype`
...
### 2.2 섀도잉(Shadowing)과 오버라이드(Override)
...
### 4.2 `instanceof`와 `Symbol.hasInstance`
```js
...
## 12. 보안: 프로토타입 오염(Prototype Pollution) 주의
