...
category: 디지털신호처리
---
# 디지털 필터에서의 반올림(라운딩) 영향과 A/D 양자화 잡음 분석

## 0) 큰 그림: “유한 정밀도”가 들어오는 두 지점
...
## 6) GNU Octave 실험 1 — 이상적 A/D 양자화 잡음 SNR 검증
...
## 7) GNU Octave 실험 2 — FIR이 A/D 잡음을 어떻게 처리하는가
...
## 8) GNU Octave 실험 3 — FIR 내부 라운딩 잡음
...
## 9) GNU Octave 실험 4 — IIR 내부 라운딩, limit cycle 감지
...
### 문제 7) truncation vs rounding 바이어스 비교
