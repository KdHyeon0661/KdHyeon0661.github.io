...
category: 정보보안기사
---
# SECTION 04 네트워크 기본 학습 — 04. IP(IPv4) 프로토콜
...
## 2. IPv4 헤더 구조(고정 20바이트 + 옵션 최대 40바이트)

### 2.1 ASCII 다이어그램 (비트 단위)
...
## 4. 서브넷팅·VLSM·요약(Route Summarization)
...
## 5. 분절(Fragmentation) & 재조립(Reassembly), PMTUD
...
### 6.2 RIB/FIB/Longest Prefix Match(LPM)
...
```bash
# 3. tcpdump: 분절/DSCP/ICMP PMTUD 관측
