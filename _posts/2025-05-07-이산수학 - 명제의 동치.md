...
## 정규형과 동치: CNF/DNF, Tseitin

### DNF(절대곱정규형) 만들기 — 진리표 기반
...
## 추가 실습 코드: CNF 변환(순수 등치 기반 소형 예제)
