...
### 최소 예제: `/etc/systemd/system/myapp.service`
...
## **소켓 활성화**: 요청 올 때만 실행(.socket)

### 예시: `/etc/systemd/system/myapp.socket`
...
### 서비스와 연결: `/etc/systemd/system/myapp.service`
...
### 서비스: `/etc/systemd/system/cleanup.service`
...
### 타이머: `/etc/systemd/system/cleanup.timer`
...
### 구성: `/etc/supervisor/conf.d/myapp.conf`
...
## **크론 @reboot vs systemd 타이머** (현대 권장)
...
## **레거시: SysVinit/`service`/`chkconfig`**
