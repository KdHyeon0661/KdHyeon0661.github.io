...
## JPEG 압축 원리 (Baseline/Progressive 개요)
...
### YCbCr 변환 (Rec.601, full-range 근사)
...
## JPEG 라이브러리 사용하기 (C API; `jpeglib.h`)
...
### **디코드: JPEG → `IppDib(BGRA32, top-down)`**
