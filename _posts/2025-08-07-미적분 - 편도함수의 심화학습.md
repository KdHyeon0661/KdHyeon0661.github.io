...
## 미분가능성 vs 편도함수 존재: 정교한 구분

### 편도함수는 있으나 미분가능하지 않은 고전 반례
...
## 편도함수와 연쇄법칙(다변수 체인룰)의 정교화

### 합성 \(f\circ g\) — \(g:\mathbb{R}^m\to\mathbb{R}^n\), \(f:\mathbb{R}^n\to\mathbb{R}\)
...
## 고급 미분가능성 계층: \(C^k\), Hölder, Lipschitz
...
## 수치 실습: SymPy/NumPy로 편도·헤시안·극값 판정

### 심볼릭 편도/헤시안·혼합편도 교환 확인
...
## 비평활 함수: 편도 존재 vs 아급미분(서브그래디언트) (간단 스케치)
...
## 수치 검증: 그래디언트 체크(유한차분 vs 심볼릭/오토디프)
