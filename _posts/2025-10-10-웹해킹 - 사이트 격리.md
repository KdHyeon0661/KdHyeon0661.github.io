...
category: 웹해킹
---
# COOP/COEP/CORP로 **사이트 격리(Site Isolation)**
...
## SharedArrayBuffer/WASM 사용 예 (고립이 되었는지 확인)
