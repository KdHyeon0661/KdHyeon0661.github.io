...
# fwmark 10 -> table 100
# table 100의 default gw를 별도 회선으로
# 마킹 예: 443 포트
# (root)
# ------------------------------------
...
## 연결성/경로/품질 — Ping·Traceroute·mtr·PathPing
...
## 포트/소켓 — LISTEN/ESTABLISHED·점유자(PID) 추적
...
## HTTP/HTTPS·프록시 — curl/Invoke-WebRequest/OpenSSL
...
## 방화벽/NAT — nftables/iptables/firewalld & Windows
...
## 진단 자동화 — Bash/PowerShell “1회 수집” 스크립트
