...
## 실전 예제 ① — **EPOLLET(엣지 트리거) 에코 서버**(C, 단일 스레드)
...
## 실전 예제 ② — **EPOLLONESHOT + 스레드 풀**(중복 처리 방지)
...
## 타이머/시그널/스레드 이벤트의 **FD화** — 리액터에 끼워넣기
