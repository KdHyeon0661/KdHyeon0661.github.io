...
### 3.2 다른 패키지에서의 `protected` — 올바른/잘못된 예
```java
// package a
package a;
public class Animal {
...
## 4. (default) — 패키지 전용(package-private)
...
## 6. 어디에 어떤 제어자가 “될까/안 될까” — 요소별 허용 조합
