...
### 1.2 확장성(Scalability)와 지연(Throughput/Latency)
...
## 13. 예제: 전형적 3티어(웹/앱/DB) 고가용 + 확장 풀스택
...
### 14.2 Aurora Global DB(요약, 실제 구성은 콘솔/CF 세부 파라미터 필요)
```bash
