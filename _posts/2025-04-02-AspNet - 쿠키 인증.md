...
## 5. Anti-Forgery와 SameSite 시나리오

쿠키 인증은 **CSRF 방어**가 핵심이다.

### 5.1 폼 기반 POST — Anti-Forgery Token
...
## 7. Claims/Principal 고급

### 7.1 ClaimsTransformation으로 동적 Claims 추가
...
### 7.2 강제 무효화(“Password/Role 변경 시 전체 재로그인”)
...
## 8. 쿠키 이벤트 훅(OnValidatePrincipal 등)
...
## 9. 데이터 보호(Data Protection)와 서명 키 운용
...
## 11. ASP.NET Core Identity와의 차이/연동
...
## 13. Swagger/JS/Ajax 환경에서의 401/403/리다이렉트 제어
...
### Program.cs(발췌) — Anti-Forgery API/리다이렉트 처리 포함
