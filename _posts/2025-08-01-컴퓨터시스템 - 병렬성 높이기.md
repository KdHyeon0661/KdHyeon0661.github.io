...
## TLP — 스레드 병렬화: for, reduction, task, 그리고 그레인
...
### CUDA 오프로딩 골격(전송/계산 오버랩은 Async+Streams 사용)
