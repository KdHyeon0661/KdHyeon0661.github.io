...
### 2.2 GNU Octave 예제 — `conv`와 동일성 확인
...
## 7. 블록 길이 \(L\), FFT 길이 \(N\) — 계산량·지연 트레이드오프
...
## 11. 파티셔닝(Partitioned Convolution) — 긴 IR을 빠르게
