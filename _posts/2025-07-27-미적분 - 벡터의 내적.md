...
### 1.3 내적의 공리(Inner Product Axioms)
$$
...
### 3.1 직교(orthogonality)
$$
\vec a\perp \vec b \iff \vec a\cdot \vec b=0.
$$

### 3.2 선(1차원 부분공간) 위 정사영
$$
...
## 9. PyTorch 예제 — 내적·각도·투영·그람–슈미트·작업(일) 적분
