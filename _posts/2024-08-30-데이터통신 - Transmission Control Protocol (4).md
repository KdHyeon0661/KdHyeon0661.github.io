...
---
# 24.3 Transmission Control Protocol — 혼잡 제어, 타이머, 옵션
...
### 2.3 Persist / Zero-Window Probe 타이머
...
### 3.3 윈도우 스케일 옵션 (Window Scale Option)
...
### 3.4 SACK (Selective Acknowledgment) 옵션
