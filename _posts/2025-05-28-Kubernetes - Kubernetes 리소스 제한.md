...
## QoS 클래스 — 왜 같은 상황에서도 어떤 Pod는 죽고, 어떤 Pod는 살아남나?
...
## 네임스페이스 기본값: **LimitRange** + 용량 상한: **ResourceQuota**

### LimitRange — 미지정 시 기본값/최대-최소 강제
...
## HPA/VPA/Cluster Autoscaler와의 상호작용
