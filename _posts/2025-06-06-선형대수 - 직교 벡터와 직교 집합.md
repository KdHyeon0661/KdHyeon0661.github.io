...
## 직교보완(Orthogonal Complement)와 기본 4공간
...
### 부분공간 \(W=\mathrm{span}\{u_1,\dots,u_k\}\) (정규직교 기저)로의 투영
...
# 벡터를 직교 분해: v = proj_u(v) + residual ⟂ u
