...
## Windows 배포: EXE(단일 파일)·MSIX·Squirrel
...
## Linux 배포: AppImage / DEB / RPM / Flatpak
...
### Avalonia.Extensions.Update (크로스)
...
## CI/CD: GitHub Actions 매트릭스 빌드 + 릴리즈
