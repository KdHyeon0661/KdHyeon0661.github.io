...
### 10.1.1 가상 메모리(Virtual Memory)의 목적
...
### 10.2.2 유효 접근 시간(EAT) with 페이지 폴트
...
### 10.2.5 단순 교체 시뮬레이터 (FIFO/Clock 비교)
...
### 10.3.5 사용자 공간에서 COW를 흉내 낸 데이터 구조(개념 확장)
