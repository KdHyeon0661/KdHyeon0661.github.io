...
category: 정보보안기사
---
# 완전 정리 (DORA/SARR·필드/옵션·DHCPv6·릴레이/옵션82·PXE/VoIP·보안(DHCP Snooping/DAI/ISG)·HA/Failover·Windows/리눅스/Kea/dnsmasq·모니터링/트러블슈팅·실습·체크리스트)
...
## DHCPv6 — SLAAC와의 관계, SARR, DUID/IAID
...
## 보안 — Rogue DHCP·Starvation·스푸핑 방지
