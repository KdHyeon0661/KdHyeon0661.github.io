...
### DAD(Duplicate Address Detection: 중복주소 탐지)
...
## ICMP / ICMPv6: 에러·에코, 진단 활용 (⚙️)

### ICMP(IPv4) & ICMPv6(IPv6) 큰 그림
...
### “IPv6만 느리다 (Happy Eyeballs로 v4가 더 빨리 선택)”
