...
## 보안/격리: userns-remap, rootless, TLS
...
### “Elasticsearch/Chromium 컨테이너가 OOM/Shared Memory 부족”

- `default-shm-size` 상향(§3.4) 또는 **컨테이너별 `--shm-size`**
- cgroups 메모리/스왑 제한도 점검

### “쿠버네티스 노드에서 파드가 자주 CrashLoopBackOff”
