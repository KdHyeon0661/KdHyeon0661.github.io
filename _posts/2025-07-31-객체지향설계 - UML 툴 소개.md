...
### 8.1 PlantUML 공통 헤더(`_common.puml`)
```plantuml
' 프로젝트 공통 테마/스킨
...
### 8.4 GitHub Actions(문서 사이트 빌드 포함)
```yaml
name: docs
on: [push]
jobs:
