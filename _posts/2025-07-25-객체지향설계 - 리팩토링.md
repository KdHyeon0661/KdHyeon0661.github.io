...
## 예제 1 — 긴 메서드 분해(Extract Method, Decompose Conditional)
...
## 예제 2 — 정책 다형화(Replace Conditional with Strategy)
...
## 예제 3 — 값 객체 도입(Primitive Obsession → Introduce Value Object)
...
## 예제 4 — 합성으로 전환(Replace Inheritance with Composition)
...
## 예제 5 — Repository 포트 도입(의존 역전 + 테스트 용이성)
...
## 위험·의사결정 매트릭스(Refactor vs Rewrite)
