...
category: Svelte
---
# 17. 고급 토픽 (2) — **D3 / Three.js / MapLibre 통합 · 데스크톱/모바일 포장(Tauri / Electron / Capacitor)**
...
### 1.3 반응형 + 스크롤 가시성 렌더링(IntersectionObserver)
