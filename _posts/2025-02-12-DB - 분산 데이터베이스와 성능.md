...
## 샤딩(Sharding)과 쿼럼(Quorum)의 성능 수학
...
## 실전 설계 절차 — “샤딩 키 → 라우팅 → 일관성 → 실패 모델 → 운영”
...
### CockroachDB/YugabyteDB — 글로벌 트랜잭션과 파티셔닝
...
### CockroachDB 트랜잭션 재시도(낙관적 충돌 대응)
