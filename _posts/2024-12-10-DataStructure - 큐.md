...
## 9. 모노토닉 큐(Monotonic Queue) — 슬라이딩 윈도우 최대
...
## 11. 블로킹 큐(Blocking Queue) — 생산자–소비자
...
## 12. (스케치) SPSC 링 버퍼 — 한 생산자·한 소비자 무락 패턴
