...
# ---------------------------
# 4) ε-NFA -> DFA (subset construction)
# ---------------------------
class DFA:
...
### 6.4 “(ab)*”: `ab`가 0회 이상 반복

```regex
(ab)*
```

### 6.5 “a?b+”: `b`가 1회 이상, 앞에 `a`는 있어도 되고 없어도 됨
