...
category: Elixir
---
# 10장 Enum과 Stream — 컬렉션과 스트림 처리의 모든 것
...
### 10.1.1 Enum이 다루는 대상 — Enumerable 프로토콜
...
### 10.1.2 핵심 변환 — map / filter / reduce
...
### 10.1.6 맵/MapSet 다루기 — Enumerable로 일관 처리
...
### 10.1.10 커스텀 컬렉션을 Enumerable로 만들기
...
### 10.2.1 기본 사용 — map/filter는 “계산 식”을 만든다
...
### 10.2.4 transform — map + filter + scan 을 한 번에
...
### 10.2.5 resource — 외부 리소스(파일/소켓)를 안전하게
...
### 10.2.6 chunk_every / chunk_by — 스트림에서도 배치 처리
...
### 10.2.7 파이프라인 예제 — 큰 텍스트에서 상위 단어 20개
...
### 10.2.8 Stream vs Enum — 언제 무엇을 쓸까?
...
### 10.3.4 테스트 & 문서화 팁 (ExUnit + doctest)
