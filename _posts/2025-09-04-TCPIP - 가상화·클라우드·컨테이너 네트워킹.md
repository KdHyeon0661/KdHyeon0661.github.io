...
# TAP 만들고 브리지에 붙이기(QEMU가 자동 생성하기도 함)
...
## 클라우드 VPC: 서브넷·라우팅·NAT·SG/NACL (⚙️)
...
## 컨테이너 네트워킹: CNI·Pod·Service·Ingress (⚙️)
...
## CNI 구현 비교: Flannel/Calico/Cilium/Weave (⚙️)
...
### NodePort·LoadBalancer·Ingress 상호작용
...
### Hairpin NAT(NodePort/Pod→자기 서비스)
