...
### 선택 알고리즘(최소 k번째, Median-of-Medians)
...
### \(T(n)=2T(n/2)+n^\alpha\) (일반 \(0<\alpha<1\))
...
## 대입법(Substitution)으로 엄밀 증명

### Merge Sort 상한 증명 스케치
...
## 보너스: Divide & Conquer DP Optimization (한 줄 메모)
