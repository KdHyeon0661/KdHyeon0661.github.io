...
## 18.1 수집 대상(방화벽/프록시/DNS/NetFlow)

### 18.1.1 수집 우선순위(Top 10)
...
### 18.2.3 Elastic KQL 예(다중 이벤트 상관)
...
### 18.3.3 SOAR 파이썬(개념) — Slack 승인 후 격리
```python
...
### 18.4.2 SIEM 룰(Elastic Detection Rule YAML 예)
```yaml
...
### 18.4.4 경보 → SOAR 컨텍스트(enrichment)
