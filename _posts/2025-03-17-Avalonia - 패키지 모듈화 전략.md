...
## 6. 모듈 구현 예시 — Dashboard

### 6.1 ViewModel/Service
...
## 8. ViewLocator/VM Locator — 느슨한 결합
...
## 15. 모듈 간 메시징(옵션) — Mediator/EventBus
