...
## TLV 헤더 (Type-Length-Value)

### 포맷 정의(예시: 1B Type, 3B Length, N Byte Value)
...
## 큰 메시지, 조각내기(Chunking), 최대 프레임(cap) 정책
...
## 미니 프로젝트 — 파일 스트리밍 프로토콜(Chunked TLV)
