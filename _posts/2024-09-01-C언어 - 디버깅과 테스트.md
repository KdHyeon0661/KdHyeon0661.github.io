...
## 메모리 버그 탐지: Sanitizer와 Valgrind

### Address/Undefined Sanitizer (권장)
...
## 커버리지(gcov/lcov) — 테스트가 코드를 얼마나 덮었나
...
## Makefile 스니펫 — 디버그/릴리스/산타이저/커버리지
