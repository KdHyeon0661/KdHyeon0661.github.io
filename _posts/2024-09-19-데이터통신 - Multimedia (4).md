...
## 1. Rationale for New Protocols (왜 새로운 실시간 프로토콜이 필요한가)
...
### 2.3 예제 시나리오: 간단 VoIP 통화의 RTP 흐름
...
## 4. Session Initiation Protocol (SIP) — Session Initialization Protocol
...
### 4.3 SIP 메시지 형식과 주요 메서드

SIP는 HTTP와 유사한 **텍스트 기반 프로토콜**입니다.  

#### 4.3.1 요청 메시지 예제 (INVITE)
...
### 5.4 예제: H.323 화상 회의 콜 플로우(간단 버전)
