...
category: 정보보안기사
---
# SECTION 07 애플리케이션 기본 학습 — 03. FTP(File Transfer Protocol) 완전 정리 (프로토콜 구조, Active/Passive, 명령/응답, NAT/방화벽, FTPS/SFTP, 보안 위협·완화, 서버 하드닝 vsftpd/ProFTPD/Pure-FTPd/IIS, 클라이언트 실습 curl/lftp/Python/PowerShell, 로깅·감사, 운영 체크리스트)
...
# 수동(PASV) 데이터 포트 범위 (예: 50000-50100)
...
## 7. 서버 하드닝 — vsftpd / ProFTPD / Pure-FTPd / IIS

### 7.1 vsftpd (리눅스: 경량·보안 중심)
