...
## 암호 구현 취약(Nonce 재사용, Padding Oracle, RNG)

### Nonce/IV 재사용의 파괴력

#### CTR/GCM에서 **nonce 충돌** → 평문 노출/위조
