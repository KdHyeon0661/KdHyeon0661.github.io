...
category: 정보보안기사
---
# SECTION 04 네트워크 기본 학습 — 01. 네트워크와 보안 위협(공격) · 02. OSI 7계층(OSI 7 Layer) 모델
...
## 2. L2(데이터링크) 보안: 스위칭·ARP·DHCP·STP

### 2.1 ARP 스푸핑 & DAI(Dynamic ARP Inspection)
...
## 3. L3(네트워크) 보안: IP 스푸핑, 라우팅·ICMP

### 3.1 uRPF(역방향 경로 검증) & BCP38
...
## 4. L4(전송) 보안: TCP/UDP, SYN Flood 대응
...
## 10. 실습: 안전한 진단·모니터링 명령(방어/가시성 중심)
