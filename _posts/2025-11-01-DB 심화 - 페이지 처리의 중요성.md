...
## 5. “일관된 페이지”를 위한 스냅샷 전략

### 5.1 단일 요청 내 일관성: Oracle의 **Consistent Read**
...
## 6. 부분범위처리(Stopkey)와 인덱스 설계

### 6.1 무엇이 Stopkey를 가능하게 하나?
