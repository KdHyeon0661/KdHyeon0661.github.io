...
### 스위칭의 핵심: **MAC 학습(Learning) → 포워딩(Forward) → 필터(Filter) → 플러딩(Flood)**
...
## VLAN(802.1Q), 트렁크/액세스 포트, MTU 개념 (⚙️)

### VLAN: L2를 **논리적 네트워크**로 분리
...
## LAG(링크 집성), STP/RSTP(루프 방지) 개요 (🚀)

### LAG(IEEE 802.1AX/옛 802.3ad): **여러 물리 링크를 하나의 논리 링크로**
...
### STP(802.1D)/RSTP(802.1w)/MSTP(802.1s): **루프 방지**
