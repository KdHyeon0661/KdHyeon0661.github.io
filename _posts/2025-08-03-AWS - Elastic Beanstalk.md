...
## 환경 구성: .ebextensions / .platform 훅 / nginx 커스텀
...
## Docker로 EB 사용(멀티 컨테이너/ECS 기반)

### Dockerrun.aws.json v2 (멀티 컨테이너)
...
### .platform/nginx/conf.d/https-redirect.conf
...
## CloudFormation / CDK로 EB 자동화(요약)

### CloudFormation 스니펫(요지)
