...
## 2) IIR 필터 구조 — Direct Form, 캐스케이드, 병렬
...
## 3) FIR 필터 구조 — Direct, Transposed, 선형 위상, Polyphase
...
## 4) 격자(Lattice) 필터 구조 — FIR Lattice–Ladder
...
## 7) 필터 계수의 양자화 — IIR/FIR 비교, SOS 구조
