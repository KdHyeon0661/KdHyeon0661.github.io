...
## 예제 2 — 병렬 합계: OpenMP vs std::thread 비교
...
### 사용자 수준 스레드(Fiber/Coroutine)와 비동기
...
## 예제 3 — Readers–Writers 문제 (rwlock vs mutex)
...
## 예제 4 — Lock-Free 구조(학습용) : MPMC 원형 큐 스케치
...
## 예제 5 — I/O 바운드: async + threadpool 하이브리드(개념)
