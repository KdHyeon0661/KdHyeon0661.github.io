...
## 표준 함수형 인터페이스 지도(java.util.function)
...
## 실전 설계 패턴 — 함수형 인터페이스로 API를 더 선명하게

### 빌더/옵션 구성에 `Consumer<Builder>` 사용
...
### Stream Collector with method references
