...
### 포함성(Inclusion)·분리성(Disjointness)
...
### 접두사/접미사 관련(Prefix/Suffix/Substring)
...
## 파이썬 레퍼런스 코드 — DFA/NFA 및 결정 문제 도구
...
# NFA: “도달 가능한 모든 상태를 시작상태”로 하는 NFA
...
### 짝수 개의 `0` DFA (Membership/Universality/Prefix)
