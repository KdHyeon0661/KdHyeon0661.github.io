...
### 1.3 DHCP 충돌/중복 IP 예방, VLAN 분리 선택지
...
### 1.4 Compose로 붙이기(외부 macvlan 참조 권장)
...
## 2. Overlay + Consul: Swarm 밖에서도 이름 기반 통신
...
### 2.5 Swarm 없이 Consul만? (단일 호스트/bridge)
...
### 5.2 Overlay + Consul + Registrator(스웜)
