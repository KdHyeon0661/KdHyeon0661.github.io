...
## x86-64 주소 변환 — 4/5 레벨 페이징, NX/SMEP/SMAP

### 4-레벨(전통 48-bit canonical) 주소구조(4KB 페이지)
...
## ARMv8(AArch64) 개요 — TTBR, PXN/UXN, 가변 페이지 크기
...
## TLB(Translation Lookaside Buffer) — 주소 변환의 캐시
...
## 성능 튜닝 — TLB·huge page·NUMA·madvise

### Transparent Huge Pages(THP) vs hugetlbfs
...
## 보안/격리 — W^X, NX, SMEP/SMAP, ASLR, KASLR
...
### Transparent Huge Pages(THP) ON/OFF 비교(히ント)
