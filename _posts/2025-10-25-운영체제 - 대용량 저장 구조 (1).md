...
### 11.2.4 시뮬레이션: 헤드 이동 총량/평균 응답 비교 (Python)
...
### 11.3.3 호스트 I/O 스케줄러(blk-mq)와 정책
...
### 11.3.4 Read/Write 혼합 워크로드에서의 스케줄링
...
### 11.3.5 큐딥/혼합비율/GC를 반영한 간단 시뮬레이터 (Python)
...
### 11.3.6 FTL 관점 스케줄링/가비지 컬렉션 상호작용
...
### 11.3.8 예제: 리눅스에서 스케줄러/큐딥 설정과 측정(학습 스크립트)
```bash
