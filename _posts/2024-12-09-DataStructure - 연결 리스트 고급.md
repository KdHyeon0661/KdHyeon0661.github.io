...
## 다중 연결 리스트 (Multi-level / Multi-pointer)
...
## Unrolled Linked List (분해/언롤드 리스트)
...
## Looping / Self-referential List (루프/자가참조)
...
### 희소 스프레드시트(2D + Sentinel 행/열 Header)
