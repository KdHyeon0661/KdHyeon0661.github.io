...
## **a^n b^n c^n** 를 생성하는 **예시 CSG**(아이디어에 충실한 버전)
...
## **멤버십 판정**을 위한 구성 그래프 탐색(의사코드)

### LBA 멤버십 — \(\mathrm{NSPACE}(n)\) 알고리즘(BFS/DFS)
...
## **감소(Undecidability) 스케치** — 공백성/보편성 등
