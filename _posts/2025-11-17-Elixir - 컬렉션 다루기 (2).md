...
category: Elixir
---
# Collectable와 컴프리헨션 — 수집과 생성의 끝판 정리
...
## Collectable 프로토콜 — ‘모이는 쪽 끝’을 규정한다
...
### Collectable + Enum.into/3 — 변환과 수집을 한 번에
...
### `:into` — 수집 대상을 바꾼다(Collectable 연동)
...
## 과거의 신성함으로부터 돌아오기 — 고전 문법을 현대적으로 쓰기

이제 Enum/Stream/Collectable/컴프리헨션을 **조합해서 설계**할 때의
실전 원칙들을 정리해 보자.

### 원칙 1 — “핫 루프만 현대적으로 최적화”
...
### 원칙 2 — 문자열·바이너리는 컴프리헨션과 Collectable이 강하다
...
### 원칙 3 — DSL/옵션 처리에서 Collectable을 ‘양 끝’으로
...
### 토큰화 + 2그램 상위 10개 (컴프리헨션 + frequencies)
...
### Collectable로 iodata 기반 Lines 수집기
