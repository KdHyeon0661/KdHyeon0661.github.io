...
## 수 체계와 위치 표기 (Positional Number System)
...
## 2진 산술 — 덧셈/뺄셈/곱셈/나눗셈과 오버플로

### 1비트 덧셈과 전가산기(Full Adder)
...
## 2진 코드 — BCD/Excess-3/Gray/문자/오류정정

### 가중 코드(Weighted Codes)
...
## 실습: 변환/코딩 유틸 — 하나로 묶어서 써보기(Python)

```python
# 진법 변환 (2) 2의 보수 표현/해석 (3) Gray/BCD/Hamming
