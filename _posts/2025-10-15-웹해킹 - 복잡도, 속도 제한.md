...
category: 웹해킹
---
# 복잡도/속도 제한: **GraphQL Depth/Cost, 파일 처리 제한**
...
## **Apollo Server** 플러그인: *깊이/노드/비용* 동시 제한
...
## Persisted Query(화이트리스트) + 인트로스펙션 정책
