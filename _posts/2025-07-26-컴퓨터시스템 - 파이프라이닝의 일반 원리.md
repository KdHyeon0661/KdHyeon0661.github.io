...
### Software Pipelining(이름은 같지만 컴파일러 기법)

- 서로 다른 반복의 단계들을 겹치게 스케줄(II 최소화). VLIW/EPIC에서 흔함.

---

## 설계·제어 의사코드 (정수 5-stage 가정)
...
## 예제—타임라인 비교 (forwarding 없음 vs 있음)
...
## 확장: Superscalar / OOO / Tomasulo / ROB
