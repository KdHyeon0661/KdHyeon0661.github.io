...
## 재귀적 정의(Recursive Definition) — 형식과 예
...
## 구조적 귀납법(Structural Induction) — 원리와 스키마
...
## 코드로 보는 재귀 정의 & 구조적 귀납법

### Python — 리스트 성질 검증 (단위/속성 테스트)
