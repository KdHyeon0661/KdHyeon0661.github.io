...
## 2. 의도된 사용(Allowed) / 비사용(Disallowed)
...
## 3) JSON/YAML 스키마 (머신 판독·자동화용)

### 3.1 모델 카드 — JSON 스키마(간단)
...
## 7) 카드 자동 생성 스크립트 (PyTorch + 표준 라이브러리만)
