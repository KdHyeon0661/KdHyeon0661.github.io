...
### xUnit + FluentAssertions로 단정 가독성 높이기
...
### Bogus/AutoFixture로 테스트 데이터 자동 생성
...
## 통합 테스트 — WebApplicationFactory로 E2E
...
## EF Core InMemory/Sqlite로 데이터 계층 테스트

### 간단한 Repository + DbContext
...
### 자동 400/ProblemDetails 활성화 (`[ApiController]`)
...
### 통합 테스트(환경 변수/환경별 appsettings로 교체)
...
## 테스트 구성 확장 — Fixtures/Collection Fixtures

### 클래스 Fixture (`IDisposable`)
