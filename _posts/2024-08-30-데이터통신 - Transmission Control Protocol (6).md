...
---
# 24.4 SCTP — Association, Flow Control, Error Control
...
### 1.3 Association 수립: 4-way Handshake 복습
...
### 3.1 오류 검출: CRC32c와 Zero Checksum 확장
...
### 3.4 Fast Retransmit: SACK gap 기반
...
### 3.5 부분 신뢰(Partial Reliability)와 FORWARD TSN
