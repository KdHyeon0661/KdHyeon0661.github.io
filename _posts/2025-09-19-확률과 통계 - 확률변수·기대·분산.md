...
## Hook — “같은 평균, 다른 분산은 완전히 다른 제품 경험”
...
## 실전 예제 2 — 캠페인 합치기: 평균의 함정 vs 비율의 비율
...
## 실전 예제 3 — 세션당 페이지뷰 분산이 인프라에 주는 메시지
...
## 심화: 모멘트·MGF, 꼬리제어(마르코프·체비셰프) 한 줄 맛보기
