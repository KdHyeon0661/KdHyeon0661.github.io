...
## 2. ELF 목적 파일(Object; ET_REL) — 섹션/심볼/재배치
...
## 3. 재배치(Relocation) — “주소 미정”을 링크 시 패치
...
## 7. 코드로 보는 재배치: 절대 vs PC-relative
...
## 9. PIE/PIC·RIP-relative — 위치 독립과 재배치
