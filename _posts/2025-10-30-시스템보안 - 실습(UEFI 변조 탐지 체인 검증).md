...
### Linux에서 서명되지 않은 모듈 로드 시도(차단 확인)
...
### shim/GRUB 취약 버전 차단(dbx/SBAT) 검증(개념)
...
### Windows: Exploit Protection + WDAC/Smart App Control(개념)
...
### Sysmon(Windows) — 이동식 미디어/드라이버 감시(발췌)
