...
## 15.3.3 Secure Boot 상태 점검(게스트 OS 내부)
...
## 15.3.4 Measured Boot(측정) 확인 및 이벤트 로그 수집
...
## 15.3.5 변조 시나리오(“안전한” 재현을 위한 개념 실험)
...
## 15.3.6 원격 검증(Attestation) – TPM Quote + 정책 판단
...
## 15.4.2 디바이스 제어(USB/HID/외부매체) 정책
...
## 15.4.3 부트/디바이스 정책을 SIEM로 연결(탐지·대응)
