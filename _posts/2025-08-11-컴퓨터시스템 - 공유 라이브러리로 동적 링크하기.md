...
## 4. 실행 시 동작 — 로더, 검색 경로, 재배치

### 4.1 검색 경로의 우선순위(일반 프로세스)
...
## 13. 실험: Lazy vs Eager, RUNPATH 확인
