...
## 7. 의존성 주입(DI)과 구성(Configuration)
...
## 9. 인증/인가(Identity, JWT, 정책 기반)

### 9.1 Cookie 기반(서버 렌더링)
```csharp
...
## 11. 성능: 캐싱/압축/Rate Limiting/풀 튜닝
...
## 15. 로깅/관측성: Serilog, OpenTelemetry, Health Checks
...
## 17. 배포: Docker, Nginx, GitHub Actions, Azure

### 17.1 Dockerfile(.NET 8)
```dockerfile
# 1. 빌드
...
## 18. 예제 미니 프로젝트: Admin Razor + Public API 결합
...
## 21. 구성/비밀 관리: 환경별 설정, User Secrets, KeyVault
...
## 23. 마이그레이션(ASP.NET Framework → Core) 간단 전략
