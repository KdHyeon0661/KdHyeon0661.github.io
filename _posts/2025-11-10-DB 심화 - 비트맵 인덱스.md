...
## 3.4 범위+다차원: 날짜는 B-Tree, 속성은 Bitmap
```sql
-- 최근 30일 + 카테고리·채널 필터
...
# 4. `records_per_block` — 비트 위치와 ROWID의 **매핑 단위**
...
# 6. 고급: Bitmap Join Index (BJI) 맛보기
