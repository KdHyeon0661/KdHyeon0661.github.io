...
#### \(x^x\equiv a\) 형식(지표를 취해도 \(x\)가 지수에도 있어 일반론은 곤란하지만, \(x\)가 특정 집합으로 제한되면 모듈러 선형화로 접근).
