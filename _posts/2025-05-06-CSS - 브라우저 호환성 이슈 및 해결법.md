...
## 빈도가 높은 이슈 패턴 — 원인과 바로 쓰는 해결책

### `100vh` 오작동(모바일 주소창) → `100dvh` / `-webkit-fill-available`
...
## 수학적 관점(선택적) — 뷰포트 비율 기반 타이포 `clamp()`
