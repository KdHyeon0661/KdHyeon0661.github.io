...
## 관측·탐지 — 패킷·플로우·애플리케이션의 다층 융합

### 패킷 기반 IDS/IPS 룰(개념 예; 실전은 공식 룰셋 권장)
