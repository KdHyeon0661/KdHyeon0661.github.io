...
### Named 세마포어 (프로세스 간, 파일시스템 네임스페이스)
...
## 대표 패턴 ②: **동시 실행 수 제한(레이트 리미팅/토큰 버킷)**
...
## 대표 패턴 ③: **배리어(Barrier) — 두 번들 문(2-phase)**
...
## 대표 패턴 ④: **Readers–Writers (세마포어 버전, 간단)**
