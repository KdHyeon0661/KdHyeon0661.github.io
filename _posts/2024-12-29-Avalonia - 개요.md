...
## MVVM 구조로 확장하기 (CommunityToolkit.Mvvm 예시)
...
### ViewModel 예시 (ObservableCollection + 커맨드)
...
### 바인딩 UI (TextBox + Button Command + ListBox)
...
## 리스트·그리드 UI (ItemsControl, ListBox, DataGrid)
...
### 간단 DI (Microsoft.Extensions.DependencyInjection)
...
## 배포 (self-contained, 런타임 지정, 단일 파일 선택)

### 기본 self-contained 배포
...
## 예제 프로젝트 정리: To-Do + 통계 화면

### StatsViewModel (완료율 계산)
