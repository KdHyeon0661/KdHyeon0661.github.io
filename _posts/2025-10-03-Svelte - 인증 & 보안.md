...
## JWT(Access / Refresh) – 회전(Rotation) 패턴
...
## OAuth/OIDC(소셜 로그인) — Authorization Code + PKCE
...
## 서버 훅: `hooks.server.ts`에서 가드/주입/프록시
...
## CSRF 방어 — Double Submit Token 패턴
