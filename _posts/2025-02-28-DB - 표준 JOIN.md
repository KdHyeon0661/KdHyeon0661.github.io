...
## FULL OUTER JOIN — MySQL 등에서의 안전한 에뮬레이션
...
## N:M 조인과 중복 곱 — 집계/Distinct 선행으로 ‘폭발’ 방지
...
## 데이터 타입/정렬 방식/Collation/암묵적 캐스팅 — ‘묵시적 함정’ 제거
...
## 집합 연산(UNION/INTERSECT/EXCEPT) vs JOIN — 언제 무엇을?
