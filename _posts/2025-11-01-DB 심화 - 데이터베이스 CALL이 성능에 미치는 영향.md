...
## “DB Call”이란 무엇인가? (User vs Recursive, Parse/Execute/Fetch)
...
### **N+1 쿼리(ORM)** — 목록 조회 후 각 행마다 추가 조회
...
### **Statement 재준비/하드파싱 남발**(리터럴/텍스트 변형)
...
### **선택적 검색조건을 OR로 처리**(SARGability 저하)
...
## **user call vs recursive call** — “호출 수”와 “호출 1회당 내부 일”의 상관
