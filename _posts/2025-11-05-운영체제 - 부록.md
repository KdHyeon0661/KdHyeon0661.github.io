...
*(A: Influential Operating Systems • B: Windows 7 • C: BSD UNIX • D: The Mach System)*  
- 모든 코드는 ```…```로 감싸고, 수식은 **반드시** $$…$$ 로 감쌉니다.  
- 실습은 “바로 돌려볼 수 있는” 단위로 준비했습니다(플랫폼 표기).
...
### A.3 UNIX(Thompson & Ritchie) — 간결한 추상화
