...
## 2. 콜백의 진화: 함수 포인터 → 함수 객체(functor) → `std::function` → 람다
...
## 10. Ranges, `span`, 구조적 바인딩, `constexpr`
...
## 13. 시간/동시성: `chrono`, `thread`, `mutex`, 병렬 알고리즘
...
## 17. 작은 종합 예제 — **Safe Plugin Loader**
