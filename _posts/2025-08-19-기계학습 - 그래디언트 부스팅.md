...
## 함수최적화 관점: Functional Gradient Descent
...
### 회귀 — MSE vs Huber vs Quantile (예측구간)
...
# 특성 중요도 (기본 gain 기반 + permutation 권장)
