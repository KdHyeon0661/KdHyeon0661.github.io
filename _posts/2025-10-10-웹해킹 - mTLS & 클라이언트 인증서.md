...
# 2. 서버 키/CSR (SAN: DNS=api.internal)
...
# 3. 클라이언트 키/CSR (SAN: URI=spiffe://svc/payment)
...
### 4.4 Nginx (다운스트림 mTLS + 업스트림 mTLS)
...
### 4.5 Envoy (다운스트림/업스트림 TLS Context)
