...
## VPC Endpoint Policy로 S3 접근 최소 권한 (Gateway/Interface 공통 개념)
...
### S3 읽기 전용: Endpoint Policy (Gateway Endpoint: com.amazonaws.<region>.s3)
...
### S3 Bucket Policy: 프라이빗 강제 (Endpoint + Principal + TLS)
...
## CloudFront + WAF + Shield Advanced로 DDoS/웹공격 방어
...
### CloudFront + OAC + Private S3(정적 자산)
...
## 통합 IaC 예시(CloudFormation 스니펫 모음)
