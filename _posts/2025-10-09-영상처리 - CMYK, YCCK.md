...
## 2. Adobe APP14(0xFFEE) 마커 — transform 규칙
...
## 4. 코드 — Adobe APP14 파싱 + YCCK/CMYK 전처리 + BGRA 출력
...
## 6. (선택) ICC 기반 **정밀** CMYK → sRGB 변환 (lcms2)
