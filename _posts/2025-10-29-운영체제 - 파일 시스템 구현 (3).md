...
## Example: The WAFL File System (Write Anywhere File Layout)
...
### 쓰기 경로: “Write Anywhere + Consistency Point(CP)”
...
### WAFL 스타일 COW-트리 체크포인트 미니 시뮬레이터(Python)
