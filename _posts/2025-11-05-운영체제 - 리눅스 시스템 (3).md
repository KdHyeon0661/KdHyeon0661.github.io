...
### eventfd/signalfd/timerfd + epoll 결합
...
### 예제 — 비특권 포트 바인딩 + seccomp + chroot

```bash
# 바이너리에 cap_net_bind_service 부여
