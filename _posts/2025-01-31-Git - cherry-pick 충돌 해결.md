...
## 2. 재현 가능한 실습 레포 — 스크립트 한 번으로 환경 구성
...
## 4. Cherry-pick 충돌 해결 — 단계별 상세 가이드
...
## 9. Rebase vs Cherry-pick 충돌 — 확장 비교
