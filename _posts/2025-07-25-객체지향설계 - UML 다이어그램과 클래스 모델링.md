...
## 5. 예제 1 — 은행 계좌 도메인(PlantUML + OCL + Java)

### 5.1 클래스 다이어그램 (PlantUML)
```plantuml
@startuml
...
## 7. 관계 심화: 연관 클래스·한정·n-항 연관

### 7.1 연관 클래스(Association Class)
...
## 8. 일반화 집합(Disjoint/Overlapping, Complete/Incomplete)
