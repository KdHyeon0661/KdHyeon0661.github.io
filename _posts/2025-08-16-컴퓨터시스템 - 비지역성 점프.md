...
category: 컴퓨터시스템
---
# — `setjmp`/`longjmp`·`sigsetjmp`/`siglongjmp`의 원리, 안전한 패턴, 성능·이식성·신호 연계

## 개요 — “호출 스택을 건너뛰어 되돌아간다”
...
## 신호와 함께 쓰기 — `sigsetjmp`/`siglongjmp`
