...
## 1. 셸 리다이렉션 표(Bash/Zsh 기준, POSIX 표준 여부 표기)
...
## 2. 핵심 법칙 — “**`2>&1`은 그 **시점의** stdout을 복제한다**”
...
## 9. C로 보는 리다이렉션 — `dup2/dup3`와 `exec`

### 9.1 stdout/stderr을 파일로 돌리기
```c
// redirect_stdio.c
#include <unistd.h>
#include <fcntl.h>
...
## 20. 내구성 요약 — 리다이렉션은 “경로”일 뿐, 데이터 안전은 별도
