...
### Java 예 — Extract Method + Rename + Introduce Parameter Object
...
### JS/TS 예 — Extract Function + Change Signature
...
### Java/Maven(또는 Gradle) + SonarQube/PMD/Checkstyle/SpotBugs
...
### Python + Flake8/Black/isort/MyPy/Bandit + pytest
...
## CI/CD 파이프라인 예시 — GitHub Actions(Matrix)
