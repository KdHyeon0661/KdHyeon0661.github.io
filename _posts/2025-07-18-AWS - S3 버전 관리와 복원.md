...
## 6) 실무 설계 — 수명주기(Lifecycle)로 **오래된 버전 자동 처리**

### 6.1 비최신 버전 자동 삭제(180일)
...
### 6.2 비용 최적화: 비최신 버전을 Glacier로 전환
...
## 11) S3 버전 관리 vs Object Lock (상호보완)
