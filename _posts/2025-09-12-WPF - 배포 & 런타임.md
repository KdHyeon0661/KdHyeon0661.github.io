...
## Visual Studio로 ClickOnce 설정(요약)
...
## .NET 5+ 프로젝트에서 ClickOnce (csproj / CLI)
...
## ClickOnce (Self-contained, 런타임 포함)
...
## 단일 실행 파일 (Self-contained, ClickOnce 미사용)
