...
## 인코더–디코더 개요 (RNN→Transformer)

### RNN(LSTM/GRU) 기반 Seq2Seq
...
## 교사강요(Teacher Forcing)와 Scheduled Sampling
...
## 실전 코드 ②: **Beam Search** & **Top-k/Top-p** 디코딩
...
## 교사강요 데모 ③: **RNN(LSTM) Seq2Seq + Scheduled Sampling**
