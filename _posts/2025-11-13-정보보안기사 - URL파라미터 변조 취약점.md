...
category: 정보보안기사
---
# SECTION 08 웹 애플리케이션 취약점 — 10. URL/파라미터 변조 취약점 (IDOR/BOLA·Mass Assignment·HPP·Open Redirect·Method Override·수량/가격·권한 플래그) 완전 정리
...
### SQL/ORM 레벨 RLS(Row-Level Security) 예 (EF Core)
