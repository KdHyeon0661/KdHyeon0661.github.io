...
## 1. Addressing — Home Address와 Care-of Address

### 1.1 Mobile IP의 기본 아이디어
...
## 2. Agents — Mobile Node, Home Agent, Foreign Agent
...
## 3. Three Phases of Mobile IP Operation
...
### 3.1 Phase 1: Agent / Network Discovery

#### 3.1.1 ICMP Router Advertisement + Agent Advertisement
...
### 3.2 Phase 2: Registration with Home Agent
...
#### 3.2.1 Registration Request (RRQ)
...
#### 3.3.2 MN → CN (Uplink) — Direct Routing
...
#### 4.1.2 Route Optimization (특히 Mobile IPv6)
...
#### 4.2.2 Path MTU Discovery와의 상호작용
...
### 4.3 Signaling Overhead & Handoff 지연
...
### 4.5 현대 인터넷에서의 위치 — 모바일 코어 vs 호스트 기반 Mobile IP
