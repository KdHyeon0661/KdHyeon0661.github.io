...
## 액티브 스니핑 기법 — 개념·탐지·대응 (공격 절차 자체는 불제공)
...
### Zeek 정책 예(ARP 매핑 불일치 경고 — 개념 스케치)
