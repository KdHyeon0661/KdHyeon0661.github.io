...
### Detection versus Correction (검출 vs 정정)
...
## Block Coding — Error Detection (블록 코딩에 의한 오류 검출)
...
### Checksum(체크섬) — 1’s Complement Sum
...
### CRC(Cyclic Redundancy Check) — 다항식 기반 블록 오류 검출의 표준
