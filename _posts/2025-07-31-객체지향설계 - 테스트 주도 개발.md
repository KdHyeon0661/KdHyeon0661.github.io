...
## 3. TDD School 비교 — Outside-in vs Inside-out
...
## 4. 워크플로우 — TDD로 OO 설계를 도출하기(은행 계좌 예시, Java)
...
## 5. 조건문을 다형성으로 — Strategy 리팩토링(TDD로 진행)
...
## 6. TDD가 만들어내는 경계(Seams) — 시간/랜덤/네트워크 추상화
...
### 8.2 C#(xUnit) — Port/Adapter + Clock
...
### 10.3 Mutation Testing(돌연변이 테스트)
변이 점수:
$$
...
## 14. 도메인 중심 설계(DDD)와 TDD — 자연스러운 접합
