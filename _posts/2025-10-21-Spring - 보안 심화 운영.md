...
category: Spring
---
# · 감사/액세스 로그 & 보안 모니터링 · 취약점 스캔(Dependency/Container/Image)
...
## — Vault / Parameter Store (Secrets Manager) 통합
...
#### Vault Agent Sidecar(템플릿 렌더 → 파일 주입)
