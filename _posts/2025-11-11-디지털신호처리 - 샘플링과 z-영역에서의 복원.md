...
## ZOH 기반 이산화(펄스 전달함수, Step-Invariant)
...
## GNU Octave 실습(핵심 시나리오)

> 필요 시 `pkg load signal`을 먼저 실행하라.

### 이상(싱크) vs ZOH 복원 — 단일 톤
