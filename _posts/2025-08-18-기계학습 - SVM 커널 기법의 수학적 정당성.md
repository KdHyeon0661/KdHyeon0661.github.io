...
### 선형 SVM의 이중(dual)에서 커널이 들어가는 자리
...
## Bochner 정리와 RFF(랜덤 푸리에 특징)

### Bochner 정리(Shift-invariant 커널)
