...
### 4.2 공간: \( \mathrm{NSPACE} \) 와 **Savitch**
...
### 5.1 Guess-and-Check (증인 추측 후 검증)
...
### 7.1 공통 BFS 엔진
```python
# nondet_bfs.py — 비결정 상태 공간의 BFS(도베일링) 모사기
