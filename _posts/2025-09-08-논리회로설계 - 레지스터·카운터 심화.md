...
## 1. 임의 순서(Arbitrary-Sequence) 카운터
...
### 2.4 SR-FF 모듈러-5(이진) 상태/다음 상태 및 S/R 요약
...
### 4.2 LFSR(최대길이 m-sequence 예: 4비트, \(x^4+x+1\))
...
## 5. 검증/시험: self-start·lockout·타이밍

### 5.1 Self-start/lockout
