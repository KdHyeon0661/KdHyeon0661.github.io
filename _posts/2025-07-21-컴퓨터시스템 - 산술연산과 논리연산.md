...
## 4. 논리 연산자 — 단락 평가와 제어 흐름

### 4.1 단락 평가(short-circuit)
...
### 6.5 popcount/clz/ctz (존재하면 내장 사용)
...
## 7. 형 변환/승격 — “계산은 넓게, 저장 때 잘림”

### 7.1 일반 승격(usual integer promotions)
