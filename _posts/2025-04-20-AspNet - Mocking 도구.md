...
## 파라미터 매칭 — `It.Is`, `It.IsIn`, `It.IsRegex`
...
## 예외/콜백/상태 캡처 — `Throws`, `Callback`, `Returns`
...
## 비동기 & 스트리밍 — `Task`, `IAsyncEnumerable<T>`
...
## 상호작용 검증 — `Verify`, `Times`, `InSequence`, 호출 순서
...
## DI/조합 — `As<T>`, 다중 인터페이스, AutoFixture
