...
## 1.6 Security and Protection (보안과 보호)
...
## 1.9 Kernel Data Structures (커널 자료구조)
...
#### (A) 연결 리스트: Linux style `list_head` (축약 버전)
