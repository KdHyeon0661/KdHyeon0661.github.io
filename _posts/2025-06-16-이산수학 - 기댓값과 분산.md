...
## 4. 전기댓값·전분산 법칙 (조건부 기대/분산)

### 4.1 전기댓값의 법칙 (Law of Total Expectation)
$$
E[X] = E\big[\,E[X\mid Y]\,\big].
$$

### 4.2 전분산의 법칙 (Law of Total Variance)
$$
...
## 6. 샘플 평균, 표본분산, 바이어스–분산

### 6.1 i.i.d. 표본 \(X_1,\dots,X_n\) (평균 \(\mu\), 분산 \(\sigma^2\))
