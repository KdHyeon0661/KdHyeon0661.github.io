...
### Mutual Exclusion 깨기 — **자원 가상화/복제/락 없는 설계**
...
### Hold-and-Wait 깨기 — **All-or-Nothing**(사전할당)
...
### No Preemption 깨기 — **선점 가능 자원/트랜잭션화**
...
### Circular Wait 깨기 — **글로벌 순서 규약(Ordered Locking)**
...
#### 계층형 뮤텍스(Hierarchical Mutex) — 규약 위반 런타임 감지
