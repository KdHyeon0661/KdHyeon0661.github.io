...
## 5) **조인** 공통 부분 CSE (Join Factorization)
...
## 6) OR Expansion과의 시너지: 공통 부분을 밖으로
...
## 7) `WITH`(CTE) — **INLINE vs MATERIALIZE** 전략
