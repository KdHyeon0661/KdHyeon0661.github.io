...
category: 운영체제
---
# Operating-System Structure • Build/Boot • Debugging

## Operating-System Structure

운영체제 구조는 **성능–안정성–보안–유지보수성** 사이의 트레이드오프를 다르게 최적화한다.

### Monolithic Structure (모놀리식)
...
### Operating-System Generation (커널 빌드/구성)
...
### Performance Monitoring and Tuning (성능 모니터링/튜닝)
