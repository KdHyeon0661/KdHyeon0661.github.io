...
### 1.2 전역 초기화(공용 컨트롤)와 **AviView** 윈도우 클래스 등록
...
### 2.2 AviView 윈도우 프로시저 — 열기/타이머/그리기/크기
