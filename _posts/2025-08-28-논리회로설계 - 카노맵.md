...
category: 논리회로설계
---
# — **스위칭 함수의 최소 형식**, **2·3·4변수 K-map**, **필수 주항(EPI)으로 최소식 결정**
...
### 최소화 예 — \(\displaystyle F=\sum m(1,2,3,5,7)\)
...
### 예 ① — \(\displaystyle F=\sum m(0,2,5,7,8,10,13,15)\)
