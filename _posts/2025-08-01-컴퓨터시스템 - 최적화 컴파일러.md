...
## 대표 최적화 기법과 작동 원리(조건과 한계 포함)

### 상수 폴딩 · 상수 전파(Constant Folding/Propagation)
...
### 강도 감소(Strength Reduction) · 인덕션 변수 간소화(IV Simplification)
...
### 루프 변환: LICM / Unroll / Fusion-Fission / Interchange / Tiling / Peeling
...
## 언어 규격과 컴파일러의 ‘특권’ — Undefined Behaviour(UB)
...
## 링크 타임 최적화(LTO/ThinLTO) · PGO — 강력한 현실 해법
