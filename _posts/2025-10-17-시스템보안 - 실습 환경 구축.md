...
## 샌드박스/에뮬레이터: QEMU, Bochs, Frida, Docker
...
# 기본 도구 꾸러미 — “편집·디버깅·리버스·트레이스·네트·포렌식·자동화”
...
### gdb 자동화(pexpect)로 크래시 재현/레지스터 덤프
