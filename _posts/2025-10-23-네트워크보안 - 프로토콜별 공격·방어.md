...
## TCP: SYN Flood, RST 인젝션, 윈도 조작 / SYN 쿠키·uRPF
...
### 방어·완화 체크리스트(호스트/리눅스 기반 웹/프록시 예)
...
## UDP: 리플렉션/앰플리피케이션(DNS/NTP/SSDP/Memcached)
...
## ICMP: 스캐닝·터널링, Rate-Limit·필터링 전략
