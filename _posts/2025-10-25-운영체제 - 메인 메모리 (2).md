...
category: 운영체제
---
# Swapping • x86 (32/64-bit) Example • ARMv8 Example
...
## 9.6 Example: Intel 32- and 64-bit Architectures (x86)

> x86은 **세그먼테이션 + 페이징**을 지원하지만, 현대 OS는 **세그먼트 평탄화(flat)** 후 **페이징 중심**으로 사용.

### 9.6.1 x86-32 (IA-32) — 페이징 개요
...
#### (예제) 사용자 모드에서 TLB 성능 힌트(PCID는 OS가 설정)
