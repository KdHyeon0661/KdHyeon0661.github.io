...
### DIB(BGRA32)와 IppImage(RGB24)의 역할 분리
...
### IppImage<RGB24> → IppImage<uint8_t>
...
### IppDib(BGRA32) 그대로 **회색으로 표시** (출력 전용)
