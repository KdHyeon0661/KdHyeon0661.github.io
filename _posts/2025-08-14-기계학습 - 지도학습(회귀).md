...
### 9.2 수치+범주 혼합 데이터: ColumnTransformer + RidgeCV
```python
import pandas as pd
...
### 9.8 시계열 회귀: TimeSeriesSplit + 누수 방지
```python
