...
## 6. 모노토닉 큐(Deque 기반) — 슬라이딩 윈도우 최대/최소
...
## 10. BFS 확장 4 — 상태 공간 BFS(키/문·벽 부수기·마스크)
...
## 11. BFS 확장 5 — 0-1 BFS(가중치 0 또는 1)
...
## 13. 시뮬레이션 — 라운드 로빈, 캐시, 교차로

### 13.1 라운드 로빈 CPU 스케줄링(타임퀀텀 q)
...
### 13.2 LRU 캐시(덱보다는 OrderedDict 권장, 여기서는 기본 원리만)
...
## 17. 실전 종합 예제 1 — 미로에서의 최단 시간(문 여러 개)
...
## 18. 실전 종합 예제 2 — 0-1 BFS로 최소 비용 경로(문=1, 빈칸=0)
