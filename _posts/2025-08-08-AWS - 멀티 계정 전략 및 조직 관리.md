...
### 허용 리전 화이트리스트 (예: ap-northeast-2, us-east-1만)
...
### CloudTrail 조직 트레일 + S3(Object Lock)
...
### GuardDuty · Security Hub · Macie · Inspector (위임 관리자)
...
## 신원·접근: SSO/권한세트/역할 모델

### IAM Identity Center(SSO) 권한세트 표준
...
## 비용/FinOps: 통합 청구 → 태그 → 예산/이상탐지 → 약정 최적화
...
### Cost Categories / Anomaly Detection
...
### CloudFormation – Config Aggregator 요약
