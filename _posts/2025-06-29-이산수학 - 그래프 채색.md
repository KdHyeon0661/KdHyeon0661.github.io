...
## 4. 특수 그래프의 빠른 판정·최적 채색

### 4.1 이분 그래프(2-색) 판정·채색 (BFS)
```python
...
### 4.2 코달(graph) 최적 채색 (MCS → PEO → Greedy)
```python
...
### 8.2 컴파일러: 레지스터 할당(Interference Graph)
...
### 8.3 무선 주파수 할당(Frequency Planning)
