...
### 2.2 분류 기준(선형·시불변·인과·BIBO) + 기타 성질
...
## 3. LTI 시스템의 3대 표상: 컨볼루션·차분방정식·주파수응답
...
## 9. 인과 LTI의 세 가지 입력 테스트: 임펄스·계단·지수
...
## 10. 시간역/시스템 테스트와 수치 안정성(구현적 포인트)

### 10.1 속성 체크(인과·BIBO·TI)
