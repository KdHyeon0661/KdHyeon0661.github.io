...
### 1.1 출력: `Console.Write`, `Console.WriteLine`
...
### 1.2 입력: `Console.ReadLine`, `Console.ReadKey`
...
### 3.2 StreamReader/StreamWriter (텍스트 스트림)
...
## 8. 바이너리 I/O — BinaryReader/Writer
...
## 11. 메모리 파일, 대용량 — MemoryStream/MemoryMappedFile
...
## 19. 실전 예시 1 — **입력 검증 + CSV 저장 + 안전한 교체**
...
## 20. 실전 예시 2 — **텍스트 로그 회전(롤링) + 공유 읽기 허용**
