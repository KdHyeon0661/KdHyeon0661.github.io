...
### 2.2 동일 개수 언어 \( \{a^n b^n \mid n\ge 0\} \)
$$
...
## 3. 유도(Derivation)와 문장형(Sentential Form)
...
### 4.2 예: \( S \to aSb \mid \varepsilon \) 에서 `aabb`
...
## 9. 유도 실습 — 파이썬으로 좌/우 유도와 파스 트리 찍기
