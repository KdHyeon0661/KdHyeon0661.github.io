...
### Interval Partitioning — 자동으로 늘어나는 Range
...
### Reference Partitioning — 부모의 파티션을 자식이 상속
...
### System Partitioning — 애플리케이션이 “파티션을 찍어서” 저장
...
### Virtual Column-based Partitioning — 가상 컬럼을 키로 쓰기
...
### “Auto-List로 값 확장 → 오래된 국가 파티션을 외부로 티어링(HPT)”
