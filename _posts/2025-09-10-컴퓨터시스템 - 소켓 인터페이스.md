...
### 수신 인터페이스/목적지 식별(답장에 유용) — `IP_PKTINFO`
...
## 종합 예제 — **논블로킹 TCP 에코 서버(epoll) 완성판 스케치**
