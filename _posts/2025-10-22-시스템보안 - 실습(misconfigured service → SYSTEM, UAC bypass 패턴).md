...
category: 시스템보안
---
# 실습: misconfigured service → SYSTEM, UAC bypass 패턴 따라잡기 (방어 중심)
...
# 소유자: BUILTIN\Administrators (또는 TrustedInstaller, 벤더 지침 준수)

icacls $dir /setowner "Administrators" /T
# 일반 사용자 쓰기 제거(필요 권한만 남김)
...
# 방어: LSA 보호, Credential Guard, AppLocker/WDAC, Attack Surface Reduction

> 이 절의 목표는 “**운영 표준**으로 만들기 좋은 설정/스크립트/정책 템플릿”을 제공하는 것입니다.

---

## LSA 보호(Protected Process Light, RunAsPPL)
...
## AppLocker / WDAC (정책으로 실행을 “허용 목록”화)
