...
## CSS Grid — 2차원 레이아웃의 주력

### 영역 기반(Grid Areas) — 페이지 프레임
...
### `subgrid` — 중첩 요소 정렬 일치(지원 브라우저 확인)
...
## 예제: 완성형 반응형 블로그 프레임(Grid + 컨테이너 쿼리)
