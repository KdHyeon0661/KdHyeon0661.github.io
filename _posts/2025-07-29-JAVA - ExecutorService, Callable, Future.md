...
## 생성: Executors vs ThreadPoolExecutor
...
## 여러 작업 한꺼번에: invokeAll / invokeAny
...
## CompletionService — “먼저 끝난 것부터” 수확
...
## 스케줄링 선택: fixed-rate vs fixed-delay
...
## 실전 시나리오 — “I/O 바운드 호출 + 캐시 스탬피드 방지 + 백프레셔”
...
## 보너스: CompletableFuture로의 확장(간단 브리지)
