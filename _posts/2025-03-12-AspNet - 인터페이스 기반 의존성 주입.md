...
## 구현 선택 전략 — 조건/환경/테넌트에 따라 인터페이스 구현 바꾸기
...
## 인터페이스와 DI 등록 방식 — 오픈 제네릭/팩터리/인스턴스/데코레이터
...
## 외부 API/DB/리소스와 인터페이스 — HttpClientFactory, DbContext
...
## 테스트 전략 — Fake/Stub/Moq + WebApplicationFactory로 DI 오버라이드
...
### 통합 테스트: WebApplicationFactory로 DI 교체
...
## 안티 패턴 주의 — Service Locator, Static Accessor, Captive Dependency
