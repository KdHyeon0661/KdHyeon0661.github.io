...
category: 시스템보안
---
# 실습: 교육용 루트킷 코드 읽기 & 탐지 룰(쌍방 시점) 설계
...
## 교육용 루트킷 스켈레톤(읽기 전용 가상 코드) — 구조 이해
...
# 방어: 커널 서명 강제, HVCI, AMSI/ETW 기반 탐지 튜닝

## 커널 서명 강제(드라이버 정책) — WDAC/CI/CD통합
