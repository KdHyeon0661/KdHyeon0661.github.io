...
## 실시간 업데이트 — ObservableValue, ObservableCollection

### ObservableValue로 고속 업데이트
...
### 툴팁/범례 커스터마이징(기본: LiveCharts2 템플릿 사용 권장)
...
## 날짜 선택/일정 시각화 — DatePicker와 커스텀 캘린더
...
### 히트맵/밀도 시각화(LiveCharts2 HeatSeries)
