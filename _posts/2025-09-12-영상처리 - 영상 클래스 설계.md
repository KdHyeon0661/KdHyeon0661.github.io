...
## `IppImage` 클래스: 소유 버퍼(Top-Down, ROI 지원)
...
## Windows 출력 클래스: `IppDib` (DIBSECTION 래퍼)
...
## **IppCreate** 프로젝트 만들기 (VS 2022, Win32 GUI)
