...
## Redo 작성 흐름: DML 한 줄이 Redo까지 가는 여정
...
## Redo를 왜 이렇게까지 중요하게 다루는가?

Redo는 3가지 의미에서 “생명줄”이다.

### 인스턴스 복구 (Crash Recovery)
...
## Redo Log Buffer와 `log_buffer`

### Redo Log Buffer는 어디에?
...
## Archived Redo Log — 장기 보관과 복구 / Data Guard
...
## Redo와 Checkpoint / DBWn / CKPT의 관계
...
## Redo 크기를 줄이면 좋은가? (OLTP vs Batch 관점)
...
### 예외적/부분적 최적화: Direct-Path Insert / NOLOGGING
...
## Redo와 성능 병목: LGWR, I/O 대기, log file sync
