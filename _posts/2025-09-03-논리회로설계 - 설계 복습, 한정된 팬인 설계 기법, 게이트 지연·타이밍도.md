...
## MUX·디코더·Tri-State와 타이밍

### MUX(샤논 전개)로 임의 함수 구현
...
### 팬인 제한 아래의 10-input OR (NOR-only 불가 조건 포함)
