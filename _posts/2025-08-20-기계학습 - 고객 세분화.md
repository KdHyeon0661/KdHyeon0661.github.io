...
category: 기계학습
---
# 고객 세분화(Customer Segmentation) — 비지도 학습
...
## 7. 파이프라인(End-to-End) — **RFM 기반 K-Means**
...
### 11.1 군집 간 분포 차이 검정(예: Kruskal–Wallis)
```python
