...
category: 영상처리
---
# 5) **대용량 타일 처리**: 초고해상도(>80 MP)에서 **스트리밍/타일링 로드맵**
...
## 4) **RegionDecoder**: 단일 JPEG에서 ROI 디코드(jpeglib)
...
### 11.1 **SingleJPEGSource**: (z,x,y) → ROI → BGRA 타일
```cpp
