...
### 13.1.4 바이트 스트림 vs 레코드 파일 vs 스파스 파일
...
### 13.2.5 메모리 매핑 접근(Memory-Mapped)
...
### 13.2.6 레코드 기반(Record-based) 고정 길이 예
- **N번째 레코드**의 오프셋은
...
### 13.3.9 보안 이슈: TOCTOU, 심링크 레이스, 경로 정규화
