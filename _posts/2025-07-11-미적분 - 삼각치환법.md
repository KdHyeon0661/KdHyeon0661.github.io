...
### \(\displaystyle \int \sqrt{a^2 - x^2}\,dx\)  (원 1/4 면적과 연결)
...
### 정적분 \(\displaystyle \int_{0}^{a} \frac{x^2}{\sqrt{a^2-x^2}}\,dx\)
...
### Weierstrass 치환(전탄젠트, \(t=\tan(\theta/2)\))
