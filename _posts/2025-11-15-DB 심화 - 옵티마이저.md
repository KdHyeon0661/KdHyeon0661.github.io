...
# 2. 규칙 기반(RBO) vs 비용 기반(CBO)

## 2.1 규칙 기반(RBO: Rule-Based Optimizer)
...
## 2.2 비용 기반(CBO: Cost-Based Optimizer)
...
## 5.2 FIRST_ROWS / FIRST_ROWS_n (n=1/10/100/1000)
...
## 6.3 FIRST_ROWS_n과 인덱스 활용 (Top-N, Stopkey)
...
# 8. 쿼리 변환(Query Transformation)과 모드
...
## 부록 B. 동적 샘플링(Dynamic Sampling) 시연
