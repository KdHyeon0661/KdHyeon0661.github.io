...
## 3. 편집/변환 — objcopy/strip의 “안전한” 사용법
...
## 4. RPATH/RUNPATH·NEEDED — 배포 디렉터리에 “고정”
...
## 8. Windows(PE/COFF)·macOS(Mach-O) 한 컷 요약
...
## 9. 실전 미니 실험 5종 — “보는→고치는→검증”

### 9.1 배포 디렉토리 고정(RUNPATH)
```bash
...
## 13. 부록 — 자주 쓰는 옵션/명령 모음

### 13.1 readelf/objdump 즐겨찾기
```bash
readelf -aW app | less
