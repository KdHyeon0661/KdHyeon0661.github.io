...
category: 시스템보안
---
# 실습: 교육용 취약 드라이버(HEVD 등)로 PrivEsc 체인 **모델링**하기
...
# len=과도 → -STATUS_INVALID_PARAMETER 기대
...
# 상태 보기 (Windows 11+ 일부 커맨드; 환경에 따라 방법 상이)
