...
## 6. 실전 패턴 — 프런트/백 분리, 리버스 프록시, 멀티 네트워크
...
## 11. 실전 시나리오 — 웹/앱/DB 3계층(포트 매핑+이름 통신)

### 11.1 단일 호스트, 사용자 정의 브리지
```bash
