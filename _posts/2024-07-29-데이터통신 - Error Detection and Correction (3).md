...
### Hamming 코드 (7,4)를 통한 구체적인 FEC 예
...
### 문제 상황: 버스트 오류가 Hamming 코드의 한계를 넘을 때
...
### Base Layer와 Enhancement Layer의 역할
...
### High/Low 해상도 패킷과 Interleaving의 결합
...
### Hamming Distance 관점에서 본 UEP 구조
