...
## 1. 정규화(Regularization) 개념 — 왜 필요한가?
...
## 2. 릿지 회귀(Ridge) — 수학적 해, 스펙트럼 해석, 베이지안 대응
...
## 3. 라쏘 회귀(Lasso) — 서브그라디언트, KKT, 소프트 임계
...
## 4. 엘라스틱넷(Elastic Net) — 라쏘의 희소화 + 릿지의 안정화
$$
...
## 8. 파이썬: Ridge/Lasso/ElasticNet — 파이프라인·경로·CV
