...
### 3.1.3 일반 단일치환(Simple Substitution)
...
### 3.3.2 Kasiski 시험 & 우연지수(Index of Coincidence, IC)
...
## ✅ 3.4 에니그마(Enigma) 스토리 — 기계적 다표치 + 현실의 공격
...
### 3.6.1 시저 자동 크랙(이미 작성) → 실제 문장으로 시험
```python
...
### 3.6.3 비제네르: 키 길이 추정 → 각 열 시저 공격 (이미 코드 제공)
