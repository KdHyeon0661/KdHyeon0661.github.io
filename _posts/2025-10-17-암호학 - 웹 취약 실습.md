...
category: 암호학
---
# 웹 취약 실습: JWT `alg=none`, 키 혼동(Key-Confusion), Padding Oracle PoC
...
# 서버는 RS256용 공개키를 이렇게 들고 있다고 가정 (실제로는 로컬 파일/비밀금고)
...
## CBC Padding Oracle (PoC: 로컬 취약 서버 + 관찰·차단 중심)
