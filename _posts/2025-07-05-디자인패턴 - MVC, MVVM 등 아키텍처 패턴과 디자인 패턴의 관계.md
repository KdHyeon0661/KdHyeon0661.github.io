...
### 3.5 Layered / Clean / Hexagonal (Ports & Adapters)
...
### 5.1 WPF/Avalonia — MVVM 기본기 (Observer + Command)
...
### 5.2 ASP.NET Core MVC — Controller + Command 핸들러 + Repository
...
### 5.3 React + Redux — Flux 변형에서의 패턴 매핑
...
### 5.4 Android MVP — View 인터페이스 + Presenter(Strategy)
...
## 12. 코드 스니펫: Repository + DI(의존성 주입) 결합
