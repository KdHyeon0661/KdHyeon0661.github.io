...
## CRITICAL_SECTION — 가장 빠른 상호배제(단일 프로세스)
...
## SRWLock & Condition Variable — 리더-라이터, 조건대기
...
## MFC 래퍼(CriticalSection/Event/Mutex/Semaphore/MultiLock)
