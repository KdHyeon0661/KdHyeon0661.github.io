...
## 10. 파이썬으로 검증/수치 적분 (SymPy/NumPy)

아래 코드는 상기 예제 중 일부를 심볼릭/수치로 확인한다.

### 10.1 포물면 예제(예제 2) 수치 확인
```python
import sympy as sp
