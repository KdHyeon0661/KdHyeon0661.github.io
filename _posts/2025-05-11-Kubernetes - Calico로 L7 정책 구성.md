...
### `GlobalNetworkPolicy`로 L7 제어(대표 패턴)
...
metadata:
  name: demo
---
# backend 서비스(앞서 만든 Pod를 쓴다면 생략 가능)
...
spec:
  ...
  - port: 80
    targetPort: 80
---
# L7 허용(프런트엔드→백엔드 GET /get, /api/v1/* + 헤더)
