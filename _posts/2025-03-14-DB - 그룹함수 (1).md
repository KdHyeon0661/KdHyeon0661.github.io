...
## 6. 조건부 집계(조건별 카운트/합계) — 전 DB 공통 핵심
...
## 11. Oracle 전용: KEEP (DENSE_RANK LAST/FIRST)
...
## 12. MySQL ONLY_FULL_GROUP_BY와 함수적 종속
...
### 15.2 다중 조건을 한 번에(포스트그레스 FILTER)
