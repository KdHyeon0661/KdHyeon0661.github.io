...
### 1.2 미니 예시 — \(L=\{a^n b^n\mid n\ge 1\}\)
...
## 2) semi-Thue / Thue 시스템

### 2.1 semi-Thue (단방향 재작성)
...
## 5) TM ↔ PCS / semi-Thue **상호 시뮬레이션**

### 5.1 TM → PCS (전이 한 스텝의 로컬화)
...
### 7.1 semi-Thue로 \(L=\{a^n b^n\mid n\ge1\}\)
...
### 7.2 PCS로 \(L=\{a^n b^n c^n \mid n\ge1\}\) (스케치)
...
### 7.3 Post **normal** system 맛보기(변수 이동)
...
### 7.4 **Tag system**(2-tag) 시뮬(정지/주기적 패턴)
...
## 8) 실전 감수(감소) **레시피** — Post 계열로 “불가능” 들이밀기
