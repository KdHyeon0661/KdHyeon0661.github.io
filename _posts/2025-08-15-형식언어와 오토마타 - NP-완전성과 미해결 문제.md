...
## 5. 근사(Approximation)와 PCP: “얼마나 가깝게?”의 경계
...
## 10. 예제·코드 — 감소, 근사, 솔버 감수

### 10.1 3-SAT → CLIQUE **생성기/검증기**(파이썬)
...
### 10.2 **SET COVER Greedy**( \(1+\ln n\)-근사 )
...
### 10.3 **VERTEX COVER 2-근사**(최대 매칭 라운딩)
...
### 10.4 **자기감소**(결정 오라클로 해 찾기, SAT 예시 골격)
...
## 15. 추가 예시: Christofides(1.5-근사)와 GW(Max-Cut) 개요
