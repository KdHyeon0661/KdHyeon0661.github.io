...
### 25.1.1 Providing Services — 애플리케이션 계층이 실제로 하는 일
...
### 25.1.2 애플리케이션 계층이 전송 계층에게 요구하는 것들
...
### 25.1.3 Application Layer Paradigms — 서비스 구조 패턴
...
### 25.2.1 Application Programming Interface — 소켓 API
...
#### 25.2.3.2 예제 상황: 간단한 “대문자 변환” UDP 서버 (Python)
...
#### 25.2.4.2 예제 상황: iterative TCP 에코 서버 (Python)
...
#### 25.2.5.1 개념 비교: Iterative vs Concurrent
...
#### 25.2.5.2 프로세스 기반 Concurrent TCP 서버 (C 개념 코드)
...
#### 25.2.5.3 스레드 기반 Concurrent TCP 서버 (Python 예제)
...
### 25.2.6 UDP vs TCP vs QUIC: 애플리케이션 코드 관점 요약
