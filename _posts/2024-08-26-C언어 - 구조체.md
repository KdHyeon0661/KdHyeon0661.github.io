...
## 2) 메모리 레이아웃 — 패딩과 정렬, `sizeof/offsetof`
...
## 7) 가변 배열 멤버(Flexible Array Member, C99)
...
### 9.2 안전한 패턴: **태그드 유니언(tagged union)**
...
## 14) 지정 초기화자/복합 리터럴(Compound Literal)
