...
# 3. 출력: eve.json(기본), fast.log, stats.log
...
```bash
# 1. 빠른 포트 스캔(상위 1000), 서비스/버전/NSE 기본
nmap -sS -sV -O -T4 10.10.10.0/24

# 2. UDP Top-Ports (느림) – 승인된 범위에서만
nmap -sU --top-ports 50 -T3 10.10.10.5

# 3. 방화벽 뒤 의심 호스트(핑 차단) – 직접 포트 시도
