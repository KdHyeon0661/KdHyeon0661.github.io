...
### 16.1.1 기본 목표: CIA, AAA, Non-repudiation
...
### 16.1.2 위협·취약점·공격면(Attack Surface)
...
### 16.4.4 패스워드 저장 — PBKDF2(표준 라이브러리)
```python
