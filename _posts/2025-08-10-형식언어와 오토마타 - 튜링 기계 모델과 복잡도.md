...
## 3. 강건성(Cobham–Edmonds 테제): 모델 간 다항식 내 등가
...
### 11.2 두 절반 동일성 $$L=\{ww\mid w\in\{0,1\}^*\}$$
...
### 14.2 시간–공간 트레이드오프(예: 테이블 vs 온더플라이)
