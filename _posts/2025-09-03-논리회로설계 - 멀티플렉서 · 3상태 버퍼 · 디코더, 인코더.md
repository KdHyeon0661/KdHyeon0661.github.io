...
category: 논리회로설계
---
# · 3상태 버퍼(Three-State Buffer) · 디코더/인코더(Decoder/Encoder) 완전 정리
...
## 3상태 버퍼(Three-State, Tri-State Buffer)
...
### Tri-State로 MUX 만들기(Decoder + 3-State)
