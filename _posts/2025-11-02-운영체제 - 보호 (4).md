...
### 17.10.3 권한 감쇠(Attenuation) & 위임(Delegation)
...
### 17.12.3 OCAP 스타일 모듈 디자인(언어 불문 공통 패턴)
- **규칙**
...
### 17.12.5 WebAssembly + WASI: 언어 기반 샌드박스
...
### 17.12.7 테스트 가능한 정책 — “권한이 없으면 컴파일이 깨져야”
