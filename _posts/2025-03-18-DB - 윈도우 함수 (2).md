...
## CUME_DIST(), PERCENT_RANK() — 분포/백분위 분석
...
## 퍼센타일(Percentile) — PERCENTILE_CONT / PERCENTILE_DISC
...
## 프레임 배제(EXCLUDE) — CURRENT ROW / TIES / GROUP
...
### “월별 매출의 전년 동월 대비(YoY), 누적(YTD), 이동(MA) 동시 산출”
