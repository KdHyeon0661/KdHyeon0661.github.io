...
### C++: `std::scoped_lock`로 2개 이상 락 데드락-프리 취득
...
### C++: **계층형 락(Hierarchical Mutex)** — 규약 위반을 런타임 감지
...
### Java: `ReentrantLock` + `tryLock` 타임아웃
