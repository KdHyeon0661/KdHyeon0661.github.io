...
## 5. Traceroute/Tracert — TTL·ICMP Time Exceeded
...
## 6. PMTUD(Path MTU Discovery) — ICMP Type 3 Code 4
...
## 8. 기타 메시지: Parameter Problem, (폐기된) Source Quench 등
...
### 9.2 nftables/iptables 예시

**nftables(권장)**
```bash
# 1. 합리적 허용: Echo는 레이트 리밋, 핵심 에러 타입은 허용
...
## 10. 탐지/가시성 — tcpdump·Wireshark·로그
