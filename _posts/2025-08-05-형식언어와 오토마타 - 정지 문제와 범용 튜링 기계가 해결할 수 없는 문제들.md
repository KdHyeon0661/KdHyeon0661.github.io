...
## 정지 문제를 넘어: **UTM으로도 못 푸는 대표들**

### Busy Beaver \(\Sigma(n)\), \(S(n)\) — **비계산 함수**
...
## **감소(reduction) 레시피** — 실전 템플릿

### “스위치 머신” 가젯 (멤버십 → 보편/공백 등)
...
### \(A_{TM}\Rightarrow NE_{TM}\) **many-one 감소**
