...
category: 정보보안기사
---
# 완전 정리 (원리·조건·공격 시나리오·현대 방어전략·프레임워크별 코드·REST/SPA·OAuth2 상태값·테스트/모니터링·체크리스트·예상문제)
...
### **동기화 토큰(Synchronizer Token Pattern)**
...
### **더블 서브밋 쿠키(Double-Submit Cookie)**
