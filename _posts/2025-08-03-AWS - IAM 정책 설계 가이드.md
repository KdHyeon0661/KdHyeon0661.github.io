...
## IAM 정책의 평가 논리(Evaluation Logic)를 먼저 이해하자
...
## 교차 계정 접근(AssumeRole, ExternalId, Session Policy)

### 신뢰 정책(Trust Policy) — `sts:AssumeRole`
...
## Permission Boundary(권한 경계) — 현장 운영의 안전망
...
### “개발자 개인 샌드박스” Permission Boundary
