...
## 1. 전체 맥락 — “탐지(Visibility) ↔ 통제(Control) ↔ 자동화(Orchestration)”
...
### 4.2 관리 평면(Management Plane) 보호 베스트프랙티스
