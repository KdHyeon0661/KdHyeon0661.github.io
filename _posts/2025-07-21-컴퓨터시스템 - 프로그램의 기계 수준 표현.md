...
## 고급 언어와 컴파일러의 탄생 — “사람 중심 표현”과 이식성
...
## ISA와 ABI — “무엇을 실행할 수 있나”를 규정하는 두 축
...
## 호출 규약과 스택 프레임 — 함수 호출의 기계적 의의

### 일반적 프로로그/에필로그(x86-64 SysV)
...
## 마이크로아키텍처: 디코드→µop→실행 — “기계어 밑의 기계어”
...
## 중간 표현(IR), SSA, LTO, JIT — “오늘날의 컴파일은 다단계 최적화”
