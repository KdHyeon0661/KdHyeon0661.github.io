...
---
# 18.5 Forwarding of IP Packets — 목적지 기반, 라벨 기반, 그리고 라우터의 패킷 스위칭 구조
...
### 6) 간단한 라벨 포워딩 시뮬레이션 코드

```python
# label forwarding table (LFIB) 예제
lfib_R1 = {  # ingress
