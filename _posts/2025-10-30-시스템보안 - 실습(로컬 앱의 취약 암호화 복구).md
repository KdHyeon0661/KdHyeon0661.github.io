...
category: 시스템보안
---
# 14.3 실습: 로컬 앱의 취약 암호화 복구(교육용 샘플)
...
# 14.4 방어: HSM/KMS, OS Keychain, 레이트리밋/락아웃
