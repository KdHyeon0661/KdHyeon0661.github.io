...
## 추가·보완 지표 (실무에서 자주 쓰는 확장)

### Specificity(특이도), NPV, Youden’s J, G-mean
...
### 지표 계산·리포트·ROC/PR 곡선·임계값 최적화(F1)
...
### Precision@k, Recall@FPR≤α (랭킹 기반 운영지표)
