...
## 엄밀한 주소/형 변환과 엄격 별칭(strict aliasing)
...
```asm
# – 분기 없는 집계의 한 조각(개념)
# / setge %r10b / movzx %r10b,%r10d / addl %r10d,%eax
