...
### dB vs dBm/dBV/dBu (참조점이 있는 절대단위)
...
### 노이즈 피겨(Noise Figure, NF)와 등가잡음온도 $T_e$
...
## 케이스 스터디: 링크 버짓 / 케이블 감쇠 / 합전력

### 링크 버짓(무선·광·유선 공통 사고법)
...
## 반사/정합: 반사계수·반사손실·VSWR

### 반사계수 $\Gamma$와 반사손실(RL)
