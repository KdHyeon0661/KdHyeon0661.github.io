...
## 포함 관계가 **엄격(strict)** 임을 보이는 표준 증개요
...
## **작업 예제** — 같은 언어를 여러 모형으로

### REG 예: “짝수 개의 1을 포함하는 이진 문자열”
...
### 정규식 → NFA → DFA (subset construction)
