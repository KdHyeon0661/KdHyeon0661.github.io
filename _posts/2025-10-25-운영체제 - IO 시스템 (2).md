...
### 12.4.3 페이지 캐시 / readahead / writeback
...
### 12.4.6 스풀링(Spooling)과 이름 있는 파이프
...
### 12.5.6 실습: io_uring으로 “파일→소켓” Zero-Copy 파이프라인(개념)
```c
...
### 12.7.5 파일 I/O 실험: readahead vs O_DIRECT
```c
