...
## PyTorch 유틸: 온라인 통계/히스토그램/슬라이딩 윈도우
...
## 기준(Baseline) 통계 생성 — 학습/준준동에서 한 번 산출
...
## 실시간 서버/배치에 삽입하기 (핵심 라인만)

### 실시간 (이전 장의 `rt_server.py`에 추가)
