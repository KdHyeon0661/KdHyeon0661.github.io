...
## `CMainFrame` 클래스 분석 (CMDIFrameWndEx)
...
## `CChildFrame` 클래스 분석 (CMDIChildWndEx)
...
## 성능/디자인 선택: CView vs CScrollView vs CFormView
