...
---
# 24.4 SCTP(Stream Control Transmission Protocol) — 서비스, 특징, 패킷 포맷 완전 정리
...
### 1.2 메시지 지향 서비스 (Message-oriented Service)
...
### 2.5 Selective Acknowledgment와 혼잡 제어
...
### 3.5 INIT / INIT-ACK Chunk 예시 (간단화)
...
### 3.6 실제 트레이스에 가까운 예시 (tcpdump 스타일)
