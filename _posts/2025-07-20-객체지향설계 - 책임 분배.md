...
### 7.1 엔티티와 규칙(Information Expert)
```java
...
### 7.2 유스케이스(Controller)와 Indirection
```java
...
### 7.3 변이 보호(Protected Variations) — 결제 전략
```java
...
## 10. 변이 관리: 전략/상태/템플릿으로 ‘달라지는 부분’ 고립
...
## 11. 책임 품질을 재보는 정량 지표(마틴 메트릭스/LCOM)
...
### 15.2 책임 할당 기록(RAR: Responsibility Assignment Record)
```text
