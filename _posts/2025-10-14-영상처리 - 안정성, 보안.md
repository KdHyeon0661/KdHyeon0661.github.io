...
category: 영상처리
---
# 안정성/보안(용량 폭탄, 잘못된 마커, 오버플로) — **외부 JPEG 입력을 “절대” 믿지 말 것**
...
## 스트리밍/네트워크 입력용 **커스텀 소스 매니저**(쿼터/타임아웃)
