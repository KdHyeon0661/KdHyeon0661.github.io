...
### 31.1.1 Security Goals — 무엇을 지키려 하는가
...
### 31.1.3 Security Services and Techniques — 서비스와 메커니즘 매핑
...
### 31.2.1 Symmetric Key Ciphers — 대칭키 암호
...
### 31.2.2 Asymmetric (Public-Key) Ciphers — 비대칭키 암호
...
# 1. 서버 측: RSA 키 쌍 생성 (보통은 미리 만들어 두고 인증서로 배포)
