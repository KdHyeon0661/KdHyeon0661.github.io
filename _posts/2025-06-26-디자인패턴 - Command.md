...
## 6. 텍스트 에디터 예제 — Undo/Redo(역연산)와 스택
...
## 10. 거래적 시나리오 — 보상 트랜잭션(Saga)와의 결합
...
## 12. 비교표 — Strategy / Observer / Mediator
