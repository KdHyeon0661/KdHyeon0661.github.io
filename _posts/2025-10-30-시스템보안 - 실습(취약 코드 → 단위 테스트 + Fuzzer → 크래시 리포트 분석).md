...
category: 시스템보안
---
# 실습: 취약 코드 → 단위 테스트 + Fuzzer → 크래시 리포트 분석
...
# 공급망: SBOM, 서명, 정책 게이트(정적 분석/SCA/라이선스)
...
## 서명(Signing) & 프로비넌스 (Sigstore/cosign, SLSA)
...
## 정적 분석(SAST) & 포맷 보안(Format Security)
