...
## 3. 체크섬과 의무 여부(IPv4 vs IPv6)

### 3.1 Pseudo-header를 포함하는 1의 보수 합
...
## 10. 코드 예제 — UDP 에코/타임아웃/청크 분할

### 10.1 Python UDP 에코 서버/클라이언트
