...
## 8. try/catch, 함수 선언과 블록, strict 모드

### 8.1 `catch` 바인딩은 블록 스코프
...
### 8.2 블록 내 함수 선언(브라우저 비표준/표준 차이 주의)
