...
### 희소 행렬 포맷(CSR/CSC/COO) — 대용량/수치계산·GPU 친화
...
## Union-Find(Disjoint Set Union, DSU) — 오프라인 연결성/동적 합치기
...
## (무방향) 단절점(articulation) & 브리지(bridge)
