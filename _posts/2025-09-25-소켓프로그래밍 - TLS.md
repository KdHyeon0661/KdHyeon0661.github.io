...
### C++에서 TLS 적용 경로 — OpenSSL/mbedTLS 래핑 포인트
...
### 실습 1 — “평문 에코”를 “TLS 에코”로 (블로킹 최소 예시)
