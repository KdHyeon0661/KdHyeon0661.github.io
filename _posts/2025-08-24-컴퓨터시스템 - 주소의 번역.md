...
## x86-64: 4단/5단(4KB 페이지) **정밀 비트 배치**

### 4단(48-bit canonical VA, 일반적)
...
## C 코드: `/proc/self/pagemap`으로 **VA→PFN** 대략 보기
...
## TLB(Translation Lookaside Buffer): **번역의 캐시**
...
### **권한 위반 실험**: `mprotect`로 강제 SIGSEGV
...
## 리눅스 용어의 매핑: PGD/P4D/PUD/PMD/PTE
...
## TLB Shootdown: PTE가 바뀔 때의 **전파 비용**
...
## 실습: **TLB 미스 유발 vs Huge Page 완화**(마이크로벤치)
