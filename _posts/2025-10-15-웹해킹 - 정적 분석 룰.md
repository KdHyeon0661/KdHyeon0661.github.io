...
## Taint 모드(고급) — **데이터 흐름**으로 정확도 높이기

**목표**: “**사용자 입력**이 **위험 싱크**로 들어가면 경고”, 중간에 **sanitize**가 있으면 통과.

### Express: 사용자 입력 → 파일 경로(sink)
...
## Python/Django & Java/Spring & Go 룰/예시 (요약)
