...
## DTFT와 LTI 시스템 주파수 응답

### \(H(e^{j\omega})\) 정의와 고유함수
...
## DTFT–DFT 스케일링과 Parseval·Plancherel(실무 캘리브레이션)
...
## 상호상관·자기상관과 스펙트럼(이산 Wiener–Khinchin)
