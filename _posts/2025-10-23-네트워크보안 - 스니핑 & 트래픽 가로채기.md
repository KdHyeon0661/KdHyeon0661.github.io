...
category: 네트워크보안
---
# 4. 스니핑 & 트래픽 가로채기 (공격 관점의 이해, 방어 중심 실습)
...
## 4.1 패시브 vs 액티브 스니핑, Promiscuous / Monitor Mode
...
### 4.1.3 안전 실습: “패시브 캡처만으로도 얻는 인사이트”
...
## 4.4 암호화 시대의 스니핑: 평문 프로토콜 위험, SNI·JA3/JA4 메타데이터
