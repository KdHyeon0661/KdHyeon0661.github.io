...
### 직렬화 포맷 선택 가이드: JSON/CBOR/Protobuf
...
#### `mini_server.cpp` — 요청 처리/중복 억제 캐시 포함
...
#### `mini_client.cpp` — ECHO/SUM 테스트 클라이언트
