...
---
# 24.3 Transmission Control Protocol — Windows, Flow Control, Error Control (상세)
...
### 1.1 윈도우 개념 – “한 번에 얼마나 앞서 나갈 수 있나?”
...
### 1.2 세 가지 윈도우: rwnd, cwnd, send window
...
### 1.3 TCP Window 필드와 Window Scaling
...
### 1.4 윈도우와 실질적인 처리율(Throughput) 관계
...
### 1.5 Silly Window Syndrome과 윈도우 관리
...
### 3.4 Fast Retransmit & Fast Recovery
...
### 3.5 SACK(Selective Acknowledgment) – 다중 손실에서의 향상된 에러 제어
