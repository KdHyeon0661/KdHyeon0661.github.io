...
### 충돌 도메인, CSMA/CD, 반이중(half-duplex)
...
## Link-Layer Switch — 멀티포트 브리지, 현대 이더넷의 중심
...
### MAC 학습(Learning)과 포워딩(Forwarding)
...
## Routers — 네트워크 계층, 서브넷과 브로드캐스트 도메인 분리
