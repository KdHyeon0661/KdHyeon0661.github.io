...
## 1. 다단 **NAND-only** / **NOR-only** 회로 설계

### 1.1 보편성(Functional Completeness)과 치환 레시피
- **NAND만으로**
  \[
...
### 1.2 다단 **NAND-only** 합성 절차(실무 체크리스트)
...
### 5.2 구조적 Verilog — **NAND–NAND(2단) + 공유**
```verilog
