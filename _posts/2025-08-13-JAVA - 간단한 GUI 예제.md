...
### 1.1 Swing — EDT(Event Dispatch Thread)
...
### 1.2 JavaFX — JavaFX Application Thread(FXAT)
...
### 6.1 Swing 안에 JavaFX 넣기 — `JFXPanel`
```java
...
### 6.2 JavaFX 안에 Swing 넣기 — `SwingNode`
```java
