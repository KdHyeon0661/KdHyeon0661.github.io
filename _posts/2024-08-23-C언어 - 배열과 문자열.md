...
## 5. 정적 vs 동적 2D — “연속 공간”과 “포인터 배열”의 차이
...
## 14. 바이너리 데이터와 `char*`/`unsigned char*`
...
### 15.2 2D 합계(정적/동적 모두 적용 가능한 인덱싱)
