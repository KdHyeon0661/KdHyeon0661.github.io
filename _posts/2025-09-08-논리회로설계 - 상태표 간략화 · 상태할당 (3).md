...
## 등가 상태할당 (Equivalent State Assignment)
...
## 예제 1 — 4상태 Moore FSM: **이진 vs 그레이 vs 등가 변환**
...
## 예제 2 — **원-핫**으로 `1011` Mealy 검출기(중첩 허용)
...
## 예제 3 — **동일 FSM**을 이진 배정으로: FF 입력식 유도
...
## 구현 스니펫 — 명시적 인코딩과 등가 검증

### VHDL: 명시적 인코딩 지시(이진/원-핫)
...
### SystemVerilog: Product 관찰자(등가 체크 스텁)
