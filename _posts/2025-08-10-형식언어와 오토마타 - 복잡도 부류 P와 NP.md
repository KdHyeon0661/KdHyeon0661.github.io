...
### 1.2 $$\mathbf{NP}$$ (Nondeterministic Polynomial time)
$$
...
### 11.2 **Vertex-Cover 2-근사**(최대 매칭 기반)
```text
Approx-VC(G):
...
### 11.4 **TSP(결정판)**: Held–Karp DP(정확) & Christofides(근사)
```text
