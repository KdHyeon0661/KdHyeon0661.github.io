...
## 5. 계단 응답 불변법 / matched-z

### 5.1 계단 응답 불변법 (Step invariance)
...
## 6. Bilinear 변환(쌍선형 변환, Tustin) — 핵심 이론
...
### 6.4 아날로그–디지털 변환 절차 (bilinear + prewarping)
...
## 7. 예제 1 — 아날로그 Butterworth → 디지털 IIR (bilinear vs 임펄스 불변 비교)
...
## 8. Bilinear 변환의 수식적 변환 예 — 1차 아날로그 RC 필터
...
## 9. 방법 선택 가이드 — 언제 어떤 아날로그–디지털 변환을 쓸 것인가?

지금까지 정리한 내용을 **실무 관점**에서 정리하면 다음과 같다.

### 9.1 Impulse invariance
