...
### **데랑주망(derangements)**: 고정점 없는 순열 수 \( !n \)
...
### “1부터 N까지에서 \(a,b,c\)의 배수 **중복 없이** 카운트”
