...
## 실전 ①: 벡터 합 — per-thread 청크 + 패딩된 reduction
...
## 코어 고정(affinity)·NUMA first-touch
...
## 미니 요리책 (Map/Reduce/Scan/Stencils)

### Parallel for (정적 분할) 매크로
