...
# 컬럼 통계(Column Statistics) — 히스토그램/확장통계
...
## 확장 통계(Extended Stats) — 컬럼 그룹/표현식
...
# 통계 운용 고급 — 자동 통계, Pending(대기) 통계, Export/Import/Lock
