...
```bash
# Firecracker: VM 정의 JSON 전달 → 빠른 부팅
...
### Process/Thread Scheduling (게스트 ↔ 호스트 이중 스케줄링)
...
### Memory Management (게스트 내부 vs 하이퍼바이저 외부)
...
### Live Migration & Storage Consistency
