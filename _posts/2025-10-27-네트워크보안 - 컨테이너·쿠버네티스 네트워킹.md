...
## 14.1 CNI / Service / Ingress, 네임스페이스
...
## 14.2 네트워크 폴리시, 서비스 메시(mTLS)

### 14.2.1 NetworkPolicy 기본(표준 KNP)
...
### 14.2.2 서비스 메시(ISTIO/Linkerd) 핵심
...
### 14.3.3 CiliumNetworkPolicy(L7까지)
...
## 부록 B. kube-proxy(eBPF) 없는 Cilium 서비스
