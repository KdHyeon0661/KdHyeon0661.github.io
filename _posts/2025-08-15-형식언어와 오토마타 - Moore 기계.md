...
### 파티션 정제(Partition Refinement) — 기본형
...
## 구현 레퍼런스(파이썬): Trim, 최소화, 동치성, Mealy↔Moore 변환
...
### Moore 최소화(파티션 정제 + Hopcroft풍 스케치)
