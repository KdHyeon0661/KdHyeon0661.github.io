...
# 2. OUTER 조인의 논리와 **predicate 배치 원칙**
...
# 4. **Outer Sort-Merge Join (MERGE JOIN OUTER)**
...
## 4.2 예제: “주문일과 가장 가까운 배송(또는 미배송) 매핑”
...
# 5. **Outer Hash Join (HASH JOIN OUTER)**

## 5.1 언제 유리한가?
- **대량 스캔/집계형** LEFT/RIGHT OUTER.
- 인덱스 의미가 작고, **조기 종료 필요가 적은** 배치/리포트 성격.

## 5.2 예제: “부서별 고객 수와 주문 수를 한 번에(주문 없는 고객도 포함)”
...
## 6.2 REWRITE: FULL OUTER = LEFT OUTER **UNION ALL** RIGHT ANTI
**개념 식**
$$
