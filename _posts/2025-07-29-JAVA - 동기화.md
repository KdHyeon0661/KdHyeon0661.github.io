...
## synchronized vs volatile — 언제 무엇을?
...
## 안전 패턴 — 가드된 블록, 퍼블리시/이스케이프 회피

### Guarded Suspension (조건 대기)
...
### Collections.synchronizedXxx 래퍼
...
### 잘못된 DCL(옛 JMM) → 현재는 `volatile`로 가능
