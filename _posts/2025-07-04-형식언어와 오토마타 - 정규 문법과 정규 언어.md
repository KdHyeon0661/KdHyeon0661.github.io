...
## 2. 우선형 문법(Right-linear Grammar, RLG)
...
## 3. 좌선형 문법(Left-linear Grammar, LLG)
...
## 4. RLG가 생성하는 언어는 정규 언어 — RLG → ε-NFA 변환
...
## 5. 모든 정규 언어는 우선형 문법으로 — DFA → RLG 변환
...
## 6. 좌선형 문법도 정규 언어를 생성 — LLG → ε-NFA (직접 변환)
