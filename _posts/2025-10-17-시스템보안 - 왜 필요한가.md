...
# 화이트 / 그레이 / 블랙 해커 — 개념을 법·윤리·운영 관점으로 분해
...
# Responsible Disclosure(RD) — 실전 운영 가이드
...
# 임의 ID 대입(다른 사용자 가정) — 응답이 "권한 없음"이어야 정상
...
## 상황 A — 공개 웹서비스에서 로그인 없이 **대량 디렉토리 브루트포스**?
