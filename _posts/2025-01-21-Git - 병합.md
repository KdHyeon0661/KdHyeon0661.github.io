...
## Fast-forward vs Non-Fast-forward (확장 설명)
...
# 작업 브랜치를 최신 main 위로 리베이스(개인 브랜치일 때만 권장)
...
## 되돌리기(Undo): merge 커밋 revert vs reset

### merge 커밋 되돌리기(revert)
