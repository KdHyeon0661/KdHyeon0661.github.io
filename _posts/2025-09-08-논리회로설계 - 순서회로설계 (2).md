...
### 1.3 예제: **교차로 신호 FSM** (Moore, 보행 버튼 포함)
...
### 2.2 예제: **UART Rx/Tx + FIFO (115200bps @ 50MHz)**
...
### 2.3 CDC(Clock Domain Crossing)와 메타안정성(Metastability)
