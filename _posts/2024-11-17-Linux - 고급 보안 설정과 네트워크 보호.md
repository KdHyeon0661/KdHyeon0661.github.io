...
### 2.3 웹 기본 인증·워드프레스·관리 URL 보호 예시
```ini
[nginx-http-auth]
enabled  = true
port     = http,https
...
## 3. VPN — OpenVPN 실전(서버·클라·라우팅·DNS·MTU)
...
### 6.2 journalctl로 fail2ban/OVPN 추적
```bash
