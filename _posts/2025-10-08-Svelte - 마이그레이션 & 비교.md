...
category: Svelte
---
# 18. 마이그레이션 & 비교 — **React/Vue → Svelte 사고 전환 · Svelte 4 → 5 체크리스트 · 프레임워크 비교 요약**
...
## 18.1 React/Vue → Svelte: **사고 전환 포인트**

### 18.1.1 “상태 = UI” 연결 방식의 차이
...
### 18.1.9 마이그레이션 전략 (React/Vue → Svelte)
...
### 18.6.2 Vue 컴포지션 → Svelte 5 (Runes)
```ts
// Vue (setup)
const q = ref('');
