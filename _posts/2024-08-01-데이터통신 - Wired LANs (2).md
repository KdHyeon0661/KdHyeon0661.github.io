...
### 13.3.1 Access Method (접근 방식)

#### 1) MAC 레벨: 여전히 CSMA/CD, 그러나 현실은 Full-duplex
...
#### 3) Half-duplex vs Full-duplex 예시
...
### 13.3.2 Physical Layer (Fast Ethernet PHY)
...
#### 1) 100BASE-TX (가장 많이 쓰인 Fast Ethernet)
...
#### 2) 100BASE-FX (파이버 Fast Ethernet)
...
#### 4) Auto-Negotiation과 10/100 혼합 환경
...
#### 1) 기본 MAC: 여전히 802.3, 하지만 Half-duplex는 사실상 사라짐
...
#### 4) 802.3x Flow Control (PAUSE Frames)
...
### 13.4.2 Physical Layer (Gigabit PHY)
...
#### 1) 1000BASE-X (1000BASE-SX/LX/CX 등)
...
#### 2) 1000BASE-T (UTP 기반 Gigabit, 802.3ab)
...
### 13.5.1 Implementation (구현과 설계 관점)
