...
## **예제 코드** — 파이썬으로 간단한 UTM(단일테이프 TM 해석기)
...
### 예제 1 — **단항 증가기**(입력: 1…1 → 끝에 1 하나 덧붙이고 수용)
