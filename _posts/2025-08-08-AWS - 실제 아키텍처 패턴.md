...
## 멀티 리전 고가용성 (Active-Active / Active-Passive)
...
## Route 53 Latency-based Routing + Global Accelerator 조합
...
## 하이브리드 연결: VPC Endpoint + Direct Connect + PrivateLink
...
## 보안 경계 분리: 퍼블릭(CloudFront/ALB) ↔ 프라이빗(NLB/GWLB)
