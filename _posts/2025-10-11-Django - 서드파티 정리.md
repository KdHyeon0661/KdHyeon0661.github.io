...
# drf-spectacular — OpenAPI 문서(Swagger/Redoc)
...
# django-allauth (+ dj-rest-auth) — 회원/소셜 로그인
...
# django-storages (S3/Cloud Storage 업로드)
...
# anymail — 트랜잭션 이메일(SendGrid/Mailgun/SES)
...
# dj-rest-auth — DRF 인증 뷰 세트(JWT 통합)
