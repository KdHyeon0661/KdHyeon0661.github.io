...
## 프록시(Proxy): 리버스/포워드, WAF/캐시/접근제어 템플릿
...
## 방화벽(FW/NGFW): 존/정책·오브젝트 표준 + L4/L7 룰
...
### Service Mesh(mTLS + AuthZ) 예(Istio)
