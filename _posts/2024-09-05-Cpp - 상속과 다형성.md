...
## NVI(Non-Virtual Interface) — 안정적인 재정의 지점
...
## RTTI: `dynamic_cast` / `typeid` (필요 최소한으로)
...
## 정적 다형성: CRTP (Curiously Recurring Template Pattern)
...
## 공변 반환형(Covariant Return)과 `final` 클래스
