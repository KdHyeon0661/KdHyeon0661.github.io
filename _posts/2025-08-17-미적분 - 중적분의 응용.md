...
## 2. 물리적 응용: 질량, 무게중심, 관성모멘트, 열량

### 2.1 면밀도(라미나)의 질량과 무게중심
...
## 3. 확률의 응용: 결합분포·기댓값·공분산·변수변환

### 3.1 결합확률밀도함수(pdf)와 주변/조건부
...
### 7.2 포물선-포물선 사이 부피(회전 없이 “높이”로 해석)
...
## 8. 수치적용: 불규칙 영역에서 몬테카를로 적분(거절 샘플링)
