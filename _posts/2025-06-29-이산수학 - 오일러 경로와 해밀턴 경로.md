...
### 1.4 구성 알고리즘 — **Hierholzer** (무/유향, 멀티그래프 OK)
...
### 3.3 해밀턴 — 백트래킹(작은 n), 비트마스크 DP(중간 n)
...
#### (B) 비트마스크 DP — 존재 판정 및 경로 복원 $$O(n^2 2^n)$$
