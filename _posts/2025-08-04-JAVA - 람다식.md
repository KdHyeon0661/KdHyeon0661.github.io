...
## 2. 함수형 인터페이스와 타깃 타입(Target Typing)
...
## 3. 매개변수 표기: 타입 생략/명시, `var`(JDK 11+), 애너테이션
...
## 6. 캡처와 스코프(Effectively final / this / 동시성)
...
## 10. Stream/Collectors/Optional과 람다
...
## 11. Executor/CompletableFuture와 람다
