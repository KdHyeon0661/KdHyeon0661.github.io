...
### 4.2.1 Number — 정수/실수, 연산, 주의점

#### (1) 정수: 임의정밀(Big Integer)
...
### 4.2.4 Binary / Bitstring — 비트/바이트 시퀀스
...
### 4.2.5 String / Charlist / Chardata — 텍스트
...
### 4.3.1 PID (Process Identifier) — 경량 프로세스 핸들
...
### 4.4.6 iodata / chardata — 고성능 출력 버퍼
