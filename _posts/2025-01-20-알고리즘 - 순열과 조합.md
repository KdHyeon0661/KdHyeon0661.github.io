...
## 생성 전략 고급: 사전식(lexicographic)/비트마스크/다음 순열

### 사전식 다음 순열(next_permutation) — O(n)
...
## 모듈러 조합 — 큰 수에서의 \(nCr \bmod M\)

### 소수 모듈러 \(M=p\): 팩토리얼과 페르마
...
## DP와 백트래킹 — 실전 템플릿과 가지치기

### 조합 생성 + 제약(예: 암호 만들기, 모음≥1/자음≥2)
