...
category: DB 심화
---
# 수동 PGA 메모리 관리 전환 시 주의사항 · PGA_AGGREGATE_TARGET 적정 크기 · Sort Area(작업영역) 할당/해제 원리
...
# 2) PGA_AGGREGATE_TARGET 적정 크기 산정
...
# 3) Sort Area(Workarea) **할당·증설·해제** 라이프사이클
