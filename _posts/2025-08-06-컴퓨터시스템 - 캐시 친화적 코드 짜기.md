...
## 4. 난이도 “상” 워크로드의 지역성 전략

### 4.1 그래프(불규칙 접근) — BFS / SpMV
...
### 8.3 스트리밍 결과 버퍼(Non-temporal store)
