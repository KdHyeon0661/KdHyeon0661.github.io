...
## 6) 고차 연쇄법칙 (2차, 헤시안, Faà di Bruno 스케치)
...
### 10.2 다변수 검증: $$f(x,y)=\ln(x^2+y^2),\ (x,y)=(r\cos\theta,r\sin\theta)$$
$$
...
## 11) 관련률(Related Rates) — 시간에 따른 합성
