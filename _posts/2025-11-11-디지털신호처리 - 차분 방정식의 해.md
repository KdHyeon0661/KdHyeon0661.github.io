...
## 특정계수법(Undetermined Coefficients) — 패턴 총정리
...
## 예제 1 — 서로 다른 실근, 지수 입력(특정계수법·Z-검증)
...
## 예제 3 — 공진(충돌) 사례: \(y[n]-0.5y[n-1]=(0.5)^n\)
