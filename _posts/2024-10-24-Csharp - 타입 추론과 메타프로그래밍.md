...
### 4.4 성능 최적화: `Delegate.CreateDelegate` / Expression Tree
...
## 7. Reflection + 제네릭 — 런타임 타입으로 `MakeGenericType`
...
## 9. 동적 객체: `ExpandoObject`, `IDynamicMetaObjectProvider`
