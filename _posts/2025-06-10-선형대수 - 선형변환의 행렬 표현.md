...
## 예제 2 — 평면 정사영: 좋은 기저에서 “대각”이 된다

### 에서 평면 \(W=\mathrm{span}\{(1,0,1)^\top,(0,1,1)^\top\}\) 로의 **직교 정사영** \(P\)
...
## \(T(\mathbf x)=\mathbf a^\top\mathbf x\)
