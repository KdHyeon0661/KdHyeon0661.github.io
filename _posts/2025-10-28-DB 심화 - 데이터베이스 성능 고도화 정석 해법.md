...
## 접근 경로 최적화: **커버링·프루닝·조인순서**
### 커버링 인덱스(정렬/ROWID 점프 제거)
...
## 메모리·캐시: **Shared Pool / Buffer Cache / PGA**
### Shared Pool(파싱/커서 재사용)
...
## 플랜 안정화: **SQL Plan Baseline / Profile / Outline**
### Baseline으로 “좋을 때” 고정
...
### “배치 커밋 때만 느림” — log file sync

- **해법**: 배치 커밋(묶기), 로그 장치 성능/RTT, 대량 DML 전략 전환

### “RAC에서 특정 노드만 느림” — GC 경합
