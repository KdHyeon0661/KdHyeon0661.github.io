...
## 예제 C: 고객 없이 **기간+상태** 중심 화면 (선택도와 정렬의 타협)
...
# 소트 오퍼레이션 **생략**하기 (정렬·Top-N·집계)

## ORDER BY 정렬 제거 + Stopkey
...
# 실전 비교: 서로 다른 설계안의 숫자 비교

## 시나리오: “최근 7일, 고객의 결제 완료 주문 Top-N”
