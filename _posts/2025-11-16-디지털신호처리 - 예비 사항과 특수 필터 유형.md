...
### IIR 필터 구조: Direct Form, 2차 섹션(SOS)
...
### 예제: 간단한 2차 IIR 설계와 극점 확인 (Octave)
...
### 예제: Butterworth IIR 설계 절차 스케치 (Octave)
...
### 오디오용 Shelving / Peaking EQ (Biquad 형태)
