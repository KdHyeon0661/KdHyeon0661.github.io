...
# 3. 과거의 "정상 작동" 커밋을 지정 (해시, 태그, 브랜치 모두 OK)
...
### 3.3 병합 커밋/브랜치가 복잡할 때(ancestry path 제한)
...
### 5.2 예: Node.js/Java/Go 등 다양한 빌드 체인

핵심은 **항상 같은 방식으로 클린 빌드/실행/측정**하는 것. 언어만 달라질 뿐 패턴은 동일하다.

---

## 6. 로그/재현/공유: 팀에서 함께 살펴보기
...
### 7.3 대규모 히스토리: 태그/릴리스로 good/bad 고정
