...
### 파생(Derivation) & 파스 트리(Parse Tree)
...
## 파싱 알고리즘 — LL(1) (재귀하강) & CYK (CNF)

### 재귀 하강(LL(1)) 파서 — 산술식 예제
...
# Parser (E,T,F) with recursive descent + evaluator
...
## 실전 문법 설계 — JSON-Lite/미니 언어/조건문

### JSON-Lite (문자열·정수·배열·객체)
