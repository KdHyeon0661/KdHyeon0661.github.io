...
## 버전 한눈에 보기 — Svelte 4 vs 5 (Runes 간단 비교)
...
# Svelte의 핵심 감각 — “반응성은 값의 **의미**다”

## 템플릿과 상태 — DOM을 ‘정확히’ 업데이트
