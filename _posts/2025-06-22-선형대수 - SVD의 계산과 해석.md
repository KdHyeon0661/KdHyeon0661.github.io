...
### 2.2 실무 표준: Golub–Kahan **바이대각화 → QR/분할정복**
...
## 6) 저랭크 근사와 Eckart–Young–Mirsky 정리
...
## 7) 파이썬 구현 — PyTorch(기본) & NumPy(비교)

### 7.1 PyTorch: SVD, 저랭크 근사, 의사역행렬, 조건수
```python
import torch
...
### 7.2 PyTorch: Randomized SVD(간단 구현)
```python
