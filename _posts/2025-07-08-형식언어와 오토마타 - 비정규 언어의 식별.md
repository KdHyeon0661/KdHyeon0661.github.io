...
## 도구 #1 — 펌핑 보조정리(Pumping Lemma for Regular Languages)
...
## 도구 #2 — Myhill–Nerode 정리(가장 강력, 깔끔, 보편)
...
### Myhill–Nerode “구별자” 힌트 도우미(유한 깊이 버전)
...
## 케이스 스터디 — 폐포성/호모모피즘 리덕션

### 교집합으로 \(a^n b^n\)로 떨어뜨리기
