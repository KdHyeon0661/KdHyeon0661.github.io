...
### 반복되는 도형/아이콘 → **Drawing/DrawingImage/BitmapCache**
...
# 지연 로딩(Incremental/Lazy Loading)

### UI 가상화 + 끝 근처 프리페치(무한 스크롤)
