...
## 동치류(Equivalence Class)와 분할(Partition)
...
## 관계 성질 검사 및 동치폐쇄(Equivalence Closure)
...
## 대표자 선택과 정렬(표준형, Canonical Representative)
