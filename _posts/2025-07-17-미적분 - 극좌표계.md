...
### 6.2 꽃잎 하나의 면적: 장미 \(r=a\cos(n\theta)\)
...
### 6.3 길이: 아르키메데스 나선 \(r=a\theta\), \(0\le\theta\le b\)
\(r'=a\).
$$
...
### 6.5 레무니스케이트 \(r^2=a^2\cos 2\theta\) (한 루프 면적)
