...
## 1. 중복 조합(Stars and Bars) — 기본부터 상·하한 제약까지
...
### 4.2 k-step Fibonacci (Tribonacci 등)
$$
...
### 4.4 빠른 계산: 행렬 거듭제곱 / 키타마사(Kitamasa)
```python
...
## 6. ‘사람/물건/상자’ 표 — 구분/라벨 유무에 따른 공식을 한눈에
...
# 2. Stars & Bars with uniform cap U
...
# 4. Partitions via Euler pentagonal recursion
...
# 5. k-step linear recurrence via Kitamasa (see earlier)
