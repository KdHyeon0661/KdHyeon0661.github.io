...
### 1.2 간단 버튼 예제 (DashboardViewModel)
...
## 3. 로딩 애니메이션 — IsExecuting/IsBusy + 취소 토큰
...
## 5. 페이지 전환 — ContentControl + DataTemplate
...
### 5.3 App.axaml의 DataTemplate 등록
...
## 6. 입력 검증 — DataAnnotations(간단) vs ObservableValidator(고급)
...
### 6.3 SettingsViewModel — 검증 + 저장/불러오기
