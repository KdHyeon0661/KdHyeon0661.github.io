...
## 클라우드 **메타데이터 서비스** 핵심 정리 (자주 노리는 표면)
...
### Node.js(Express) — 이미지 “URL로 가져오기” 기능
...
### Alibaba Cloud / OCI / DigitalOcean
...
### Nginx/iptables로 로컬/링크로컬 차단(호스트 레벨)
...
### Kubernetes — 특정 네임스페이스만 외부 통신 허용
