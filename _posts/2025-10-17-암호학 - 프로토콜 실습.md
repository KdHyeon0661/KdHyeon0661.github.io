...
## 미니 TLS 1.3 핸드셰이크 트레이스 (X25519 + AES-128-GCM 가정)

### “핵심 흐름” 요약 (서버 인증 / 1-RTT)
...
### 파이썬으로 **HKDF-Expand-Label**/비밀 파생/Finished 검증 재현
