...
## 관련 구조 복습 — ITL · Row Lock Byte · XID(Undo 슬롯)
...
## Commit Cleanout vs Delayed Cleanout — 차이와 발생 조건
...
## 실습 — Commit/Delayed Cleanout 체감하기
...
### 세션 A — 대량 UPDATE 후 커밋 (Commit Cleanout 일부 수행)
...
### 세션 B — 이어서 동일 범위 조회(Delayed Cleanout 유발)
...
## 클린아웃과 ITL(Interested Transaction List)
...
### “대량 DML → 즉시 보고서” (Delayed Cleanout 비용 체감)
