...
## 2. 주항의 결정(결합 절차) — **완전 전개 예제**

### 2.1 문제(케어/Don’t-care 명세)
...
### 2.5 소수 주항(PI) 확정(✓가 **최종 단계에서** 붙지 않은 항)
...
### 5.4 패트릭(Petrick) — 최소 커버(PI 수 → 리터럴 수)
