...
### NF4 / Double Quant / Paged Optimizer
...
# LoRA 병합하여 추론 단순화
# # 가중치에 ΔW 병합, 추후 CPU 추론 편리

```

### 생성 예시(소형 Causal LM + LoRA)
