...
## 4. 기본값 — undefined에서만, 의존 기본값

### 4.1 `undefined`에서만 동작
```js
const [d1 = 1] = [null];         // d1 = null
const { v = 1 } = { v: 0 };      // v = 0
```

### 4.2 다른 변수에 의존하는 기본값(선언 순서 중요)
```js
