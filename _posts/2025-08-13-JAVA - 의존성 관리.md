...
### BOM(Bill of Materials)로 버전 일괄 관리
...
### BOM 사용 — `platform` / `enforcedPlatform`
...
### Version Catalogs (`libs.versions.toml`) 예
...
### 공급망 보안: **Dependency Verification**
...
### Gradle + Spring Boot (platform + catalogs + locking)
