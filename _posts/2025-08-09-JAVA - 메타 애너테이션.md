...
### 1.3 예제 — TYPE_USE/TYPE_PARAMETER 활용 (정밀한 타입 애너테이션)
```java
import java.lang.annotation.*;
...
### 1.4 예제 — RECORD_COMPONENT, MODULE, PACKAGE
```java
...
### 6.2 RECORD_COMPONENT 애너테이션 조회 (Java 16+ API)
```java
...
## 8. PACKAGE/MODULE 애너테이션 — package-info.java / module-info.java
...
## 11. 종합 예제 — 올바른 메타 애너테이션 조합과 사용

### 11.1 정의: 서비스 메타데이터 애너테이션
```java
import java.lang.annotation.*;
