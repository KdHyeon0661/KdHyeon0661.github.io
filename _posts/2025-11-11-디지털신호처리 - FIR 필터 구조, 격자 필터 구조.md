...
## Direct Form(Transversal) FIR 구조
...
### GNU Octave 구현 (Transposed 구조, 개념 코드)
...
## FIR 격자 필터와 격자-사다리(Lattice–Ladder) 구조
...
### GNU Octave 구현 예 (2단 FIR 격자–사다리, 샘플 단위)
