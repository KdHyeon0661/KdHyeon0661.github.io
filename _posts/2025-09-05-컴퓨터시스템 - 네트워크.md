...
## 10. 전송 방식 — Uni/Multi/Broad/Anycast
...
## 11. 성능 최적화 — MTU/PMTUD, 큐잉/혼잡, 버퍼블로트
...
## 13. 클라우드·데이터센터 — VPC/VXLAN/Leaf-Spine/K8s

### 13.1 VPC (AWS/GCP/Azure 공통 개념)
