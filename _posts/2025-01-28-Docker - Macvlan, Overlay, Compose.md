...
### 2.4 호스트 ↔ 컨테이너 직통 불가 문제 해결 (권장 루트)
...
### 2.5 Compose 예제 — macvlan 외부 네트워크 사용
...
### 3.3 포트 공개(ingress/routing mesh)
...
### 3.5 Stack(Compose for Swarm) 예제
...
### 4.2 외부 네트워크 붙이기(bridge/macvlan/overlay 등)
