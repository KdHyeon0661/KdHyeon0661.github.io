...
## 서버 이벤트 버스(InMemory / Redis)

### InMemory 버스(단일 인스턴스용)
...
## 히스토리(초기 로드/오프라인 동기화) — `/api/history`
...
## 페이지 구성(+page.svelte) — 선택한 전송 방식으로 연결
