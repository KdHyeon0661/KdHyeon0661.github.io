...
category: 정보보안기사
---
# 완전 정리 (구조·MIB/OID·PDU·v1/v2c/v3 보안·트랩/인폼·NAT/방화벽·리눅스/네트워크장비 설정·도구(snmpwalk/pySNMP/PowerShell)·성능계산·운영/보안 체크리스트)
...
## PowerShell 예시(Windows에서 폴링 스크립트)
...
## 트랩 운영(snmptrapd → Syslog/SIEM 연계)
