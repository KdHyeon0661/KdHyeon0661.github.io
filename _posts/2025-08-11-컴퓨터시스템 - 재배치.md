...
## 텍스트 재배치(TEXTREL)와 `R_*_COPY` — 반드시 피하기
...
## TLS(Thread-Local Storage) 재배치 (개요)
...
## 미니 워크스루 — `RELATIVE/GLOB_DAT/JUMP_SLOT` 눈으로 보기
