...
## 어셈블(Assemble): 기계어·섹션·재배치·심볼

### 오브젝트 파일(ELF .o)의 기본 섹션
...
## ELF 섹션 vs 세그먼트, 심볼/디버깅

### 섹션(빌드 관점)과 세그먼트(로딩 관점)
...
## CRT(startup)과 수명 주기: _start → main → 종료
