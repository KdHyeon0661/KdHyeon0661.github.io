...
## 4. 표현 노출(Representation Exposure) 방지

### 4.1 잘못된 예(내부 구조 새어 나감)
```java
public class Cart {
...
## 13. 도메인 시나리오: 할인 규칙을 ‘행위’로 감싸기

### 13.1 안티패턴(게터/세터로 외부 제어)
```java
