...
category: Django
---
# 린트/포맷터 — **Ruff / Black / isort**, 그리고 **pre-commit**
...
## `pyproject.toml` 예시 (Ruff + Black 한 번에)
...
### `.pre-commit-config.yaml` (Ruff → Black → Ruff --fix)
