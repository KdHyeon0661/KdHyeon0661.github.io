...
## 합법·윤리: 책임 있는 공개(Responsible Disclosure), 테스트 범위(ROE), 로그·개인정보 처리
...
# ns-gw에 NAT 구성(외부 인터넷이 필요 없다면 생략 가능)
...
### Docker Compose 기반 랩 (웹/DNS/미들박스 포함)
