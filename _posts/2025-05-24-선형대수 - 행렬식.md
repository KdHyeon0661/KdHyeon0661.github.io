...
### 2.2 라플라스 전개(Laplace expansion, 여인자 전개)
...
### 5.2 실전(수치해석) — **LU/QR/Cholesky/SVD**
...
## 부록 A) 교육용 구현: 재귀적 여인자 전개(작은 n 전용)
