...
### 2.2 ULP(Unit in the Last Place)
...
### 2.3 Octave 실험 — eps/ULP/half-ULP
...
## 3. 표현의 함정: 0.1, 결합법칙 붕괴, 소실/폭발

### 3.1 0.1이 정확히 표현되지 않는 이유
...
### 3.3 소실(cancellation): 큰 값에서 작은 값 빼기
...
### 5.2 FMA(Fused Multiply-Add) 개념과 모의실험
