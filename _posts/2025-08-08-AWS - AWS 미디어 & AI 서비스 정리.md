...
## Elastic Transcoder — “간단 변환” 파이프라인
...
## AWS Elemental MediaConvert — 방송/OTT급 트랜스코딩
...
### Python: 업로드 → MediaConvert → Rekognition Moderation
...
### Bash: Rekognition OCR → Comprehend 감정
