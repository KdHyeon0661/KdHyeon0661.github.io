...
## 내구성(영속성) — `fsync`/`fdatasync`/원자적 교체
...
## 성능 레버: 버퍼 크기, readahead, Direct I/O
...
### 원자적 교체 + 내구성(임시→fsync→rename→fsync(dir))
