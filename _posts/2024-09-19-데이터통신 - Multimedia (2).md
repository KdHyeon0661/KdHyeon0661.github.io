...
## Streaming Stored Audio/Video (저장된 콘텐츠 스트리밍)
...
### 단순 프로그레시브 다운로드 vs HTTP Adaptive Streaming
...
#### HTTP Adaptive Streaming (HLS, DASH 등)
...
## Streaming Live Audio/Video (라이브 스트리밍)
...
## Real-Time Interactive Audio/Video (실시간 상호작용 A/V)
...
### WebRTC 코드 스니펫(개념 예제, JavaScript)
