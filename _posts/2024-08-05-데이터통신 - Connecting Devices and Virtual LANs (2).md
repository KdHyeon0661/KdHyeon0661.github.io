...
## 17.2.1 VLAN Membership

### 1) VLAN이란? — “논리적 브리지 도메인”
...
### 2.1 Port-based VLAN Membership (정적 VLAN)
...
### 1) Access Link vs Trunk Link (다시 정리)
...
### 3) 여러 스위치 간 VLAN 설계 예와 코드 시뮬레이션
...
### 4) Inter-VLAN Routing과 스위치 간 연계
...
### 6) 코드 예제: VLAN 개수와 브로드캐스트 부하 간단 계산
