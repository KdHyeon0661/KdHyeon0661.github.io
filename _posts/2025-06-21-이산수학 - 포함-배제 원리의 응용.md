...
## 3. 응용 3 — **문자열/알파벳 제약** (A,B,C 중 적어도 하나 포함)
...
## 5. 응용 5 — **정수론: 배수/공배수 & 오일러 피함수**

### 5.1 배수의 포함-배제 (일반 N, 다수의 약수)
...
## 6. 응용 6 — **조합적 카운팅의 대표작: 전사 함수/데랑주망**

### 6.1 전사(onto) 함수 \([n]\to[m]\)
...
## 9. 알고리즘 관점 — **비트마스크 PIE / LCM-DFS / SOS-DP**

### 9.1 비트마스크 PIE (조건 수 \(m\)이 작을 때)
...
### 9.3 SOS-DP(Subset Sum over Supersets) & 모비우스 반전
...
### 10.2 강한 비밀번호(대/소/숫자 최소 1) — 모듈러 버전
