...
## 7. VLA(Variable Length Array)와 제약
...
## 9. 구조체 배열(AoS) vs 배열 분할(SoA)과 캐시
...
```asm
# 부록: 1D 접근 (int) - rdi=a, esi=i, edx=v
# a[i] = v
