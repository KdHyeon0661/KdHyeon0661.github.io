...
## 3. 연쇄 분할(Partition refinement) — **Moore 표준**
...
### 4.2 Worked Example — **Mealy**(중첩 허용 `1011`의 부분 FSM)
...
## 6. 상태할당(State Assignment) — **로직을 줄이는 코딩**
...
## 7. 실전 예제(끝까지) — **Moore FSM 최소화 → 상태할당 → 논리 도출**
