...
category: DB 심화
---
# vs 낙관적(Optimistic) 동시성 제어** 완전 가이드
...
## 동시성 문제의 원형: Lost Update / Non-Repeatable / Phantom / Write-Skew
...
### Lost Update 방지: `SELECT ... FOR UPDATE`
