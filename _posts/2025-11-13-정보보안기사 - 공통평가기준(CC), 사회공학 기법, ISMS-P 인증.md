...
## 공통평가기준(CC: Common Criteria) — CC:2022 중심
...
## 사회공학(Social Engineering) — 최신 위협·교육·탐지
...
## 실전 예제 묶음(운영에 바로 쓰는 스니펫)

### DMARC RUA(집계) XML 파서(학습용)
