...
## 3. typeof / instanceof / toString.call — 타입 판별 총정리
...
## 4. Primitive vs Object — 저장·복사·변경
...
### 4.1 함수 인자 전달 — **항상 값-복사(call by value)**
...
## 5. 박싱(Wrapper)과 ToPrimitive — 연산 시 내부 동작
...
## 6. 얕은 복사 vs 깊은 복사 — 스프레드, 구조 분해, Object.assign
...
## 8. 직렬화/역직렬화 — JSON vs structuredClone vs MessagePort
...
## 10. 객체 불변화 — freeze/seal/preventExtensions
...
## 11. 심볼/접근자/비열거 프로퍼티 — 메타데이터 안전 저장
...
### 14.1 타입 안전 덧셈기 — `number`/`bigint`/`string` 구분
