...
## `git fsck --lost-found` — dangling(고아) 커밋/객체 찾기
...
## 브랜치 삭제 복구 — reflog와 팀 동료의 로컬이 최고의 백업
...
## rebase 중단/혼선 복구 — abort, continue, reflog, rerere
...
## force-push(강제 푸시) 사고 — 팀 레벨 롤백 전략
...
### rebase 꼬임 → abort/continue + reflog 회귀
