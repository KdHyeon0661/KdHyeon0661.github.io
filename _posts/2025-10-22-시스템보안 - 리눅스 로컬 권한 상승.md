...
## 잘못된 파일 퍼미션 / PATH 하이재킹 / LD_PRELOAD 악용

> 아래는 **감사·탐지와 완화** 관점의 절차입니다. **악용 절차**는 제공하지 않습니다.

### 잘못된 퍼미션 (world-writable, 소유자/그룹 설정 오류)
...
### LD_PRELOAD/LD_LIBRARY_PATH 오남용
...
## 커널 인터페이스 /proc, /sys, /dev를 통한 정보수집 (안전한 점검)
...
## (안전 대체) 실습: VulnHub/THM 스타일 박스 — “프리뷰만” & 방어 보고서 쓰기
...
## 방어: sudoers 최소화, 파일시스템 마운트 옵션, 크론/타이머 점검
