...
## 7.1 TLS 1.2/1.3, Cipher Suite, PFS, 0-RTT 리스크

### 7.1.1 TLS 1.2 vs 1.3 핵심 비교
| 항목 | TLS 1.2 | TLS 1.3 |
|---|---|---|
...
### 7.1.2 Cipher Suite & 운영 권장(서버 우선)
- **TLS 1.3(권장 기본)**
...
### 7.1.3 PFS(Perfect Forward Secrecy)
...
## 7.3 TLS 가시성: JA3/JA4, SSL Inspection의 법·컴플라이언스
...
### 7.3.2 SSL Inspection(복호) — 법·윤리·컴플라이언스
...
### 7.4.9 보너스: Python으로 인증서 파싱·검증(점검 스크립트)
```python
