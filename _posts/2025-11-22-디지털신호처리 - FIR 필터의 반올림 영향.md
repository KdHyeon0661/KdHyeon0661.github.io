...
category: 디지털신호처리
---
# 영향 — 내부 연산 잡음 모델, 구조별 차이, 고정소수점 설계, GNU Octave 실험과 실무 체크리스트
...
## GNU Octave 실험 2 — 구조(대칭 최적 vs 일반 DF) 비교
...
## GNU Octave 실험 3 — “잡음 이득”과 오차 분산의 관계 확인
