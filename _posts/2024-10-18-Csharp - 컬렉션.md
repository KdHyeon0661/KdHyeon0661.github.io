...
## 2) Dictionary<TKey, TValue> — 해시 기반 맵
...
### 8.1 SortedDictionary<TKey, TValue>
- 내부는 **균형 트리**(레드-블랙 트리)
...
## 11) 동시성 컬렉션 (System.Collections.Concurrent)
...
## 13) 커스텀 비교/동치 — `IEqualityComparer<T>`, `IEquatable<T>`

### 13.1 값 타입/레코드의 동치 정의
