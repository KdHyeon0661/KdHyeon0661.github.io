...
### 3.3 자동/특수 터널 (6to4, Teredo, ISATAP 등)
...
### 3.4 현대식 활용 — IPv6-only 코어 + 터널 기반 IPv4 운반
...
## 4. Translation (NAT64, DS-Lite, 464XLAT 등)
...
### 4.2 DS-Lite, LW4o6, MAP-T/E 등 (요약)
...
### 4.3 464XLAT — NAT64를 보완하는 단말 측 변환
...
## 2. IPv4와 연관된 특별 IPv6 주소들

전환기에 자주 언급되는 몇 가지 IPv6 주소 형식이 있다.

### 2.1 IPv4-mapped IPv6 주소(::ffff:a.b.c.d)
...
### 2.2 IPv4-compatible IPv6 (::a.b.c.d) — 역사적 개념
...
### 4.2 재번호(Renumbering) — IPv4보다 쉬워야 한다
