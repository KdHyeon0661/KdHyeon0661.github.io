...
## 3. 핵심 기법 카탈로그와 SQL 패턴

### 3.1 인덱스 최적화(커버링/함수/부분/복합)
...
## 5. 보고서/집계성 워크로드 패턴(OLAP-on-OLTP 최소화)
...
### 12.2 BRIN 인덱스(대용량 시간열, PostgreSQL)
