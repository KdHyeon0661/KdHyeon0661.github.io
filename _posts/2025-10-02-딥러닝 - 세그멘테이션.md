...
## 손실 선택: Dice / Focal-Dice 중심

### Binary Dice Loss (soft)
...
### Multi-class Dice (mean of per-class)
...
### Tversky / Focal-Tversky (경계·불균형 강화)
...
### 간단 변환(Flip/RandomCrop/Normalize)
...
## 통합 훈련 스크립트(바이너리; ResUNet + Focal-Dice + 타일 추론 옵션)
