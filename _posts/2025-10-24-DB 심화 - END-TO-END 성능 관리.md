...
### 애플리케이션(예: Java/Spring)에서 Trace 전파
...
## **Oracle 연동 심화**: 요청→세션→SQL→라인까지 **한 줄로**

### 요청-단위 태깅(모듈/액션/클라이언트)
...
### DB Time/CPU/Temp 단서(Time Model + Temp)
