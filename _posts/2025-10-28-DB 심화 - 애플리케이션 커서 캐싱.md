...
### 2.1 Java — **JDBC (Oracle 드라이버)**
#### 2.1.1 풀 & Statement Cache 활성화
```java
...
### 2.2 .NET — **ODP.NET (Oracle.ManagedDataAccess)**

#### 2.2.1 연결 & Statement Cache
```csharp
...
### 2.5 Go — **godror (Go Oracle driver)**
...
## 9. 작은 실험: Statement Cache On/Off 비교(개념 데모)
