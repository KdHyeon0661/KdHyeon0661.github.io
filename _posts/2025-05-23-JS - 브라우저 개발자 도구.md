...
## Elements — DOM·CSS 실시간 편집과 구조 파악
...
## Styles / Computed / Layout — CSS 디버깅 집중
...
## Application — Storage·PWA·Service Worker
...
## Performance — 렌더링/스크립트 병목과 프레임 드롭 찾기
...
## Lighthouse — 성능·접근성·SEO·PWA 품질 자동 점검
...
## Security — HTTPS·CSP·Mixed Content·인증서
...
## Rendering / Layers / Paint Flashing — 레이아웃·페인트 가시화
