...
## 0. Connection String의 구조와 병합 규칙 복습
...
### 1.3 개발(appsettings.Development.json)
...
### 1.4 운영(appsettings.Production.json)
...
## 2. Program.cs — 구성 병합과 DbContext 등록
...
## 3. Secret Manager / 환경 변수 / Azure Key Vault

### 3.1 Secret Manager (로컬 개발)
...
## 7. 헬스 체크(Health Checks) — DB 연결 확인
...
## 9. 구성 바인딩과 IOptions 패턴(연결 관련 튜닝)
...
### 11.1 로컬 개발: SQLite + User Secrets
