...
## 2. **Adaptive Cursor Sharing(ACS)** — 바인드 스큐 보정
...
## 3. **입력 값에 따라 SQL을 분리** — 의도를 명시하는 설계
...
## 7. SPM(SQL Plan Baseline)으로 **좋은 플랜 봉인**
