...
## 3) 정규형(Canonical Forms)

### 3.1 PDNF / SOP (Principal Disjunctive Normal Form)
...
### 3.2 PCNF / POS (Principal Conjunctive Normal Form)
...
## 4) Shannon 분해(Decomposition) & 공변수(Cofactor)
...
## 5) ANF(Algebraic Normal Form) / Zhegalkin 다항
...
## 6) BDD/ROBDD (Binary Decision Diagram)
...
### 8.2 K-맵(Karnaugh Map) — 2~4(6)변수 시각 간소화
...
## 11) 완전성(Functional Completeness) & Post 조건
...
### 13.2 간단 K-맵 보조(4변수까지) — 교육용 그룹 후보 찾기
