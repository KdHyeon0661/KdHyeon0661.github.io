...
#### C#으로 무결성 수준(Integrity Level) 읽기
...
#### PowerShell: 서비스 경로/권한 한 번에 훑어보기
...
#### PowerShell: SYSTEM 작업 + 쓰기 가능 경로 탐지
