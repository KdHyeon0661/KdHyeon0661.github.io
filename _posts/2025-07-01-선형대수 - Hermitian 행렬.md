...
### 레일리 몫(Rayleigh quotient)과 최대/최소
...
## Python 실습(NumPy): 판정·대각화·최소최대·Cholesky
...
# Rayleigh quotient로 λ_min/λ_max 확인
...
## 추가 Python 예제: 무작위 Hermitian 생성·검증
