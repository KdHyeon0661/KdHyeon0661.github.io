...
## 개인 장비 보안 가이드(연구자용): VM 스냅샷·격리 습관
...
### Windows 권한/서비스 빠른 헬스체크 (PowerShell)
...
### Linux SUID/Caps/SSH/NOPASSWD 빠른 헬스체크 (bash)
