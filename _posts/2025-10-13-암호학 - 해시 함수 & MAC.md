...
## ✅ 6.2 SHA-2 / SHA-3(Keccak) 개관

### 6.2.1 SHA-2 (SHA-224/256/384/512 …)
...
### 6.2.2 SHA-3(Keccak) — 스펀지(Sponge) 구조
...
## ✅ 6.3 길이 확장 공격(length extension) 직관

### 6.3.1 왜 발생하나 (Merkle–Damgård)
...
### 6.4.3 KMAC (SHA-3 계열) — 스펀지 기반 MAC
