...
### 조건문 폭발(Complex Conditional / Repeated Switch)
...
### 메시지 체인(Message Chain) / 중개자 남용(Middle Man)
...
### 데이터 클래스(Data Class) / 기본형 집착(Primitive Obsession)
