...
### Terraform 예시(요약: 2-AZ Public/Private)
...
### Aurora(리전 내) & Aurora Global Database(다중 리전)
...
## 글로벌 트래픽 — Route 53, CloudFront, Global Accelerator
...
### CDK(TypeScript): ALB + TargetGroup + 헬스체크
...
### 두 AZ에 퍼블릭/프라이빗 서브넷 만들기(요약 Terraform)
