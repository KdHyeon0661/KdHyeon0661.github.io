...
## 조건 이동(Branchless) — cmov/setcc로 분기 제거
...
## switch — 연속 범위는 점프 테이블, 산개는 체인/이진검색
...
## 루프 최적화 개론 — 언롤링·강도 감소·벡터화·호이스팅

### 루프 불변 코드 이동(hoisting)
...
## 조건 코드와 분기 종류 — signed vs unsigned
...
## 고급: 듀프의 기법(Duff’s Device) — switch+루프 언롤링
...
## 플랫폼 차이 — ARM의 조건부 실행/선택, MIPS 지연 슬롯
...
## 예제: 분기 제거로 일정 시간(constant-time) 비교
...
## 실습: 분기/분기없는 max, switch 변형, 루프 언롤
