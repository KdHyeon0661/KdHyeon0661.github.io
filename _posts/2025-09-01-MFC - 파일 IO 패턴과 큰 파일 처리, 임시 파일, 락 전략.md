...
# 락 전략 — 바이트 범위 락 + 네임드 뮤텍스

## 파일 내부 레코드/범위 보호 — LockFileEx
...
# 텍스트/바이너리/인코딩 — UTF-8/UTF-16, BOM, 줄바꿈
...
# 오류 처리/복구 UX — 디스크 부족/권한/충돌/바이러스 검사
...
# MFC `CFile`/`CArchive`와 Win32 혼용 팁
...
# 파일 감시/동기화 — ReadDirectoryChangesW
