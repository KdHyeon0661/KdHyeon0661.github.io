...
## NVI(Non-Virtual Interface)와 예외 보증
...
## 예제: `static` + 오버로딩 + 변환 연산자 + `explicit` 종합
...
## PImpl(포인터에 의한 구현) — ABI 안정·컴파일 시간 단축
