...
## 권한(Authorization) — 롤/정책/클레임/리소스 기반
...
## 정책 기반 권한 — Role/Claim/Custom Requirement
...
## 리소스 기반 권한(IAuthorizationService)
...
## 401 vs 403 — 에러 응답 표준화(ProblemDetails)
