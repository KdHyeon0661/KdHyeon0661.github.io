...
## Regularization 튜닝 절차(실무형 Checklists)
...
### Scikit-learn — L1/L2/ElasticNet와 정규화 경로
...
### PyTorch — MC Dropout로 **불확실성** 추정(ECE 평가 예시 포함)
...
### TensorFlow/Keras — Label Smoothing + Dropout/BatchNorm + ReduceLROnPlateau
