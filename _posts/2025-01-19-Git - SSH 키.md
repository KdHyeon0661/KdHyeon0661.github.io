...
## 여러 키/여러 계정/여러 호스트 관리 — `~/.ssh/config`
...
## 고급: **SSH 기반 커밋/태그 서명(Verified 배지)**
...
### ProxyCommand/ProxyJump(전용 프록시 활용)
...
### 기존 HTTPS 프로젝트를 SSH로 마이그레이션(서브모듈 포함)
