...
## 4. **Child 커서를 공유하지 못하는** 대표 케이스 (같은 Parent인데 Child가 늘어남)
...
### 4.3 스키마/권한/뷰 확장 차이(파싱 스키마가 다른 경우)
...
## 5. **Parent 커서를 공유하지 못하는** 대표 케이스 (텍스트가 달라 Parent 자체가 분리)
...
### 8.3 “배포/통계 수집 직후 Invalidations 폭주”
