...
## 배치(Batch) vs 실시간(Online/Realtime)
...
## 배치 파이프라인 예시(파이썬/파이토치 + DuckDB/S3)
...
### IoU/mAP 계열(Detection/Seg) 회귀 체크 핵심
...
## 엔진/정밀도 변경(ONNX↔TensorRT/FP32↔FP16↔INT8) 수치 검증
