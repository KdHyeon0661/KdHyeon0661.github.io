...
### 6.6 1697 — 숨바꼭질(BFS on 상태공간: 위치 그래프)
...
### 6.7 1012 — 유기농 배추(격자 DFS/BFS, 연결 요소)
...
### 6.8 13023 — ABCDE(깊이 5 경로 존재 여부: DFS with depth)
...
### 7.1 벽을 한 번 부술 수 있는 BFS(상태 차원 추가)
