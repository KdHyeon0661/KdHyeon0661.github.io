...
## 의미 있는 클래스 네이밍 — 역할 기반으로, 모양이 아니라 “의도”
...
## 일관된 코드 스타일 — linters/formatters로 자동화
...
## 디자인 토큰(CSS Custom Properties) — 확장성의 기반
...
## 우선순위(Specificity) 관리 — 낮게 유지하는 것이 왕도
...
## 반응형 설계 — Mobile First + 컨테이너 쿼리 병행
...
## 재사용 극대화 — Mixin/Function vs Utilities vs 컴포넌트 API
...
## 상태/변형 설계 — Modifier, data-*, ARIA 상태 활용
...
## DevTools로 검증 — Coverage/Performance/Layout
...
## 미사용 CSS 제거(안전하게) — Content aware 제거
...
## 마무리 — “낮은 우선순위·의미 중심·자동화”가 오래가는 CSS의 핵
