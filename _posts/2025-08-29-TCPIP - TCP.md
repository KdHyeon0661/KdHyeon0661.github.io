...
## 3-way 핸드셰이크 & 종료, 상태 다이어그램 (🔰)

### 연결 성립 (SYN → SYN/ACK → ACK)
...
## SACK, 윈도우 스케일, 대역폭-지연곱(BDP) (⚙️)

### 윈도우 스케일(Window Scale)
...
## Nagle, Delayed ACK, Keepalive, TIME_WAIT, MSL (⚙️)
...
## 혼잡제어 심화: ECN, CUBIC vs Reno, RACK/TLP (⚙️)
