...
## 5.1 케이스 A — 왼쪽 입력(ORD)을 **인덱스 스캔**으로 정렬 대체
...
## 5.2 케이스 B — 양쪽 모두 **정렬 대체** (두 쪽 다 인덱스 순서)
...
# 6. **first 집합이 이미 정렬**되어 있을 때 (소트 생략)
