...
### 듀얼스택 리스닝과 `IPV6_V6ONLY`

#### 한 소켓으로 v4/v6를 받을 수 있나?
...
### `AI_V4MAPPED`/`AI_ADDRCONFIG` — 주소 해석 모드
...
### 실습: **IPv4/IPv6 자동 선택 클라이언트** (Happy Eyeballs 스타일)
