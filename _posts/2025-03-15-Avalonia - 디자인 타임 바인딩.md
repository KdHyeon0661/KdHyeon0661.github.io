...
## 2. 가장 쉬운 방법: `d:DataContext` (XAML 전용 더미 바인딩)
...
## 3. 디자인 전용 ViewModel/Model/Service를 분리하기

### 3.1 ViewModelDesign: 상속으로 더미 데이터 넣기
...
### 3.2 디자인 전용 Service를 주입하기 (DI/Mock)
...
### 5.2 View에서 DataContext를 DI로 주입
...
## 6. 컬렉션/템플릿/그리드의 디자인 타임 관찰 포인트

### 6.1 가상화 컨트롤(ItemsControl/TreeView/DataGrid)
...
## 8. 디자인 타임에서의 형식 안전(Compiled Bindings)과 상태
...
## 10. Rider / Visual Studio / CLI Previewer
...
## 11. 실전 예제: 마스터-디테일 화면의 디자인 타임 데이터

### 11.1 ViewModel(런타임용/디자인용)
...
## 12. 고급: 복합 화면(탭/다중 패널)에서의 디자인 타임 데이터 전략
