...
### 2.5 Faddeev–LeVerrier (트레이스 기반, 임의 \(n\))
...
## 9) Python 실전: 특성다항식/검증/알고리즘

> 아래 코드는 **SymPy**(상징), **NumPy**(수치) 기반 예제입니다.

### 9.1 SymPy로 특성다항식, 고유값, 비에타 검증
...
### 9.3 Faddeev–LeVerrier 구현 (NumPy)
...
### 9.5 동역학/제어: 원하는 특성다항식의 companion 행렬
