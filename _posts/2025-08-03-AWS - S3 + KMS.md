...
### 1.1 S3 Block Public Access (BPA)
...
### 1.3 버킷 기본 암호화(Default Encryption) + S3 Bucket Keys(비용절감)
...
## 7. S3 객체의 KMS 키 변경(재암호화) — 운영 패턴

### 7.1 S3 Copy로 SSE-KMS 키 교체(서버사이드)
