...
## 베이스라인: MFC SubclassDlgItem로 “가벼운 확장”
...
## Old-school: `SetWindowLongPtr(GWLP_WNDPROC)` 직접 교체
...
## MFC 클래스 기반 서브클래스(확장 컨트롤 라이브러리화)
