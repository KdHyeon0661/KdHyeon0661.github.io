...
### 3.3 공통 규칙 + 개별 규칙(Include/Match 활용)
```sshconfig
# 공통 기본
Host *
...
## 10. CI/CD와 배포 키(Deploy Key), 머신 사용자
...
### 11.1 개인/회사 동시 운용(전체 흐름)
```bash
# 1. 키 생성(이미 있음 가정)
# 2. ~/.ssh/config 구성(개인/회사 별칭)
# 3. 개인 저장소
