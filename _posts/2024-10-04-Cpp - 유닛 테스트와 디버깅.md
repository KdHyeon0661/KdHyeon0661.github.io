...
## `assert` vs `static_assert` vs 예외: 언제 무엇을 쓰나
...
## GoogleTest & GoogleMock: 대규모 프로젝트 표준
...
## Property-based Testing 한 숟갈 (불변식 테스트)
...
## 새너타이저(ASan/UBSan/TSan/MSan): 버그를 “즉시” 터뜨려라
...
## 실전 미니 모듈: `StringUtil` + 두 프레임워크 테스트
