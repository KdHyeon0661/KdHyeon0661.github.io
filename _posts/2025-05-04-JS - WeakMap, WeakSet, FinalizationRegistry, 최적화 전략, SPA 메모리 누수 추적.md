...
## 메모리 추적(Chrome DevTools/Node)

### 크롬 DevTools — Heap Snapshot
...
### AbortController로 “일괄 정리”되는 fetch
...
### WeakRef + FinalizationRegistry로 소프트 캐시
