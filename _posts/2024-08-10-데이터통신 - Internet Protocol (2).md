...
#### 2.1.3 ping + ICMP를 직접 만들어 보는 코드 (Python, raw socket)
...
### 2.2 traceroute / tracert — Time Exceeded 기반
...
### 2.3 기타 도구 (mtr, pathping, PMTUD 등)
