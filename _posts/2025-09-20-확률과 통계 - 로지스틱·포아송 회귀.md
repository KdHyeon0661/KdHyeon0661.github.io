...
## Hook — “비율은 로지스틱, 카운트는 포아송. 그리고 ‘노출’은 오프셋”
...
## 예시 1 — 로지스틱: CVR ~ variant + device + sessions + (variant×new_user)
...
## 예시 2 — 포아송: 클릭수 ~ variant + (오프셋=log 노출)
