...
### 하위 태스크와 관련 활동(RelatedActivityId)
...
```powershell
# Admin PowerShell
# 시작: CPU 샘플+스택, 디스크/파일 I/O, 네트워크, GPU, 힙(할당), CLR off
