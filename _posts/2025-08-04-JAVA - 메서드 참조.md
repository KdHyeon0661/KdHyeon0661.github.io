...
### `collect(Supplier, BiConsumer, BiConsumer)` 3항 형태
...
### 동시성 API: `CompletableFuture`와 결합
...
### `super` 디폴트 메서드 선택 (인터페이스 충돌 해결 맥락)
