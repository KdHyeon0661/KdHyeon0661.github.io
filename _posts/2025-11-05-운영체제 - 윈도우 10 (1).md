...
### 21.1.1 NT 계열에서 Windows 10까지 간략 연대표
...
### 21.1.2 “Windows as a Service”의 의미
...
### A.3 HTTP.sys 커널 HTTP 바인딩(관리자) — URL 예약
```powershell
