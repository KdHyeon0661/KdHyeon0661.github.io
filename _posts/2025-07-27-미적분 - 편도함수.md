...
## PyTorch로 검증(오토그라드) — 사용자가 선호하는 PyTorch 기준
...
# 헤시안: jacobian-of-gradient 또는 torch.autograd.functional.hessian
