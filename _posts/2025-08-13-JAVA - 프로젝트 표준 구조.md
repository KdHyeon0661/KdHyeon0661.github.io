...
## `src/main/resources` & `src/test/resources` — 리소스 처리
...
## Gradle Test Fixtures — 테스트 공용 코드 공유
...
## CI/CD 예시(Wrapper, 캐시, 멀티-JDK)

### Maven (GitHub Actions 예시)
