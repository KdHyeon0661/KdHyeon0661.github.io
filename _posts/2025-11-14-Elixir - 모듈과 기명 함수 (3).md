...
### 6.8.2 `alias/import/require/use` 의도 구분
...
#### 6.8.2.1 alias — 길고 중복되는 모듈 이름 줄이기
...
#### 6.8.2.2 import — 함수 이름을 현재 스코프로 끌어오기
...
#### 6.8.2.4 use — 보일러플레이트 주입(__using__/1)
...
## 6.11 얼랭 라이브러리의 함수 호출하기 (Erlang Interop)
...
## 6.12 라이브러리 찾기 (Code Path · Mix/Hex · priv · 런타임 탐색)
