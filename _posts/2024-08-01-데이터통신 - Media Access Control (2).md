...
---
# 12.2 Controlled Access — Reservation, Polling, Token Passing
...
## 12.2.0 Controlled Access 개요

### 1) Random Access vs Controlled Access
...
### 4) 실제 시스템 예: DOCSIS 케이블 모뎀 upstream
...
### 4) 실제 시스템 예 1: USB — Host 중심 Polling
...
### 5) 실제 시스템 예 2: DOCSIS Real-time Polling Service (rtPS)
...
#### (1) 최대 접근 지연 (Worst-case access delay)
...
## 12.2.4 Reservation vs Polling vs Token Passing 비교
