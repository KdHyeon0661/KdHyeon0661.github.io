...
## URL/QueryString과 상태 동기화 (SvelteKit)
...
## (Svelte 5) **Runes** 맛보기 — `$state`, `$derived`, `$effect`
...
## 종합 실습 — “검색·필터·페이지네이션: 상태 ↔ URL ↔ 서버 데이터”
...
### 페이지 — UI → URL (replaceState) → 자동 재로드
