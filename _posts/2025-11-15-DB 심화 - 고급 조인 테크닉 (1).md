...
### 2.3 포인트-선분(기간) 조인 — 판매일이 속한 가격 붙이기
...
### 2.4 선분-선분 교집합 분절 — 프로모션과 가격구간의 겹치는 구간만
...
### 3.2 GROUPING SETS — 한 번의 스캔으로 상세/소계/총계
...
#### 3.2.1 GROUPING_ID로 소계 종류 “한 번에” 라벨링
...
### 5.3 KEEP(DENSE_RANK LAST) 방식 — 집계 1번으로 최종값
...
### 5.4 LATERAL/APPLY Top-1 — 인덱스 역순 접근에 강함
