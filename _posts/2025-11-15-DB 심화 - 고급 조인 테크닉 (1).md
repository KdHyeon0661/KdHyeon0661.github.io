...
# 누적 매출(러닝 토털) 구하기 — “조인형”과 “윈도 함수형” 비교
...
### “조인형 러닝 토털” — **자기조인**으로 Dates≤Current 일자 묶기
...
# 선분이력 끊기(변경 구간 분절) — 유효기간 조인 + 경계 합치기
...
# 데이터 복제를 통한 “소계(Subtotal)” 구하기 — GROUPING SETS vs UNION ALL
...
### **GROUPING SETS**(권장) — “데이터 복제” 없이 **엔진이 소계 생성**
...
# 상호배타적(Exclusive) 관계의 조인 — “둘 중 하나만” 매칭
...
### 상호배타를 **무결성**으로 enforce — **체크/유니크**(설계적)
...
# “최종 출력 건”만 남기기 — 최신/우선순위 1건 픽(ROW_NUMBER) + 조인
