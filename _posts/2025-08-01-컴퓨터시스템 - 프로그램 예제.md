...
### 5.2 어셈블리(전형적, Intel 문법; 컴파일러/옵션에 따라 다를 수 있음)
...
## 9. 별칭(alias)과 `restrict`로 벡터화 돕기
...
## 22. 디버깅/관찰 도구: gdb/objdump/perf/strace
