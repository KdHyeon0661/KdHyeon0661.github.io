...
#### 변동하는 전파 품질과 속도 적응(rate adaptation)
...
#### 세대별(802.11n/ac/ax/be) 특징과 최신 속도
...
#### DCF(Distributed Coordination Function) 알고리즘
...
#### Hidden / Exposed Terminal 문제와 RTS/CTS
...
#### 802.11ax (Wi-Fi 6/6E)의 핵심 PHY 기능
