...
### MTU, MSS, 세그먼트 분할(스트림에서 “패킷”이 보이는 이유)
...
### 실습: 실제 **5-튜플**을 코드/도구로 확인하기

#### C++23: `getsockname`/`getpeername` 로 로컬/피어 5-튜플 출력
