...
## 3. `<picture>`로 아트 디렉션 + 포맷 전환

### 3.1 구도(자르기) 전환: 브레이크포인트마다 다른 이미지
...
## 5. 성능 속성: `loading`, `decoding`, `fetchpriority`, `referrerpolicy`
...
## 6. CSS 배경 이미지도 반응형 — `image-set()`과 미디어쿼리
...
## 7. 접근성: `alt`, `figure/figcaption`, 장식 이미지
