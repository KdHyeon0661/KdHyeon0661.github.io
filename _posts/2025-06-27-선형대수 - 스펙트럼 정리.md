...
## 예제 3 — 함수 $$f(A)$$ 계산: $$\exp(A)$$, $$A^{1/2}$$(PSD)
...
## 종합 예제 — 스펙트럼 분해, 함수계산, 레일리 몫, 인터레이싱
