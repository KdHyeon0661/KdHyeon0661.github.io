...
category: 디자인패턴
---
# — 구조 그림 유지, 테레스코핑 생성자 대체, 불변 객체·검증·체이닝·스텝빌더·DI/IoC 연동까지 실전 완전 정리
...
### 기본 예제(사용자 초안을 확장: 체이닝 + 검증 + Director 선택)
...
## — Effective Java 스타일 + Staged(순서 강제) 변형
...
### **Staged/Step Builder** — 순서 강제(필드 누락 방지)
