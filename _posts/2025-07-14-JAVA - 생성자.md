...
## 9. 텔레스코핑 vs 빌더 vs 정적 팩토리

### 9.1 텔레스코핑( telescoping ) 생성자
```java
...
### 12.2 **생성자 참조**(`ClassName::new`)와 배열 생성자 참조
```java
