...
## 0. 큰 그림: “URL → DNS → 연결(TCP/TLS/QUIC) → HTTP 요청/응답 → 렌더/캐시 → 재사용/종료”
...
### 8.3 Node(Express): JSON API + 캐시 헤더
...
### 12.4 Express: ETag/Last-Modified 제어
...
## 17. 부록 B — 미니 에코 서버(학습용, C/epoll, H1만)
