...
## 4. 대표 문제 ④ — 슬라이딩 윈도우 최솟값 (BOJ 11003)
...
## 7. 시뮬레이션에서의 덱: 뱀, 에디터, 카드 게임

### 7.1 뱀(예: BOJ 3190 풍의 구현 스케치)
