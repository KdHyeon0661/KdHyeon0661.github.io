...
#### Reader Preference — writer 기아 가능
...
#### Writer Preference — 공정성 개선(대기열 세마포어)
...
### Dining Philosophers (교착·기아·라이브락 연구용)

#### 단순 세마포어 — 한 철학자는 반대 순서 (교착 완화)
...
### The Santa Claus Problem (조합 동기화 패턴)
...
### 사례 1 — ISR ↔ Bottom-Half 링버퍼 (키보드/NET RX 등)
...
### 사례 2 — Wait Queue로 “수면 가능한” 소비자 깨우기
...
### 사례 3 — Completion 객체 (1회성 이벤트 동기화)
...
### 사례 5 — Seqcount/Seqlock (락 없는 읽기 + 재시도)
