...
## ACL(Access Control List) — 세분화 권한의 핵심
...
## 파일 속성(immutability 등) — `chattr` / `lsattr`
...
## SELinux/AppArmor(정책 기반 MAC) — 개념과 빠른 진단
...
### 80/443 포트 바인딩 — setuid 없이 Capabilities
