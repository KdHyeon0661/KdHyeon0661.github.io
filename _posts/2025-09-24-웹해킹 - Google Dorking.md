...
### Nginx: 디렉터리 인덱스/숨김 파일 차단, 다운로드 전용 헤더
...
### robots.txt·메타태그(참고: 보안 통제가 아닌 인덱스 힌트)
