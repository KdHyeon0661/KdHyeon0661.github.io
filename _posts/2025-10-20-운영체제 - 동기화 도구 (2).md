...
#### Test-Test-and-Set (TTAS) — 캐시 버스 감소
...
### Readers–Writers (세마포어 버전: 쓰기 우선/읽기 우선 변형)

#### 간단 “읽기 우선” 모델 — 쓰기가 기아 가능
...
### Dining Philosophers — 세마포어 해법(간단, 기아 가능성 있음)
