...
## 8.1 OS/브라우저/클라우드 자격증명 저장 위치 (지도 + 점검 스크립트)
...
### 8.3.2 Windows “읽기 전용” 전수 점검 스크립트
...
### 8.3.4 EventLog abuse(개념) — 방어 관점 가이드
