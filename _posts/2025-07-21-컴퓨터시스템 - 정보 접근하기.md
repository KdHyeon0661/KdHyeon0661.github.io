...
## 3. 배열(Array) — 연속 저장, 인수 전달 시 decay
...
## 4. 다차원 배열 — 행우선(row-major)과 올바른 시그니처
...
## 7. 공용체(Union) — 동일 저장 영역 공유와 안전한 용법
...
## 9. 엔디안(Endianness) — 바이트 순서가 해석을 바꾼다
...
## 10. 별칭(strict aliasing)과 `restrict` — 최적화의 열쇠
...
## 15. 위험 사례 — 범위 밖 산술/비교, dangling, void* 규칙
...
### 16.2 고성능(정렬/엔디안 고정시) — 컴파일러 내장 사용
...
## 21. 결론 — “주소를 계산하는 법을 알면 성능과 안정성이 따라온다”
