...
### 4.1 정수/실수 합(accumulation) — 다중 축적기
```c
...
### 4.4 Duff’s Device — switch 기반 언롤링(핵심 아이디어 예시)
```c
...
## 7. 벡터화(SIMD)와의 결합 — 시너지 극대화

### 7.1 AVX2 예: 8개 정수 합 + 언롤
```c
#include <immintrin.h>
