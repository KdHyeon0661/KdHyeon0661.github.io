...
### 17.4.3 도메인 전환 (Domain Switching)
...
### 17.4.4 도메인 교차 시 **증폭/감쇠**(Amplification/Attenuation)
...
### 17.5.4 소유자(owner)/제어(control)/복사(copy) 권한
...
### 17.6.1 ACL(Access Control List) — 객체 중심
...
### 17.6.2 Capability List — 주체 중심(능력)
...
### 17.6.4 POSIX/Windows에서의 구현 대응표
...
### 17.6.5 도메인 전환의 실무 예: setuid & `openat`(경로 고정)
...
### 17.6.7 정보 흐름(무결성/기밀성)과 격자(Lattice)
