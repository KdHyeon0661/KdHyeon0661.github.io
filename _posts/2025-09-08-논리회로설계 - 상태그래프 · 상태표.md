...
### DFA(유한상태기계) 접근 — “접두/접미(prefix/suffix)” 원리
...
### **이진 인코딩**(예: S0=00, S1=01, S2=10, S3=11)로 **D식 유도 예**
...
## 예제 B — **Moore, Overlap/Non-Overlap**
...
### VHDL(원-핫, Moore, Overlap/Non-Overlap 토글)
...
## 예제 C — **다중 패턴**(Aho–Corasick 아이디어)

### “`1011` 또는 `1001`” (Mealy, 겹침 허용)
...
## 검증(Verification) — 테스트벤치 & SVA

### 간단 TB(임의 비트스트림, 스코어보드 비교)
