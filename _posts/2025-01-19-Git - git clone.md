...
### Sparse Checkout (원하는 디렉터리만 워킹트리로)
...
### 오래된 대형 저장소를 빠르게 보고 싶다(히스토리 최소)

```bash
git clone --depth 1 --branch main --single-branch <url>
```

### 포크를 최신 원본에 맞추고 싶다(Fork + Upstream)
