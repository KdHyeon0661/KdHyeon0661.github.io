...
category: 시스템보안
---
# 2. 리버스 엔지니어링 기초 — 포맷·정적/동적 분석·패킹·크랙미 실습
...
### 2.2.2 제어흐름 그래프(CFG) & 콜그래프(Callgraph)
...
## 2.3 동적 분석 — 브레이크포인트/메모리·레지스터/API 모니터

### 2.3.1 gdb/LLDB/WinDbg/x64dbg 공통 루틴
...
## 2.4 난독화·패킹 개요 — UPX / VMProtect 개념
