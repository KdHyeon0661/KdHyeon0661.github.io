...
category: 디지털신호처리
---
# 델타 변조(Delta Modulation) — 1비트 미분 부호화의 원리, 한계, 적응형 구조, 그리고 GNU Octave 실험
...
## 2) DM의 핵심 한계 1: 과립 잡음(Granular Noise)
...
## 3) DM의 핵심 한계 2: 경사 과부하(Slope Overload)
