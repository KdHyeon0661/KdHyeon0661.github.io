...
## **작동하는 소형 TM 예제** (교육용 DSL)

### M\_map\_a2b — 모든 `a`를 `b`로 바꾸고 수용
...
### M\_even1 — `1`의 개수가 **짝수**면 수용, 홀수면 거절
...
### M\_len\_unary — 입력의 길이만큼 오른쪽에 `#111...1` 생성
