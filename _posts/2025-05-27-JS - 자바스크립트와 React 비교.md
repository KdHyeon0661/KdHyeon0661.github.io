...
## 8) JSX vs HTML: 중요한 차이

| 항목 | HTML | JSX |
|---|---|---|
| 속성 이름 | `class`, `for` | `className`, `htmlFor` |
| 스타일 | 문자열 | 객체(`style={{ color:'red' }}`) |
...
### 10.2 이벤트/상태 끌어올리기(Lifting State Up)
...
## 11) 네트워크/비동기: fetch vs React Query 예시
