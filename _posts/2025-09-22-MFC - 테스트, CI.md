...
# gtest: 단위·통합 테스트 표준 템플릿

## CMake + vcpkg(Manifest)로 gtest 가져오기
...
# 자동: CMake가 VCPKG_ROOT 또는 toolchain을 감지
...
# WinAppDriver + Appium: Windows UI 자동화(E2E)
...
# GitHub Actions: Windows CI 파이프라인
