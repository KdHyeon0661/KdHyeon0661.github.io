...
## 등가 순서회로 (Equivalent Sequential Circuits)
...
## 불완전 명세 상태표(ISM) — **don’t-care로 더 크게 줄이기**
...
### 핵심 개념 — **호환(Compatibility)**와 **닫힌 커버(Closed Cover)**
...
### Worked Example — Moore ISM을 5→3상태로
...
## 연쇄 분할(Partition Refinement) — **Moore 최소화 표준**
...
## 상태할당(State Assignment) — **조합로직을 줄이는 코딩**
...
### Worked Example — §2의 3상태 Moore(이진 인코딩)
...
### SystemVerilog — **Product 관찰자**로 등가 검증 스텁
