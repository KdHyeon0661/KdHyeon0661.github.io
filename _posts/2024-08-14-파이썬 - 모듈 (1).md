...
## 5. import가 실제로 동작하는 순서 (로더/파인더, 캐시)
...
## 13. 배포(패키징) 기초: `pyproject.toml` (PEP 517/518)
...
## 15. 예제: 플러그인 구조(네임스페이스 패키지 + entry_points)
