...
### 예제 A — **@i18n("key") 지시어를 $t('key') 코드로 치환**
...
### 예제 B — **가상 모듈(virtual:build-meta) 제공**
...
### 예제 C — **마크다운을 Svelte 모듈로 변환하는 로더(초간단)**
...
## Svelte **프리프로세서** 만들기 — 마크업/스크립트/스타일 조작
...
### 예제 D — **@feature 블록을 빌드 플래그로 제거/유지**
...
### 예제 E — **템플릿 안에서 @@env.VAR → import.meta.env.VAR 치환**
...
## **웹 컴포넌트(Custom Elements)** 로 내보내기

### Svelte에서 Custom Element로 컴파일
...
## 종합 예제 — **SvelteKit 앱 + CE 라이브러리 동시 제공**
