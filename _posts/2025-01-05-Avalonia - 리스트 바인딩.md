...
## Model — 불변(Immutable)과 가변(Mutable) 중 선택
...
## ViewModel — 단일 선택/다중 선택, 필터, 추가/삭제, 선택 인덱스
...
## MVVM 규범: Click 대신 Command 사용(권장)
