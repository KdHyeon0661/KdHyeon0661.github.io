...
### 2.2 2의 보수(two’s complement, 서명 정수)
...
## 4. 형 변환과 승격 — “계산은 넓게, 저장할 때 잘림”

### 4.1 일반 승격(usual integer promotions)
...
## 17. 결론 — “표시는 계약이고, 계약은 코드와 문서로 남긴다”
