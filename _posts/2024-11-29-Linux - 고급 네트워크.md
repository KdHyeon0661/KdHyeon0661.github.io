...
## NIC Bonding/Teaming — 고가용성/대역폭/부하분산
...
## Linux Bridge — 가상 스위치로 VM/컨테이너 L2 연결
...
## 고급 IP/라우팅 — 다중 경로, 정책 라우팅(SRP), ECMP
...
### “한 NIC로 사내망/DMZ 분리” (VLAN trunk + 정책 라우팅)
