...
## 3. 선형 변환의 전치(Transpose of a Linear Map)
...
### 3.3 복소·내적이 있을 때: 전치 vs 수반(Adjoint)
...
## 4. 멸자(Annihilator)와 네 공간의 쌍대 관계
...
## 5. 좌표 변환: 반변·공변(Contravariant vs Covariant)
...
## 6. 내적과 Riesz: 전치 $$\leftrightarrow$$ 수반
...
### 7.2 전치 사상 — $$T:\mathbb{R}^2\to\mathbb{R}^3$$
...
## 8. Python 실습 — SymPy/NumPy로 전 과정 검증
