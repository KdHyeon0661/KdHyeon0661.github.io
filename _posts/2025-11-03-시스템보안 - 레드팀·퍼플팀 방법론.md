...
## 목표 가설, 질의 기반 침투(Objective-Driven)
...
## MITRE ATT&CK 매핑, Atomic Test로 TTP 검증
...
#### Windows: 이벤트 생성 PowerShell (Dry-Run)
...
# 신호: PowerShell EncodedCommand 문자열만 로그에 남김
