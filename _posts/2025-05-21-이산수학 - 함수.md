...
## 9. 잘 정의됨(well-definedness)과 몫집합 위의 함수
...
### 13.4 등가류 위의 함수가 **잘 정의**되었는지 테스트(모듈러 예시)
