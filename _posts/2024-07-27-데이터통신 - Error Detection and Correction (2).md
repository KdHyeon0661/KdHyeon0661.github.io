...
### 10.3.1 Cyclic Redundancy Check (CRC) — 개요 재정리
...
### 10.3.2 Polynomials — GF(2) 다항식, 표기, 표준 생성다항식
...
### 10.3.3 Cyclic Code Encoder Using Polynomials — 절차와 예제

#### (1) **Systematic** 인코딩(실무 표준)
...
### 10.3.4 Cyclic Code Analysis — 거리·버스트·미검출 확률
...
### 10.3.5 Advantages of Cyclic Codes — 왜 사이클릭인가
...
### 10.3.6 Other Cyclic Codes — BCH, RS 등과의 관계
...
### 10.3.7 Hardware Implementation — LFSR, 병렬화, 실무 파라미터

#### (1) LFSR(Linear Feedback Shift Register) 모델
...
### 10.4.2 Other Approaches to the Checksum — 변형/대안 기법
