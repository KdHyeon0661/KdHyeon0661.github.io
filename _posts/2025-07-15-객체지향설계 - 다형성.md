...
## 6. 공변·반공변·불변(제네릭/반환 타입)

### 6.1 반환 타입 공변(covariant return)
```java
...
## 9. Visitor(더블 디스패치)로 `instanceof` 제거
...
## 11. DI/플러그인 아키텍처에서의 다형성

### 11.1 포트/어댑터(헥사고날 아키텍처)
...
### 11.2 Java ServiceLoader(런타임 플러그인)
...
## 13. 성능 관점: vtable, 인라이닝, `sealed/final`
...
## 15. 테스트 전략: **계약 테스트**로 구현 교체를 안전하게
