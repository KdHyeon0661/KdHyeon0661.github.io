...
## 1. 왜 “최적 등리플”인가? — 창함수/주파수 샘플링 vs Equiripple
...
## 3. 선형 위상 FIR로의 축소 — 실질적인 최적화 변수 줄이기
...
## 4. Chebyshev 근사와 교대 정리(Alternation Theorem)

최적 등리플 설계의 이론적 기반은 **Chebyshev 다항식**과 **교대 정리(Alternation theorem)** 에 있다.

### 4.1 minimax 근사와 Chebyshev 함수
...
## 6. GNU Octave에서의 최적 등리플 설계 도구: `remez`
...
## 11. 다른 필터 유형: Differentiator, Hilbert 변환기
...
## 16. 결론 — Equi-ripple은 “마지막 1 dB”를 쥐어짜는 도구
