...
### 1.3 COMDAT/SHF_MERGE/SHF_STRINGS 오염
...
## 2. 동적 속성 변경 — RPATH/RUNPATH/SONAME/Interpreter

### 2.1 RPATH vs RUNPATH 우선순위 함정
...
## 9. 미니 실습 — 의도적 실패/복구로 배우기 (ELF)

> **주의**: 개인 테스트 환경/샌드박스에서만. 운영 바이너리 금지.

### 9.1 RPATH→RUNPATH 전환 영향
```bash
...
## 12. 보안/정책 — 바꾸지 말아야 할 것과 바꿀 때 지켜야 할 것
