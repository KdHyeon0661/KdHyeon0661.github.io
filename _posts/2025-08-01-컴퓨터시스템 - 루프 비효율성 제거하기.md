...
## 1. 측정이 먼저다 — 프로파일링/마이크로벤치

### 1.1 신뢰 가능한 시간 측정 헬퍼(C)
```c
#include <time.h>
#include <stdio.h>
...
## 4. 강도 감소(Strength Reduction) & 인덕션 변수 정리
...
## 7. 루프 상호교환(Interchange) & 타일링/블로킹

### 7.1 Interchange — 행렬 접근 순서 교정
...
## 9. 분기 제거(Branch elimination) & 조건 이동
...
## 11. 소프트웨어 프리페치 & Non-temporal Store
...
## 20. 부록 — 벤치마크 스캐폴딩, 두 가지 루프 최적화 데모
...
## 21. 수학으로 보는 개선 효과(간단 추정)

### 21.1 언롤링/분기감소로 CPI 개선
