...
# 도수분포(Frequency) 히스토그램 — 실습

## 스큐가 큰 컬럼(예: `PROD.BRAND`)에 히스토그램 생성
...
## 연속형 분포(예: `ORD.AMOUNT`)에 히스토그램 생성
