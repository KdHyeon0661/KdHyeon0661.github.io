...
## 6. 2000년대: 웹 대중화와 수평 확장·유연 스키마 요구
...
## 7. 2010년대–현재: NewSQL, 분산 트랜잭션, 클라우드 DBaaS
...
## 9. 정규화·인덱스·트랜잭션: 역사에서 현재까지 이어지는 핵심
...
## 11. NewSQL/분산 트랜잭션 감각

### 11.1 직렬가능성과 전역 타임스탬프
- 직렬가능 스케줄의 직관:  
