...
## Celery로 작업 큐 구성 (Redis/RabbitMQ)
...
### Celery의 `update_state` / RQ의 `job.meta`
...
## 예제: “엑셀 대량 업로드 → 비동기 처리 → 진행률 푸시 → 다운로드 링크”
