...
## 1.1.3 Defining Operating Systems (정의)
...
### 예제: 사용자 공간에서 인터럽트 유사 이벤트(시그널) 관찰
...
## 1.3 Computer-System Architecture (컴퓨터 시스템 아키텍처)
...
## 1.3.1 Single-Processor Systems (단일 프로세서)
...
## 1.3.2 Multiprocessor Systems (다중 프로세서)
