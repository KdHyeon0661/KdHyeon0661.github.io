...
## 예전 레이아웃에서의 float — 왜 더 이상 권장되지 않나
...
## clearfix — “부모가 float 자식을 감싸도록” 만드는 고전 처방

### 가장 표준적인 clearfix(의사요소)
...
### 카드 갤러리(구 float-wrap → 신 Flex wrap)
...
## float로 “모양대로 감싸기”: `shape-outside`(텍스트 래핑 고급)
