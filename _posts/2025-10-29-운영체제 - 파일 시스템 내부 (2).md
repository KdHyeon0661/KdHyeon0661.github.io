...
### 15.4.2 단일 호스트에서의 공유: FD, OFT, inode
리눅스 기준 내부 모델(요약):
...
### 15.4.4 동시성 제어: advisory/mandatory, 레인지 락, flock
...
### 15.4.7 원자적 업데이트 패턴: temp + fsync + rename
...
### 15.4.8 권한/ACL/UMASK/캡abilities
...
### 15.6.2 NFS (Network File System)
...
### 15.6.4 9P, virtio-fs, FUSE over network
...
### 15.6.8 미니 실습: 소켓 기반 “아주 단순한 원격 파일 서버/클라이언트”
