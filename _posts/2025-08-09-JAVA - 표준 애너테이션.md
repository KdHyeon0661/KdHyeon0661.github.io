...
## 2. @Deprecated — “사용 중단, 대체 API로 이동하세요”
...
## 4. 세 애너테이션의 **정확한 Target/Retention**과 사용 위치
...
### 5.1 “Deprecated → 대체로 점진 이행” 체크리스트
...
### 5.2 “SuppressWarnings 남용 금지” 체크리스트
...
## 6. 종합 예제 — 3종 애너테이션이 한 파일에서 만나는 경우
