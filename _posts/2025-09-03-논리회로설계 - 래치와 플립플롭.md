...
### NAND형(활성 Low \(\overline{S},\overline{R}\)) — 교차결합 NAND
...
## **에지-트리거 D 플립플롭(Edge-Triggered D FF)**
...
### DFF with Enable (합성 우호적 MUX 스타일)
