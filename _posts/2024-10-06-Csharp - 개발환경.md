...
## NuGet 패키지 추가 — 예: Newtonsoft.Json
...
## 코드 스타일·분석 — .editorconfig / Analyzers / 포맷팅
...
## 환경 분리/설정 — appsettings & 환경변수 & User Secrets

### Minimal API 예시 + 설정 바인딩
...
## WSL(Windows Subsystem for Linux)과 VS Code
...
## 컨테이너/Dev Containers — 동일한 개발환경 공유

### Dockerfile (콘솔/웹 공용 예시)
...
## 문서화·품질 게이트 — XML 주석, Code Analysis
...
## 배포 빌드 — self-contained / single-file / ReadyToRun
