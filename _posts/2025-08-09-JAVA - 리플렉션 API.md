...
category: Java
---
# 리플렉션(Reflection) API 사용법

## 1. 큰 그림 — 리플렉션이 해결하는 문제와 한계
...
## 4. 인스턴스 생성 — newInstance() 대신 생성자 호출
...
## 6. 필드 읽기/쓰기 — primitive 전용 접근자 활용
...
## 7. 배열 조작 — java.lang.reflect.Array
...
## 8. 제네릭/AnnotatedType/TypeVariable — 타입 소거의 벽 넘기
...
## 10. 동적 프록시 — 인터페이스 기반 AOP/로깅/트랜잭션
...
## 11. MethodHandles & VarHandle — 고성능 대안

### 11.1 MethodHandle (메서드/생성자/필드 getter·setter에 대한 호출句)
...
### 11.2 VarHandle (필드/배열/바이트버퍼 원자적·가시성 제어 포함)
...
## 13. JPMS(모듈)와 리플렉션 — exports vs opens, 실행 옵션
...
## 14. ClassLoader와 리플렉션 — 플러그인/격리/리소스
...
## 17. 예제 시나리오 — 초간이 DI 컨테이너(생성자/필드 주입)
