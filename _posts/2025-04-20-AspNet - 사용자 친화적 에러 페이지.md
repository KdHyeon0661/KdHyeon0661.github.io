...
### 상태 코드 페이지(404/403) — `Pages/StatusCode.cshtml`
...
## Web API — RFC7807 ProblemDetails(JSON) 표준화
...
## SPA(React/Vue/Svelte) + 프록시(Nginx/IIS)에서의 에러
