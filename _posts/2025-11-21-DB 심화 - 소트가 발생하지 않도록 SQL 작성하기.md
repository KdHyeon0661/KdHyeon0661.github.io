...
## `DISTINCT`/`UNION` 소트 제거 — **세미조인/해시 집계/UNION ALL**
...
#### `KEEP (DENSE_RANK FIRST/LAST)` 주의

`KEEP`은 내부적으로 정렬/랭크가 필요할 수 있다. 대신 **(1)** 방식이 인덱스 친화적.

---

## 표현식 정렬 회피 — **함수기반 인덱스(FBI)**
