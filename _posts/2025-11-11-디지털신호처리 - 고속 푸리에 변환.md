...
## Cooley–Tukey Radix-2: DIT 유도 (정석)
...
## DIF(Decimation-in-Frequency) — 대칭 형제
...
## GNU Octave — Radix-2 DIT FFT 구현과 검증
...
## Stockham 한 스텝 데모(개념) — 비트역전 없는 흐름
