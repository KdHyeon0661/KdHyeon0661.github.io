...
## chroot vs namespace — “디렉토리 바꾸기”와 “세계 바꾸기”의 차이

### chroot: 루트 디렉토리만 바뀌는 *부분 격리*
...
## cgroup v2로 리소스 선 그어두기(컨테이너 필수 기초)
...
## 보안 격리의 다른 축: Capabilities·seccomp·LSM
...
## 파일시스템 격리 심화: mount ns·pivot_root·overlayfs

### pivot_root: 새 루트로 깔끔 전환
...
## systemd-nspawn — “시스템 컨테이너”로 systemd 세계를 띄운다
...
### 설정 맛보기(`/var/lib/lxc/myct/config`)
...
### nspawn으로 Debian 컨테이너 부팅 + 브리지 연결
...
### libvirt로 빠르게 VM 생성(virt-install)
