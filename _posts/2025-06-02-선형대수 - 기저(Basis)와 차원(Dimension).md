...
## 7. 기저를 계산하는 알고리즘(유한차원)

### 7.1 가우스 소거/행기약형(RREF)
...
## 9. Python 예제 (SymPy) — 기저·차원·좌표·기저변화
