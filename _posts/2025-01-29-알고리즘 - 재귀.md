...
## 5. 패턴 라이브러리 — 바로 갖다 쓰는 재귀 레시피

### 5.1 분할정복: 거듭제곱(빠른 거듭제곱, BOJ 1629)
...
### 5.6 종이 자르기(BOJ 2630/1780) — 균일 영역 카운트
...
## 7. 백준 실전 문제 모음 — 재귀로 푼다

### 7.1 10870 — 피보나치 수(재귀/메모)
