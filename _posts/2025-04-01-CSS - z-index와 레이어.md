...
## transform/opacity/filter/isolation/contain과의 상호작용
...
## 미세 규칙: inline/float/positioned의 기본 페인팅 흐름(요약)
...
## 수식 두 가지 — 비교 키와 높이쌓기 직관화

### 같은 컨텍스트 내 z-index 비교 키(단순화)
