...
#### **effectively final** (람다/내부 클래스 캡처 규칙)
...
## **compile-time constant**와 상수 인라이닝
...
### **Initialization-on-demand holder** — 싱글톤 Lazy & 안전
...
## 미니 프로젝트 — `static` 유틸/상수 + `final` 값 타입 + Holder 싱글톤
