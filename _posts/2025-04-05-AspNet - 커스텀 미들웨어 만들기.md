...
## 6) 단락(Short-Circuit)과 조건부 실행

### 6.1 단락: 조건에 따라 파이프라인을 즉시 종료
...
## 9) 관측/추적: Correlation Id & Logging Scope
...
## 13) Minimal API/Controller와의 경계
...
## 16) 통합 테스트(WebApplicationFactory)
