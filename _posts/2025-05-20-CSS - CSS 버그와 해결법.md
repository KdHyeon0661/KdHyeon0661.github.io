...
## margin 겹쳐서 사라지는 현상 (margin collapsing)
...
## height가 안 잡히는 부모 요소 (자식이 float일 때)
...
## position: absolute 요소가 이상한 위치에 배치됨
...
## input / button 요소가 브라우저마다 다르게 보임
...
## 케이스 스터디 — “3단 컬럼이 Safari에서 1px 깨진다”
