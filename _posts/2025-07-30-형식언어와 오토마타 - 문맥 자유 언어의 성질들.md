...
### 대표 예제 ①: \(L=\{a^n b^n c^n\mid n\ge 0\}\)는 CFL이 **아님**
...
## 선형 언어(Linear language) 펌핑 보조 정리
...
## 코딩 데모 ① — **CFL 펌핑 반증 실습**(비CFL: \(a^n b^n c^n\))
...
## 코딩 데모 ③ — **CYK 파서**로 “펌핑 결과 소속성” 확인 (CFL 대상)
