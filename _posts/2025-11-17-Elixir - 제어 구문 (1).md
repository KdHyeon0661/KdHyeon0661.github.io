...
#### 12.1.1.1 truthiness 패턴 — 값 자체를 반환하는 if
...
### 12.1.4 if/else 대신 **연산자**로 표현 가능한 경우
...
### 12.2.6 `cond` 에서 결과를 **값**으로 사용하는 패턴
