...
### 10.3 불균형 + 파이프라인(결측/스케일 불필요하나 결측은 보정)
...
### 11.2 `min_samples_leaf` 효과(매끄러움·과적합 완화)
...
## 12. 정보이득 비율(Gain Ratio)와 다중분기(C4.5 세부)
...
## 13. 규칙 추출과 반사실(counterfactual) 해석
