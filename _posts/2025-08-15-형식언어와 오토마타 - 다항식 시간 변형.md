...
## 5) 대표 예시 ① — **3-SAT → CLIQUE** (Karp 변형, 풀 스케치)
...
## 7) 대표 예시 ③ — **3-SAT → 3-COLORING** (색칠 가젯)
...
## 8) 대표 예시 ④ — **3-SAT → SUBSET-SUM** (수치 가젯, 스케치)
...
## 9) 결정·탐색·최적화: **자기감소(Self-reduction)**
...
## 13) **Fine-grained** 변형(정밀 시간 하한 전파)
...
### 18.2 **Vertex Cover 2-근사**(최대 매칭 라운딩)
