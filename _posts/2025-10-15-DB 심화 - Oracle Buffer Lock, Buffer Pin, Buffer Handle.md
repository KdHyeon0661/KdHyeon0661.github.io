...
## Buffer Handle(=Buffer Header) — 무엇이고 어디에 있나?
...
### 완화 1 — 액세스 분산(Reverse/Partition/샤딩)
...
## LRU·DBWn·Pin 상호작용 — `free buffer waits` / `write complete waits`
