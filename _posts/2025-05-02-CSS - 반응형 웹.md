...
## 컨테이너 쿼리(Container Queries) — 컴포넌트 스스로 반응
...
## 반응형 카드 레이아웃 — Flex → Column 전환(기본 예제 확장)
...
## 추가 실전 예제: 반응형 카드 그리드(유동 타이포/이미지/컨테이너 쿼리 포함)
