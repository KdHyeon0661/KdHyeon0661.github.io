...
## Sealed Classes/Interfaces — 상속 제어 (Java 17)
...
## Virtual Threads — 경량 스레드 (Java 21, GA)
...
### Sequenced Collections — 양방향 순서 API (Java 21, GA)
...
### Unnamed Classes & Instance Main — 빠른 진입 (21 Preview → **22 GA**)
...
### 도메인 분기(Sealed + Record + Pattern + switch)
...
### Virtual Threads + HTTP Client (Java 11+) 조합
