...
## 퍼널 3변수 모형: (S=노출, K=클릭, V=전환)

### 단순 ‘희석(thinning)’ 포아송 퍼널
...
## 시간단위 집계(일별)에서의 공분산 — 총분산/총공분산 법칙
