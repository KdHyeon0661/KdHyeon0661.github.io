...
## 이벤트 수집 표준화: Windows(EventID), Linux(auditd), Sysmon/ETW
...
### Sigma → **KQL** 변환(예시: Microsoft Sentinel)
...
#### LOLBins(합법 바이너리 악용) — mshta/regsvr32/rundll32/wmic
...
#### 서비스 설치/지속성(7045/4697 + Sysmon 1 Join)
