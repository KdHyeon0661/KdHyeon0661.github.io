...
## 실전 구성(랩) — hostapd + FreeRADIUS + wpa_supplicant

> 아래는 **방어/구성** 목적의 **미니멀 재현** 예시다. 실서비스는 벤더 가이드와 보안 정책에 맞게 확장·하드닝한다.

### AP(소프트 AP) — WPA3-SAE + PMF=Required
...
### (선택) 공개 SSID를 OWE로 전환한 뒤 포털 인증

- L2는 OWE로 암호화·프라이버시 제공, L3에서 포털/토큰으로 **식별·정책** 적용.

---

## 운영·모니터링 — WIDS/WIPS·로그·지표
### 지표
