...
## 17. SCD/템포럴: 속성 변경 이력 추적

### 17.1 SCD Type 2(차원 이력)
```sql
...
### 17.2 시스템 버전(엔진 제공 기능)
- 일부 DB는 시스템 버전 테이블을 제공(자동 이력).
- 감사/복구/회계 도메인에 유용.

---

## 18. 마이그레이션: 속성 변경의 안전 절차
