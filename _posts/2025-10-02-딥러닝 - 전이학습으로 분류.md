...
#### 점진적 Unfreeze + Discriminative LR
...
#### **가중치**(CrossEntropy에 `weight=class_weights`)
...
#### Bootstrapping Loss(soft/hard 혼합)
...
#### Self-Training(고확신 pseudo-label)
