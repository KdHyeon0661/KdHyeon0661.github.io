...
## Critical CSS: 위-폴드(above the fold) 우선
...
## 렌더링 영역 줄이기: `content-visibility`/`contain`
...
## Cascade Layers(@layer)로 특이성 경쟁 종료
