...
category: 시스템보안
---
# 6. 커널 익스플로잇 입문 — 구조 이해, 버그 패턴, 안전한 실습/디버깅
...
# 6.1 커널 메모리, 시스템 콜 경로, 드라이버 인터페이스(IOCTL)
...
# 6.3 심볼/디버깅 환경(WinDbg KD, kASLR, kptr_restrict)

## 6.3.1 Linux 커널 디버깅/심볼

### (A) QEMU + GDB + vmlinux 심볼
